...
## Corpus Check
- 564 files · ~843,332 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7494 nodes · 9896 edges · 573 communities (508 shown, 65 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 183 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c8fcf1c`
...
## Communities (573 total, 65 thin omitted)
...
Cohesion: 0.04
Nodes (47): AuthUser, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto (+39 more)
...
Cohesion: 0.03
Nodes (38): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto (+30 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (62): RestaurantContextType, DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, api, BoricaCheckoutResponse, changePassword(), CheckoutResponse (+54 more)
...
Cohesion: 0.04
Nodes (50): NotificationBell(), PaymentToast(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications(), Order (+42 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (50): RestaurantList(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+42 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (51): CreateRestaurantForm(), AnalyticsView(), SettingsTab, SettingsView(), bondSection, { container }, mockRestaurant, mockT (+43 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (45): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), useMenu(), getGoogleReviewUrl() (+37 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (26): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, OptionalJwtStrategy, DashboardModule, EventsModule, HealthController (+18 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (49): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), SocketProvider(), AssistanceContextValue, AssistanceRequest (+41 more)
...
Cohesion: 0.07
Nodes (38): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+30 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (26): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+18 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (36): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute() (+28 more)
...
Cohesion: 0.05
Nodes (31): confirmCheckoutSession(), disconnectStripe(), generateStripeConnectLink(), getStripeStatus(), updateOnboardingStep(), updateRestaurant(), Billing, getVisibleSteps() (+23 more)
...
Cohesion: 0.08
Nodes (14): AssistanceController, AssistanceService, dto, mockEvents, mockFeatureService, mockPrisma, req, updated (+6 more)
...
Cohesion: 0.1
Nodes (28): getMethodLabel(), PaymentDrawer(), TimelineItem(), translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles (+20 more)
...
Cohesion: 0.09
Nodes (25): abandonCheckout(), createAssistanceRequest(), getCategoryItems(), getMenuMeta(), getTrendingItems(), recordMenuView(), getTranslatedArray(), getTranslatedField() (+17 more)
...
Cohesion: 0.07
Nodes (23): createDeviceEnrollment(), createStaff(), listDeviceEnrollments(), removeStaff(), resetStaffPin(), StaffMember, updateStaff(), DeviceEnrollment (+15 more)
...
Cohesion: 0.11
Nodes (19): CreatePrintStationDto, UpdatePrintStationDto, burger, call, existingAcc, makeMenuItem(), makeRestaurant(), makeTx() (+11 more)
...
Cohesion: 0.09
Nodes (21): BoricaCardholderDetails, CheckoutProvider, createCheckout(), createPaymentIntent(), BillData, BillItem, BillOrder, BoricaPaymentState (+13 more)
...
Cohesion: 0.11
Nodes (18): MetricCard(), cn(), SummaryCard(), formatElapsed(), statusConfig, TableCard(), TableCardProps, formatDate() (+10 more)
...
Cohesion: 0.15
Nodes (3): CreateStaffDto, UpdateStaffDto, UsersService
...
Cohesion: 0.2
Nodes (9): code:typescript (import { IsIn, IsOptional, IsBoolean } from 'class-validator), code:bash (git add apps/backend/src/super-admin/dto/update-tenant.dto.t), code:typescript (import { Test, TestingModule } from '@nestjs/testing';), code:bash (git add apps/backend/test/super-admin.e2e-spec.ts), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 17: Backend e2e smoke test, Task 18: Build verification (+1 more)
...
Cohesion: 0.21
Nodes (8): Files Changed, Files Changed, Fix, Key Changes, Pricing Page i18n + Badge Wrap Fix (May 19, 2026), Problem, Staff Attribution & Itemized Bills (May 24, 2026), Summary
...
Cohesion: 0.5
Nodes (3): BillingPeriod, CheckoutTier, CreateCheckoutDto
...
- **Why does `FeatureService` connect `Community 3` to `Community 33`, `Community 98`, `Community 35`, `Community 68`, `Community 5`, `Community 73`, `Community 12`, `Community 109`, `Community 85`, `Community 150`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 45` to `Community 3`, `Community 9`, `Community 15`, `Community 17`, `Community 30`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 9` to `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 141`, `Community 14`, `Community 15`, `Community 13`, `Community 17`, `Community 22`, `Community 23`, `Community 30`, `Community 36`, `Community 41`, `Community 45`, `Community 174`, `Community 58`, `Community 62`, `Community 191`, `Community 75`, `Community 83`, `Community 86`, `Community 87`, `Community 227`, `Community 100`, `Community 110`, `Community 111`?**
