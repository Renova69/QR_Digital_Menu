# Graph Report - QR_Digital_Menu-main  (2026-07-03)

## Corpus Check
- 684 files · ~985,822 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8709 nodes · 12113 edges · 651 communities (574 shown, 77 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 226 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `855a74d0`
...
- `on()` --calls--> `m`  [INFERRED]
  index.js → apps/backend/src/dashboard/dashboard-views.service.spec.ts
- `dn()` --calls--> `D()`  [INFERRED]
...
## Communities (651 total, 77 thin omitted)
...
Cohesion: 0.05
Nodes (56): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, BoricaCardholderInfo, EpayCheckoutForm, EpayCheckoutParams, EpayMode (+48 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (81): BannerSettings, TYPE_STYLES, filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES (+73 more)
...
Cohesion: 0.03
Nodes (36): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto, UpdateMenuOptionDto (+28 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (42): AuthUser, JwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto (+34 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (32): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, UpdatePlatformSettingsDto, EventsModule, HealthController (+24 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (60): Channel, COUNTRIES, CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider(), useMenuContext() (+52 more)
...
Cohesion: 0.05
Nodes (57): CancelAnalysisPanel(), CustomerKitchenPanels(), StaffPerformancePanel(), TableTurnoverPanel(), computeInsights(), MenuProfitabilityPanel(), MenuProfitabilityPanelProps, Panel() (+49 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (36): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, OptionalJwtStrategy, passwordChangedAt, prisma, WrapperType (+28 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (54): NotificationBell(), PaymentToast(), useAssistance(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications() (+46 more)
...
Cohesion: 0.05
Nodes (47): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+39 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (47): RecentOrders(), RecentOrdersProps, DashboardSummary, superAdminGetDataRequests(), superAdminGetMrr(), superAdminUpdateDataRequest(), createCategory(), createItem() (+39 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (47): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), ReservationsView(), SettingsTab, SettingsView() (+39 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (38): CustomPreferencesEditor(), format24h(), ManualBookingForm(), ReservationCard(), ReservationList(), ReservationSettingsForm(), ServiceHoursEditor(), STATUS_STYLES (+30 more)
...
Cohesion: 0.05
Nodes (21): AssistanceService, dto, mockEvents, mockFeatureService, mockPrisma, req, updated, CreateAssistanceDto (+13 more)
...
Cohesion: 0.05
Nodes (46): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, OrderProvider(), RestaurantProvider(), SocketContext, SocketContextData (+38 more)
...
Cohesion: 0.06
Nodes (28): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, ApiKeyGuard, mockPrisma, MenuImportService (+20 more)
...
Cohesion: 0.06
Nodes (30): AnalyticsView(), formatDate(), SummaryView(), UpgradeBanner(), useAnalytics(), usePaymentSummary(), useScanStats(), DateRangePreset (+22 more)
...
Cohesion: 0.08
Nodes (23): CancelAnalyticsData, CancelHourRow, CancelItemRow, CategoryBreakdown, CloseoutReport, CustomerMetric, CustomerMetricsData, DailyTargetData (+15 more)
...
Cohesion: 0.1
Nodes (23): createTable(), createZone(), deleteTable(), deleteZone(), getLogoBase64(), getTables(), getTableSessions(), reorderZones() (+15 more)
...
Cohesion: 0.12
Nodes (20): addDays(), addEarnedPointBatch(), ensureLoyaltyAccount(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress(), getRewardValue(), lockLoyaltyAccountRow() (+12 more)
...
Cohesion: 0.13
Nodes (10): PatronService, MenuAllergenSummary, ReservationAllergensService, ACTIVE_HOLD_STATUSES, AvailabilitySlot, ReservationAvailabilityService, sanitizeStaffTags(), ReservationsModule (+2 more)
...
Cohesion: 0.16
Nodes (13): UpdateOrderDto, redeemAccountPoints(), getTierInfo(), config, defaultConfig, info, TierConfig, tierConfigFromRestaurant() (+5 more)
...
Cohesion: 0.16
Nodes (13): AvailabilityQueryDto, CreateReservationDto, CoverCountDto, ListReservationsQueryDto, ManualReservationDto, RESERVATION_ACTIONS, RESERVATION_STATUS_FILTERS, ReservationActionBodyDto (+5 more)
...
Cohesion: 0.18
Nodes (12): CUSTOMER_PREFERENCE_SET, CUSTOMER_PREFERENCES, CustomerPreference, DIETARY_PREFERENCE_SET, DIETARY_PREFERENCES, hasDietaryPreference(), sanitizeCustomerPreferences(), STAFF_PATRON_TAG_SET (+4 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/pages/pos/PosPage.tsx), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), File Structure (+3 more)
...
Cohesion: 0.2
Nodes (7): baseDto, FUTURE, PAST, { service, features }, { service, prisma }, { service, prisma, events }, { service, prisma, txReservationCreate }
...
Cohesion: 0.2
Nodes (9): code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/SuperAdminRoute.tsx), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/pages/super-admin/TenantDetailPage), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 10: SuperAdminRoute — frontend guard, Task 15: TenantDetailPage — tier override + suspend (+1 more)
...
## Knowledge Gaps
- **4703 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4698 more)
...
- **Why does `PublicMenuPage()` connect `Community 24` to `Community 7`, `Community 12`, `Community 18`, `Community 53`, `Community 25`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `FeatureService` connect `Community 7` to `Community 3`, `Community 6`, `Community 8`, `Community 41`, `Community 13`, `Community 114`, `Community 115`, `Community 85`, `Community 245`, `Community 23`, `Community 89`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `t` connect `Community 12` to `Community 1`, `Community 130`, `Community 4`, `Community 9`, `Community 14`, `Community 15`, `Community 142`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 151`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 156`, `Community 155`, `Community 31`, `Community 416`, `Community 34`, `Community 42`, `Community 48`, `Community 51`, `Community 308`, `Community 54`, `Community 186`, `Community 71`, `Community 73`, `Community 74`, `Community 205`, `Community 78`, `Community 91`, `Community 94`, `Community 229`, `Community 230`, `Community 105`, `Community 106`, `Community 247`, `Community 376`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Are the 190 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
...
- **What connects `Kt`, `ya`, `p` to the rest of the system?**
  _4703 weakly-connected nodes found - possible documentation gaps or missing edges._
