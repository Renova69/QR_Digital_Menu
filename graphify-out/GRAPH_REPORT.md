...
## Corpus Check
- 601 files · ~909,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8216 nodes · 10976 edges · 601 communities (533 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 197 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `263c69f9`
...
Cohesion: 0.03
Nodes (81): filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage() (+73 more)
...
Cohesion: 0.03
Nodes (70): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), useNotifications() (+62 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (69): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+61 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (66): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider() (+58 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (31): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto, UpdateMenuOptionDto (+23 more)
...
Cohesion: 0.05
Nodes (38): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, PinLoginMeta, JwtStrategy (+30 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (55): MenuProfitabilityPanel(), MenuProfitabilityPanelProps, Panel(), SummaryView(), UpgradeBanner(), CancelAnalyticsData, CancelHourRow, CancelItemRow (+47 more)
...
Cohesion: 0.05
Nodes (49): CustomTooltip(), KpiCard(), KpiCardProps, BoricaCardholderDetails, CheckoutProvider, createCashPaymentRequest(), createCheckout(), createPaymentIntent() (+41 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (26): AuthUser, JwtAuthGuard, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem (+18 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (24): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, EventsModule, HealthController, HealthModule (+16 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (40): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), useMenu(), getGoogleReviewUrl(), submitFeedback(), CategoryList() (+32 more)
...
Cohesion: 0.07
Nodes (26): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+18 more)
...
Cohesion: 0.07
Nodes (30): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, abandonCheckout(), createAssistanceRequest(), getCategoryItems() (+22 more)
...
Cohesion: 0.09
Nodes (16): AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result, servedEntry (+8 more)
...
Cohesion: 0.08
Nodes (18): CategoryPills(), CategoryPillsProps, Footer(), FooterProps, linkifyPhones(), advantageItems, comparisonRows, DashboardPreview() (+10 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (21): DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, changePassword(), confirmCheckoutSession(), generateStripeConnectLink(), updateOnboardingStep(), updateProfile() (+13 more)
...
Cohesion: 0.11
Nodes (13): categories, mockFeatureService, mockPrisma, mockStorageService, tx, VALID_AVAILABILITY, StorageModule, ProcessedUpload (+5 more)
...
Cohesion: 0.11
Nodes (16): CreateRestaurantForm(), RestaurantList(), RestaurantContext, RestaurantContextType, AuditIssue, MenuCheckWidget(), getScanStats(), ScanStats (+8 more)
...
Cohesion: 0.21
Nodes (9): TimelineItem(), MetricCard(), SettingCard(), cn(), SummaryCard(), formatElapsed(), statusConfig, TableCard() (+1 more)
...
Cohesion: 0.18
Nodes (10): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/context/AuthContext.tsx), code:bash (git add apps/frontend/src/context/AuthContext.tsx apps/front), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), File Structure, RBAC Sprint Implementation Plan, Self-Review (+2 more)
...
Cohesion: 0.2
Nodes (9): code:typescript (import { IsIn, IsOptional, IsBoolean } from 'class-validator), code:bash (git add apps/backend/src/super-admin/dto/update-tenant.dto.t), code:json ("superAdmin": {), code:bash (git add apps/frontend/src/locales/en/translation.json), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 16: i18n — add EN translation keys, Task 18: Build verification (+1 more)
...
Cohesion: 0.42
Nodes (4): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, GenerateTokenDto
...
Cohesion: 0.21
Nodes (8): CI Gate Added (May 18, 2026), Dashboard Purple/Violet Luxury Redesign (May 24, 2026), Files Changed, Files Changed, Fix, Key Changes, Problem, Summary
...
## Knowledge Gaps
- **4731 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4726 more)
...
- **Why does `FeatureService` connect `Community 13` to `Community 36`, `Community 41`, `Community 10`, `Community 138`, `Community 172`, `Community 78`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 86`, `Community 95`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 34` to `Community 33`, `Community 7`, `Community 8`, `Community 9`, `Community 13`, `Community 26`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `t` connect `Community 8` to `Community 1`, `Community 3`, `Community 4`, `Community 262`, `Community 7`, `Community 9`, `Community 11`, `Community 141`, `Community 14`, `Community 16`, `Community 19`, `Community 26`, `Community 33`, `Community 34`, `Community 162`, `Community 290`, `Community 37`, `Community 53`, `Community 54`, `Community 321`, `Community 70`, `Community 199`, `Community 72`, `Community 200`, `Community 71`, `Community 90`, `Community 220`, `Community 116`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Are the 163 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
...
- **What connects `Kt`, `ya`, `p` to the rest of the system?**
  _4731 weakly-connected nodes found - possible documentation gaps or missing edges._
