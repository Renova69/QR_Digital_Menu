...
## Corpus Check
- 590 files · ~889,266 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7902 nodes · 10467 edges · 589 communities (522 shown, 67 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `96536a27`
...
## Communities (589 total, 67 thin omitted)
...
Cohesion: 0.03
Nodes (76): RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, useRestaurantContext(), SettingsTab (+68 more)
...
Cohesion: 0.03
Nodes (68): RestaurantContextType, DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES (+60 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (37): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, PinLoginMeta, JwtStrategy (+29 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (59): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+51 more)
...
Cohesion: 0.04
Nodes (35): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+27 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (25): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto, UpdateMenuOptionDto (+17 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (35): AuthUser, JwtAuthGuard, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateRestaurantDto, DateRangeQueryDto, RefundPaymentDto, SettleAllocationDto (+27 more)
...
Cohesion: 0.05
Nodes (47): getMethodLabel(), PaymentDrawer(), TimelineItem(), translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles (+39 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (41): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), useMenu(), CategoryList() (+33 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (16): AssistanceController, AssistanceService, CreateAssistanceDto, CreateFeedbackDto, OrderQueryDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto (+8 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (40): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute() (+32 more)
...
Cohesion: 0.07
Nodes (35): CustomTooltip(), KpiCard(), KpiCardProps, AnalyticsData, formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual() (+27 more)
...
Cohesion: 0.08
Nodes (9): UpdatePlatformSettingsDto, PlatformSettingsController, PlatformSettingsService, expectSuperAdminGuards(), guardNames(), ctx, SuperAdminGuard, UsersDataController (+1 more)
...
Cohesion: 0.07
Nodes (27): abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCheckout(), createPaymentIntent(), CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel(), interpolateNameFallback() (+19 more)
...
Cohesion: 0.09
Nodes (26): createTable(), createZone(), deleteTable(), deleteZone(), getLogoBase64(), getTables(), getTableSessions(), reorderZones() (+18 more)
...
Cohesion: 0.1
Nodes (21): DashboardSummary, createCategory(), createItem(), deleteCategory(), deleteItem(), getCategories(), getItems(), updateCategory() (+13 more)
...
Cohesion: 0.12
Nodes (8): CreateTableDto, UpdateTableDto, TablesController, mockOrders, mockOwner, mockRestaurant, mockTable, session
...
Cohesion: 0.11
Nodes (13): AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result, servedEntry (+5 more)
...
Cohesion: 0.15
Nodes (10): CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem, basePayload, dto, errors, UpdateOrderDto (+2 more)
...
Cohesion: 0.12
Nodes (14): 11. Role-Based Access Control (RBAC) Bypasses, 1. Alternative Payment Gateways (ePay, Borica, MyPos), A. Feature summary, A. Feature summary, A. Feature summary, B. Files involved, B. Files involved, B. Files involved (+6 more)
...
Cohesion: 0.14
Nodes (13): 21-Agent Codebase Audit — Complete Findings (107 total), 7. seed-safety-auditor (Seed Scripts), CRITICAL, CRITICAL, HIGH, HIGH, Historical Pending TODO (superseded; 0 explicit `**[TODO]**` finding rows now), Legend (+5 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/pages/pos/PosPage.tsx), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosItemGrid.tsx), code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/StaffRoute.tsx), File Structure (+3 more)
...
Cohesion: 0.22
Nodes (9): 9. i18n-validator (Translation Key Parity), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 232 - "Community 232"
Cohesion: 0.22
Nodes (9): 18. analytics-accuracy (Analytics & KPIs), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 233 - "Community 233"
Cohesion: 0.22
Nodes (9): 6. query-n1-detector (Database Performance), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 234 - "Community 234"
Cohesion: 0.22
Nodes (9): 14. print-station-auditor (Receipt Printers), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 235 - "Community 235"
Cohesion: 0.22
Nodes (9): 4. stripe-webhook-auditor (Stripe Integration), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 236 - "Community 236"
Cohesion: 0.22
Nodes (9): 13. epay-auditor (ePay.bg Payments), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 237 - "Community 237"
Cohesion: 0.22
Nodes (9): 20. super-admin-safety (Super-Admin Security), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 238 - "Community 238"
Cohesion: 0.22
Nodes (9): 11. borica-auditor (BORICA EMV-3DS Payments), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 239 - "Community 239"
Cohesion: 0.22
Nodes (9): 17. call-waiter-auditor (Assistance / Call Waiter), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 240 - "Community 240"
Cohesion: 0.22
Nodes (9): 15. auth-strategy-auditor (Authentication Perimeter), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 241 - "Community 241"
Cohesion: 0.22
Nodes (9): 16. subscription-tier-auditor (Billing & Tiers), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 242 - "Community 242"
Cohesion: 0.22
Nodes (9): 19. mypos-auditor (MyPOS Card Terminal), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 243 - "Community 243"
Cohesion: 0.22
Nodes (9): 2. pos-session-auditor (POS Session Lifecycle), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 244 - "Community 244"
Cohesion: 0.22
Nodes (9): 8. api-contract-guard (DTO/Schema Consistency), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 245 - "Community 245"
Cohesion: 0.22
Nodes (9): 12. device-enrollment-auditor (Staff Device Binding), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 246 - "Community 246"
Cohesion: 0.22
Nodes (9): 21. cart-order-consistency (Cart → Order Pipeline), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)

### Community 247 - "Community 247"
Cohesion: 0.22
Nodes (9): 3. loyalty-integrity (Loyalty Math), CRITICAL, CRITICAL, HIGH, HIGH, LOW, LOW, MEDIUM (+1 more)
...
Cohesion: 0.29
Nodes (7): 5. socket-event-tracer (Realtime Events), CRITICAL, CRITICAL, HIGH, HIGH, MEDIUM, MEDIUM

### Community 303 - "Community 303"
Cohesion: 0.29
Nodes (7): 10. migration-safety (Prisma Migrations), CRITICAL, CRITICAL, HIGH, HIGH, MEDIUM, MEDIUM
...
## Knowledge Gaps
- **4534 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4529 more)
...
- **Why does `FeatureService` connect `Community 8` to `Community 96`, `Community 34`, `Community 40`, `Community 138`, `Community 107`, `Community 12`, `Community 13`, `Community 11`, `Community 14`, `Community 16`, `Community 19`, `Community 121`, `Community 62`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 21` to `Community 8`, `Community 9`, `Community 20`, `Community 37`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `t` connect `Community 9` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 136`, `Community 140`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 24`, `Community 37`, `Community 41`, `Community 173`, `Community 49`, `Community 51`, `Community 58`, `Community 188`, `Community 66`, `Community 72`, `Community 73`, `Community 224`, `Community 97`, `Community 123`?**
