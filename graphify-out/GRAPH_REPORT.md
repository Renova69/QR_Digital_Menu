...
## Corpus Check
- 949 files · ~2,392,915 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17028 nodes · 21631 edges · 1528 communities (1442 shown, 86 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8c8833d`
...
- `LiveTablesView()` --calls--> `useSocket()`  [EXTRACTED]
  apps/frontend/src/pages/Dashboard/LiveTablesView.tsx → apps/frontend/src/context/SocketContext.tsx

## Communities (1528 total, 86 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (152): BannerSettings, TYPE_STYLES, CATEGORY_META, getGuideField(), getGuideSteps(), groupBy(), HelpCategory, HelpView() (+144 more)
...
Cohesion: 0.03
Nodes (85): PinLoginMeta, AuthUser, JwtStrategy, passwordChangedAt, prisma, WrapperType, DeepPartial, payment (+77 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (102): cartMocks, MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), normalizeTag() (+94 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (73): BASE_RESTAURANT, created, first, mockEvents, mockMenuTranslation, mockMenuTranslationRead, mockPrisma, mockStorage (+65 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (106): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), PrintStationsView(), ReservationsView(), api (+98 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (99): orderStatusKeyMap, CartItem, SelectedOption, KpiCardProps, AnalyticsData, useDailyTarget(), BoricaCardholderDetails, CheckoutProvider (+91 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (64): AvailabilityQueryDto, CreateReservationDto, ModifyReservationDto, BlackoutDto, CoverCountDto, ListReservationsQueryDto, ManualReservationDto, RESERVATION_ACTIONS (+56 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (93): RenovaBrand(), RenovaBrandProps, RenovaBrandSize, RenovaMark(), RenovaMarkProps, sizeStyles, DASHBOARD_LANGUAGES, Header() (+85 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (89): AssistanceContext, AssistanceContextType, AssistancePage, AssistanceRequest, useAssistance(), Order, OrderContext, OrderContextType (+81 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (47): BulkItemUpdateDto, BulkUpdateItemsDto, AvailabilityType, CreateCategoryDto, pipe, result, CreateItemDto, Currency (+39 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (55): CreateOrderDto, LoyaltyHistoryQueryDto, OrderQueryDto, UpdateOrderDto, isLoyaltyAvailable(), addDays(), addEarnedPointBatch(), ensureLoyaltyAccount() (+47 more)
...
Cohesion: 0.04
Nodes (62): CustomerLoginModal(), CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartProvider(), isValidOrderLocation() (+54 more)
...
Cohesion: 0.07
Nodes (31): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, EventsModule, FeedbackModule, HealthController (+23 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (54): Channel, COUNTRIES, CustomerLoginModalProps, Step, BulkEditView(), DashboardProfileModal(), DashboardProfileModalProps, DashboardUser (+46 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (42): filterConfig, FilterMode, LiveTablesView(), DashboardOrder, DashboardOrderItem, getOrderLocationText(), ORDER_STATUSES, OrdersContextValue (+34 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (56): addReservationBlackout(), createManualReservation(), getReservationAnalytics(), getReservationSettings(), listReservationBlackouts(), listReservations(), removeReservationBlackout(), reservationAction() (+48 more)
...
Cohesion: 0.05
Nodes (22): JwtAuthGuard, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto, CreatePaymentIntentDto, PaymentExportQueryDto, PaymentReconciliationQueryDto, RefundPaymentDto (+14 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (38): spy, storageMock, store, ThemeConsumer(), Theme, ThemeContext, ThemeContextValue, ThemeProvider() (+30 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (18): buildRestaurantDateRange(), buildRestaurantPresetDateRange(), RestaurantDateRange, CreateFeedbackDto, DateRangeQueryDto, FeedbackSummaryQueryDto, PaginatedResult, PaginationDto (+10 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (37): MenuTranslationReadService, ACTIVE_HOLD_STATUSES, AvailabilityDb, AvailabilitySlot, ReservationAvailabilityService, labels, { service }, { service, findMany } (+29 more)
...
Cohesion: 0.08
Nodes (30): getMethodLabel(), PaymentDrawer(), TimelineItem(), PaymentReconciliationQueueProps, ReconciliationDecision, exportPaymentsCsv(), formatDateTime(), formatMoney() (+22 more)
...
Cohesion: 0.05
Nodes (41): API Contract, Call-Waiter, Frontend, H-11: 20 files exceed 800-line limit, H-12: KitchenPage stale closure + interval churn, H-13: 5 providers missing `useMemo` on context value, H-14: AuthContext.refreshUser() no stale-response guard, H-15: Font `<link>` elements never cleaned up on unmount (+33 more)
...
Cohesion: 0.07
Nodes (26): PosCartItem, PosContext, PosContextType, PosSession, PosSessionInput, usePos(), useIdleTimer(), Category (+18 more)
...
Cohesion: 0.09
Nodes (29): PosProvider(), syncEngine, { result }, useCombined(), usePosOfflineSync(), createOrder(), asRecord(), classifySyncError() (+21 more)
...
Cohesion: 0.06
Nodes (35): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Call-Waiter Cooldown Bypass on Reload (May 29, 2026), CartContext `updateItem` Type Fix (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+27 more)

### Community 61 - "Community 61"
Cohesion: 0.06
Nodes (35): Analytics Deep-Dive Full i18n (May 24, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), CartContext `updateItem` Type Fix (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+27 more)
...
Cohesion: 0.06
Nodes (31): Atomic Refund — Race Condition Fix (May 23, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), CI Gate Added (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+23 more)
...
Cohesion: 0.13
Nodes (20): UseMenuSocketArgs, clearHostedCheckoutMarker(), hasHostedCheckoutMarker(), PaymentBanner, UsePaymentReturnArgs, abandonCheckout(), getCategoryItems(), buildTableSessionCheckoutUrl() (+12 more)
...
Cohesion: 0.12
Nodes (21): analyticsData, paymentRecord, rows, sheets, t, xlsxMocks, aggregateByMethod(), bgn() (+13 more)
...
Cohesion: 0.13
Nodes (16): AssistanceProvider(), PosTheme, PosThemeContext, PosThemeContextValue, PosThemeProvider(), usePosTheme(), PosCartDrawer(), PosThemeShell() (+8 more)
...
Cohesion: 0.13
Nodes (18): ReservationUpdatedPayload, useReservationRealtime(), getReservationConfig(), getReservationStatus(), DEFAULT_PUBLIC_DARK, DEFAULT_PUBLIC_LIGHT, getStoredPublicTheme(), hexToRgba() (+10 more)
...
Cohesion: 0.15
Nodes (11): cancelManageReservation(), getManageReservation(), getReservationAvailability(), modifyManageReservation(), BookingManagePage(), localDateISO(), ManageReservation, apiMocks (+3 more)
...
Cohesion: 0.2
Nodes (9): code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/SuperAdminRoute.tsx), code:tsx (import { useQuery } from "@tanstack/react-query";), code:bash (git add apps/frontend/src/pages/super-admin/OverviewPage.tsx), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 10: SuperAdminRoute — frontend guard, Task 13: OverviewPage — platform stats (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTableModal.tsx), code:bash (cd apps/backend && npx tsc --noEmit && npm test -- --passWit), code:bash (cd apps/frontend && npx tsc --noEmit && npm run build), code:bash (git add -A), File Structure, Task 18: Final verification — full build + POS smoke test (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Phase 2 (Frontend):), code:typescript (// apps/backend/src/auth/dto/pin-login.dto.ts), code:typescript (// apps/backend/src/users/dto/create-staff.dto.ts), code:bash (git add apps/backend/src/auth/dto/pin-login.dto.ts apps/back), code:tsx ({), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), File Structure, Task 4.2: Create Validation DTOs (+1 more)
...
Cohesion: 0.25
Nodes (5): first, names, { result }, second, summary
...
- **Why does `FeatureService` connect `Community 2` to `Community 280`, `Community 129`, `Community 1`, `Community 4`, `Community 67`, `Community 7`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 182`, `Community 88`, `Community 26`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `PublicMenuContent()` connect `Community 13` to `Community 8`, `Community 2`, `Community 36`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 8` to `Community 0`, `Community 3`, `Community 5`, `Community 6`, `Community 9`, `Community 41`, `Community 170`, `Community 13`, `Community 175`, `Community 48`, `Community 17`?**
