# Graph Report - QR_Digital_Menu-main  (2026-06-18)

## Corpus Check
- 577 files · ~861,937 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7614 nodes · 10062 edges · 579 communities (513 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7179c365`
...
## Communities (579 total, 66 thin omitted)
...
Cohesion: 0.03
Nodes (78): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), bondSection (+70 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (74): CATEGORY_META, getGuideField(), getGuideSteps(), groupBy(), HelpCategory, HelpView(), ICON_MAP, filterConfig (+66 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (43): AuthUser, JwtAuthGuard, JwtStrategy, passwordChangedAt, prisma, BillingPeriod, CheckoutTier, CreateCheckoutDto (+35 more)
...
Cohesion: 0.04
Nodes (59): RestaurantList(), RestaurantContextType, AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState() (+51 more)
...
Cohesion: 0.04
Nodes (48): CustomerLoginModal(), CartDrawer(), CustomTooltip(), KpiCard(), KpiCardProps, BoricaCardholderDetails, CheckoutProvider, createCheckout() (+40 more)
...
Cohesion: 0.05
Nodes (39): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, names, { result }, summary (+31 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (21): OptionalJwtStrategy, passwordChangedAt, prisma, AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews (+13 more)
...
Cohesion: 0.06
Nodes (41): AnalyticsData, CategoryBreakdown, OrderStatusBreakdown, PeakHour, RevenueTrendPoint, TableMetric, TopItem, bgn() (+33 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (36): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider() (+28 more)
...
Cohesion: 0.09
Nodes (25): Channel, COUNTRIES, CustomerLoginModalProps, Step, getGoogleReviewUrl(), submitFeedback(), EditItemForm(), EditItemFormProps (+17 more)
...
Cohesion: 0.08
Nodes (30): ApiKeyPanel(), csvToPayload(), downloadMenuXLSX(), ExportTab(), FileImporter(), ImportTab(), KNOWN_ALLERGENS, MenuImportExportView() (+22 more)
...
Cohesion: 0.12
Nodes (20): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), useMenu(), CategoryList() (+12 more)
...
Cohesion: 0.12
Nodes (13): MenuImportService, after, before, FREE_RESTAURANT, mockEvents, mockMenuImport, mockPrisma, PROFESSIONAL_RESTAURANT (+5 more)
...
Cohesion: 0.09
Nodes (18): CategoryPills(), CategoryPillsProps, LANG_CODES, TopBar(), TopBarProps, advantageItems, comparisonRows, DashboardPreview() (+10 more)
...
Cohesion: 0.13
Nodes (17): abandonCheckout(), createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), generateUUID(), getVisitorId(), FilterPanel() (+9 more)

### Community 98 - "Community 98"
Cohesion: 0.13
Nodes (15): DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, PrintStationsView(), changePassword(), getPrintStations(), updateProfile(), CategorySettingsModalProps (+7 more)
...
Cohesion: 0.16
Nodes (16): addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress(), markRemindersSent(), redeemAccountPoints(), batches (+8 more)
...
Cohesion: 0.17
Nodes (11): getTrendingItems(), getImageUrl(), getTranslatedArray(), getTranslatedField(), Translatable, ImageLightbox(), ImageLightboxProps, ItemWithOptionsProps (+3 more)

### Community 121 - "Community 121"
Cohesion: 0.13
Nodes (9): DashboardSummary, AvailabilityType, Order, OrderStatus, PaginatedResponse, StaffMember, SuperAdminStats, TenantDetail (+1 more)

### Community 122 - "Community 122"
Cohesion: 0.12
Nodes (14): PaymentMethod, PaymentStatus, getMethodLabel(), PaymentTab, PaymentTable(), PayoutsPanel(), SettingsPanel(), getPaymentDetail() (+6 more)
...
Cohesion: 0.24
Nodes (10): translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles, openStripePayment(), PaymentDetail, PaymentRecord (+2 more)
...
Cohesion: 0.18
Nodes (11): getMethodLabel(), PaymentDrawer(), TimelineItem(), MetricCard(), PaymentsView(), SettingCard(), cn(), formatElapsed() (+3 more)
...
Cohesion: 0.17
Nodes (12): c(), Aa(), ei(), En(), it(), ja(), Ke(), lt() (+4 more)

### Community 176 - "Community 176"
Cohesion: 0.32
Nodes (10): createCategory(), createItem(), deleteCategory(), deleteItem(), getCategories(), getItems(), updateCategory(), updateItem() (+2 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTableModal.tsx), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosSeatSelector.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), File Structure (+3 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Phase 2 (Frontend):), code:bash (cd apps/backend && ls src/users/), code:typescript (// Add to apps/backend/src/auth/auth.controller.ts:), code:bash (git add apps/backend/src/auth/auth.controller.ts), code:typescript (// Add these imports at top of menu-crud.service.ts (alongsi), code:bash (git add apps/backend/src/menu/menu-crud.service.ts), File Structure, Task 3.1: Move getPublicMenu + getTrendingItems into MenuCrudService (+1 more)
...
## Knowledge Gaps
- **4327 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4322 more)
...
- **Why does `FeatureService` connect `Community 7` to `Community 34`, `Community 102`, `Community 71`, `Community 8`, `Community 12`, `Community 13`, `Community 14`, `Community 81`, `Community 52`, `Community 90`, `Community 60`, `Community 94`, `Community 31`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 97` to `Community 132`, `Community 7`, `Community 9`, `Community 19`, `Community 21`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 9` to `Community 3`, `Community 132`, `Community 5`, `Community 6`, `Community 11`, `Community 140`, `Community 15`, `Community 144`, `Community 143`, `Community 18`, `Community 19`, `Community 21`, `Community 153`, `Community 37`, `Community 39`, `Community 177`, `Community 178`, `Community 55`, `Community 65`, `Community 199`, `Community 327`, `Community 82`, `Community 83`, `Community 222`, `Community 223`, `Community 97`, `Community 98`, `Community 120`, `Community 122`, `Community 123`?**
