...
## Summary
- 5980 nodes · 7753 edges · 480 communities (435 shown, 45 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e50ff1bf`
...
## Communities (480 total, 45 thin omitted)
...
Cohesion: 0.03
Nodes (74): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), Order, OrderContext, OrderContextType (+66 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (50): RestaurantContextType, filterConfig, FilterMode, LiveTablesView(), SITE_COOKIES, api, closeSession(), createTable() (+42 more)
...
Cohesion: 0.07
Nodes (25): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, OptionalJwtStrategy, DashboardModule, EventsModule, FeedbackModule (+17 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (13): JwtAuthGuard, MenuAuditController, CategoryController, CategoryDetailController, MenuAuditService, MenuModule, MenuOptionController, PublicMenuController (+5 more)
...
Cohesion: 0.07
Nodes (34): Channel, COUNTRIES, CustomerLoginModalProps, Step, CartDrawer(), CartIcon(), CartIconProps, CartContext (+26 more)
...
Cohesion: 0.07
Nodes (30): RestaurantContext, useRestaurantContext(), SettingsTab, SettingsView(), bondSection, { container }, mockRestaurant, mockT (+22 more)
...
Cohesion: 0.07
Nodes (11): AssistanceController, AssistanceService, CreateAssistanceDto, CreateFeedbackDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto (+3 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (34): ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo, SubscriptionTier, TIER_FEATURES, useTier() (+26 more)
...
Cohesion: 0.08
Nodes (35): BrandingPreview(), BrandingPreviewProps, Device, Scene, SCENE_KEYS, ColorSchemeEditor(), ColorSchemeEditorProps, ColorSwatchProps (+27 more)
...
Cohesion: 0.07
Nodes (24): MenuContext, MenuContextType, MenuProvider(), DashboardSummary, useMenu(), getTrendingItems(), EditItemForm(), EditItemFormProps (+16 more)
...
Cohesion: 0.09
Nodes (11): JwtStrategy, dto, dtoWithRedirect, mockPrisma, PlatformSettingsService, jitteredDelay(), PrismaService, RetentionService (+3 more)
...
Cohesion: 0.11
Nodes (27): useMenuContext(), AuditIssue, MenuCheckWidget(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps, DAYS, CreateCategoryForm() (+19 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (25): createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), getImageUrl(), getTranslatedArray(), getTranslatedField(), Translatable (+17 more)
...
Cohesion: 0.08
Nodes (21): ErrorBoundary, Props, State, NotificationBell(), PaymentToast(), renderWithProviders(), NotificationContext, NotificationContextType (+13 more)
...
Cohesion: 0.1
Nodes (22): CustomTooltip(), createPaymentIntent(), formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual(), BillData, BillItem (+14 more)
...
Cohesion: 0.09
Nodes (10): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, EventsGateway, parseCookie() (+2 more)
...
Cohesion: 0.07
Nodes (22): createDeviceEnrollment(), createStaff(), listDeviceEnrollments(), removeStaff(), resetStaffPin(), StaffMember, updateStaff(), DeviceEnrollment (+14 more)
...
Cohesion: 0.15
Nodes (8): CreateHelpContentDto, ReorderHelpContentDto, ReorderItem, UpdateHelpContentDto, HelpContentController, dto, mockService, HelpContentModule
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosSeatSelector.tsx), code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/StaffRoute.tsx), File Structure (+3 more)
...
Cohesion: 0.21
Nodes (4): LiveTablesGridProps, TableData, QuickAction, QuickActionsRowProps
...
- **Why does `FeatureService` connect `Community 92` to `Community 131`, `Community 100`, `Community 67`, `Community 38`, `Community 72`, `Community 10`, `Community 76`, `Community 14`, `Community 48`, `Community 23`, `Community 28`, `Community 125`, `Community 31`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 34` to `Community 16`, `Community 9`, `Community 92`, `Community 17`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 16` to `Community 33`, `Community 34`, `Community 3`, `Community 4`, `Community 37`, `Community 70`, `Community 135`, `Community 8`, `Community 9`, `Community 12`, `Community 15`, `Community 182`?**
