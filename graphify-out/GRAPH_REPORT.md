...
## Corpus Check
- 579 files · ~864,582 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7627 nodes · 10094 edges · 582 communities (513 shown, 69 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 187 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d64558e`
...
## Communities (582 total, 69 thin omitted)
...
Cohesion: 0.03
Nodes (39): JwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency (+31 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (61): filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage() (+53 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (38): PinLoginMeta, AuthUser, OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto, DateRangeQueryDto, OrderQueryDto (+30 more)
...
Cohesion: 0.06
Nodes (54): Channel, COUNTRIES, CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider(), useMenuContext() (+46 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (54): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+46 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (53): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, NotificationContext, NotificationContextType (+45 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (54): CATEGORY_META, getGuideField(), getGuideSteps(), groupBy(), HelpCategory, HelpView(), ICON_MAP, ALL_FEATURE_FLAGS (+46 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (41): draft, PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, names, { result } (+33 more)
...
Cohesion: 0.09
Nodes (22): AssistanceModule, DashboardModule, EventsModule, HealthController, HealthModule, LoyaltyModule, MenuImportModule, MenuViewModule (+14 more)
...
Cohesion: 0.08
Nodes (36): CustomerLoginModal(), CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider() (+28 more)
...
Cohesion: 0.06
Nodes (23): AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result, servedEntry (+15 more)
...
Cohesion: 0.06
Nodes (32): useAssistance(), Order, OrderContext, OrderContextType, OrderStatus, useOrders(), AssistanceContextValue, AssistanceRequest (+24 more)
...
Cohesion: 0.1
Nodes (30): getMethodLabel(), PaymentDrawer(), TimelineItem(), translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles (+22 more)
...
Cohesion: 0.08
Nodes (23): AgentToken, PrintStation, PrintStationsView(), ReceiptTemplate, StationHealth, SummaryCardProps, createPrintStation(), deletePrintStation() (+15 more)
...
Cohesion: 0.07
Nodes (26): abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCheckout(), createPaymentIntent(), getSessionBill(), CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel() (+18 more)
...
Cohesion: 0.12
Nodes (18): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, burger, call, existingAcc, makeMenuItem(), makeRestaurant() (+10 more)
...
Cohesion: 0.11
Nodes (9): AuthModule, GoogleStrategy, JwtStrategy, passwordChangedAt, prisma, LocalStrategy, OptionalJwtStrategy, passwordChangedAt (+1 more)
...
Cohesion: 0.11
Nodes (18): code:bash (git add CODING_ROADMAP.md CLAUDE.md), code:typescript (@Post(':id/stripe/connect')), code:typescript (import { Module } from '@nestjs/common';), code:bash (cd apps/backend && npm test -- --no-coverage), code:bash (git add apps/backend/src/restaurants/restaurants.controller.), code:typescript (// Payment / TableSession), code:bash (git add apps/frontend/src/lib/api.ts), code:tsx (import { useState, useEffect } from 'react';) (+10 more)
...
Cohesion: 0.14
Nodes (14): c(), Aa(), De(), ei(), En(), it(), ja(), Ke() (+6 more)
...
Cohesion: 0.2
Nodes (9): code:tsx (import { useQuery } from "@tanstack/react-query";), code:bash (git add apps/frontend/src/pages/super-admin/OverviewPage.tsx), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/pages/super-admin/TenantsPage.tsx), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 13: OverviewPage — platform stats, Task 14: TenantsPage — searchable tenant table (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import PosSplitBill from "./PosSplitBill";), code:tsx (<PosSplitBill total={total} />), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), File Structure, Task 17: Integration — wire Phase D components into PosCartDrawer (+1 more)
...
## Knowledge Gaps
- **4331 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4326 more)
...
- **Why does `FeatureService` connect `Community 6` to `Community 35`, `Community 100`, `Community 101`, `Community 4`, `Community 13`, `Community 77`, `Community 78`, `Community 15`, `Community 84`, `Community 87`, `Community 152`, `Community 88`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 55` to `Community 32`, `Community 6`, `Community 9`, `Community 16`, `Community 17`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 9` to `Community 5`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 17`, `Community 145`, `Community 144`, `Community 23`, `Community 32`, `Community 37`, `Community 44`, `Community 177`, `Community 178`, `Community 51`, `Community 55`, `Community 56`, `Community 59`, `Community 66`, `Community 197`, `Community 331`, `Community 85`, `Community 89`, `Community 221`, `Community 102`, `Community 103`, `Community 235`, `Community 116`, `Community 124`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Are the 154 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
