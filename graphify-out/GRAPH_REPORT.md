...
## Corpus Check
- 564 files · ~850,256 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7495 nodes · 9897 edges · 570 communities (506 shown, 64 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 183 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d94546a`
...
## Communities (570 total, 64 thin omitted)
...
Cohesion: 0.04
Nodes (74): Channel, COUNTRIES, CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider(), useMenuContext() (+66 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (75): CustomerLoginModal(), CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider() (+67 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (72): filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage() (+64 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (72): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS (+64 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (35): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto (+27 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (38): AuthUser, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto (+30 more)
...
Cohesion: 0.04
Nodes (55): RestaurantContextType, AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate() (+47 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (27): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, OptionalJwtStrategy, DashboardModule, EventsModule, FeedbackModule (+19 more)
...
Cohesion: 0.06
Nodes (31): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, names, { result }, summary (+23 more)
...
Cohesion: 0.07
Nodes (22): AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result, servedEntry (+14 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (29): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider(), mockUser, TestConsumer() (+21 more)
...
Cohesion: 0.07
Nodes (25): DASHBOARD_LANGUAGES, Header(), spy, storageMock, store, ThemeConsumer(), Theme, ThemeContext (+17 more)
...
Cohesion: 0.1
Nodes (22): Order, OrderContext, OrderContextType, OrderProvider(), OrderStatus, useOrders(), RestaurantProvider(), SocketContext (+14 more)
...
Cohesion: 0.09
Nodes (18): CreateRestaurantForm(), RestaurantList(), RestaurantContext, AuditIssue, MenuCheckWidget(), bondSection, { container }, mockRestaurant (+10 more)
...
Cohesion: 0.11
Nodes (20): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), AssistanceContextValue, AssistanceRequest, AssistanceView() (+12 more)
...
Cohesion: 0.14
Nodes (8): CreateHelpContentDto, ReorderHelpContentDto, ReorderItem, UpdateHelpContentDto, dto, mockService, HelpContentModule, HelpContentService
...
Cohesion: 0.17
Nodes (15): ErrorBoundary, Props, State, renderWithProviders(), ClientLogLevel, ClientLogPayload, getClientSessionId(), logApiError() (+7 more)
...
Cohesion: 0.15
Nodes (15): NotificationBell(), PaymentToast(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications(), BOTTOM_NAV_TABS (+7 more)
...
Cohesion: 0.18
Nodes (14): getMethodLabel(), PaymentDrawer(), translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles, openStripePayment() (+6 more)
...
Cohesion: 0.14
Nodes (12): getMethodLabel(), PaymentTab, PaymentTable(), PayoutsPanel(), SettingsPanel(), getPaymentDetail(), getPaymentHistory(), getPaymentOverview() (+4 more)
...
Cohesion: 0.15
Nodes (7): DashboardOrder, DashboardOrderItem, getElapsedLabel(), ORDER_STATUSES, OrdersContextValue, SourceBadge(), statusAccent
...
Cohesion: 0.22
Nodes (9): TimelineItem(), MetricCard(), PaymentsView(), SettingCard(), cn(), formatElapsed(), statusConfig, TableCard() (+1 more)
...
Cohesion: 0.2
Nodes (5): installGlobalErrorLogging(), resources, container, queryClient, root
...
Cohesion: 0.22
Nodes (9): code:block1 (Create:), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:bash (cd apps/backend && npx tsc --noEmit && npm test -- --passWit), code:bash (cd apps/frontend && npx tsc --noEmit && npm run build), code:bash (git add -A), File Structure, Task 13: PosCartDrawer — cart panel + submit (+1 more)
...
- **Why does `FeatureService` connect `Community 9` to `Community 34`, `Community 101`, `Community 122`, `Community 69`, `Community 8`, `Community 12`, `Community 13`, `Community 78`, `Community 142`, `Community 154`, `Community 92`, `Community 63`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 5` to `Community 25`, `Community 11`, `Community 9`, `Community 14`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 11` to `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 14`, `Community 16`, `Community 145`, `Community 146`, `Community 147`, `Community 20`, `Community 25`, `Community 156`, `Community 32`, `Community 35`, `Community 54`, `Community 57`, `Community 64`, `Community 197`, `Community 70`, `Community 198`, `Community 76`, `Community 80`, `Community 220`, `Community 221`, `Community 94`, `Community 102`, `Community 106`, `Community 114`, `Community 120`?**
