...
## Summary
- 8101 nodes · 10735 edges · 597 communities (531 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eac39c9a`
...
## Communities (597 total, 66 thin omitted)
...
Cohesion: 0.02
Nodes (99): CreateRestaurantForm(), NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance() (+91 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (89): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, RestaurantProvider(), useRestaurantContext(), SettingsTab (+81 more)
...
Cohesion: 0.03
Nodes (67): draft, PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names (+59 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (65): RestaurantContextType, filterConfig, FilterMode, LiveTablesView(), api, AssistanceRequestType, BoricaCheckoutResponse, CheckoutResponse (+57 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (39): PinLoginMeta, OptionalJwtStrategy, passwordChangedAt, prisma, WrapperType, AnalyticsResult, canceledEntry, defaultAggregate (+31 more)
...
Cohesion: 0.06
Nodes (33): AuthUser, JwtAuthGuard, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateRestaurantDto, DateRangeQueryDto, RefundPaymentDto, errors (+25 more)
...
Cohesion: 0.04
Nodes (52): RestaurantList(), AuditIssue, MenuCheckWidget(), ApiKeyPanel(), csvToPayload(), ExportTab(), FileImporter(), ImportTab() (+44 more)
...
Cohesion: 0.07
Nodes (31): UpdateOrderDto, isLoyaltyAvailable(), addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress(), getRewardValue() (+23 more)
...
Cohesion: 0.09
Nodes (28): getTrendingItems(), formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual(), getImageUrl(), getTranslatedArray(), getTranslatedField() (+20 more)
...
Cohesion: 0.08
Nodes (28): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, SelectedOption, useCart() (+20 more)
...
Cohesion: 0.06
Nodes (25): confirmCheckoutSession(), generateStripeConnectLink(), updateOnboardingStep(), Billing, getVisibleSteps(), OnboardingPage(), PAID_TIERS, PAYMENT_TIERS (+17 more)
...
Cohesion: 0.07
Nodes (22): CartProvider(), CategoryPills(), CategoryPillsProps, Footer(), FooterProps, linkifyPhones(), LANG_CODES, TopBar() (+14 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (23): AnalyticsView(), CategoryMix(), CHART_COLORS, CustomTooltip(), dayPartKeyMap, dayParts, EmptyState(), formatDate() (+15 more)
...
Cohesion: 0.07
Nodes (13): MenuAuditService, cat1, cat2, category, errorIssues, info, item, mockPrisma (+5 more)
...
Cohesion: 0.11
Nodes (9): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, ApiKeyGuard, mockPrisma, MenuImportController (+1 more)

### Community 78 - "Community 78"
Cohesion: 0.11
Nodes (6): UpdatePlatformSettingsDto, PlatformSettingsService, RetentionService, UsersDataController, UsersDataModule, UsersDataService
...
Cohesion: 0.12
Nodes (10): categories, category, [firstChunk], item, mockPrisma, mockTranslation, option, [texts] (+2 more)
...
Cohesion: 0.17
Nodes (8): AvailabilityType, CreateCategoryDto, CreateMenuOptionDto, UpdateCategoryDto, UpdateMenuOptionDto, allowedTypes, CategoryDetailController, MenuOptionController
...
Cohesion: 0.12
Nodes (15): SummaryView(), UpgradeBanner(), usePaymentSummary(), useScanStats(), getLoyaltyAnalytics(), getPaymentSummary(), LiveTablesGrid(), LiveTablesGridProps (+7 more)
...
Cohesion: 0.15
Nodes (8): BASE_RESTAURANT, mockMenuTranslation, mockPrisma, mockStorage, mockTranslation, option, spy, MenuTranslationService
...
Cohesion: 0.24
Nodes (9): DateRangePreset, formatDate(), SummaryDateRange, useSummaryDateRange(), CustomDateInput(), DateRangeFilter(), DateRangeFilterProps, isoToDisplayDate() (+1 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/pages/pos/PosPage.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)

### Community 232 - "Community 232"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/context/AuthContext.tsx), code:typescript (// Add to UsersService class in apps/backend/src/users/users), code:bash (git add apps/backend/src/users/users.service.ts), code:bash (git add apps/frontend/src/context/AuthContext.tsx apps/front), code:tsx (import { BrowserRouter as Router, Routes, Route, Outlet } fr), code:bash (git add apps/frontend/src/App.tsx), File Structure (+3 more)
...
Cohesion: 0.57
Nodes (3): CreatePrintStationDto, UpdatePrintStationDto, GenerateTokenDto
...
- **Why does `FeatureService` connect `Community 39` to `Community 100`, `Community 165`, `Community 101`, `Community 103`, `Community 8`, `Community 138`, `Community 12`, `Community 141`, `Community 77`, `Community 15`, `Community 47`, `Community 16`, `Community 18`, `Community 53`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 32` to `Community 31`, `Community 21`, `Community 14`, `Community 39`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `t` connect `Community 14` to `Community 256`, `Community 257`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 11`, `Community 142`, `Community 17`, `Community 21`, `Community 25`, `Community 154`, `Community 31`, `Community 32`, `Community 36`, `Community 166`, `Community 40`, `Community 49`, `Community 55`, `Community 56`, `Community 61`, `Community 197`, `Community 71`, `Community 79`, `Community 213`, `Community 214`, `Community 87`, `Community 348`, `Community 108`, `Community 240`, `Community 120`?**
