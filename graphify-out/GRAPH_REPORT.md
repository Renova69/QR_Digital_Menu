...
## Corpus Check
- 594 files · ~900,375 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8135 nodes · 10813 edges · 594 communities (522 shown, 72 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 195 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9d3c380d`
...
## Communities (594 total, 72 thin omitted)
...
Cohesion: 0.03
Nodes (84): filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage() (+76 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (85): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), bondSection (+77 more)
...
Cohesion: 0.04
Nodes (68): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AssistanceContext, AssistanceContextType, AssistanceProvider() (+60 more)
...
Cohesion: 0.04
Nodes (60): NotificationBell(), PaymentToast(), useAssistance(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications() (+52 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (24): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto (+16 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (58): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+50 more)
...
Cohesion: 0.05
Nodes (34): AuthUser, OptionalJwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, CreateOrderDto, OrderItemDto, OrderItemOptionDto (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (56): PaymentRecord, bgn(), Cell, dayParts, downloadAnalyticsExport(), empty(), eur(), ExportMeta (+48 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (45): isLoyaltyAvailable(), addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress(), getRewardValue(), markRemindersSent() (+37 more)
...
Cohesion: 0.06
Nodes (46): getMethodLabel(), PaymentDrawer(), TimelineItem(), translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles (+38 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (26): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, WrapperType, CreatePrintStationDto, CreateTableDto, UpdatePrintStationDto (+18 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (37): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), PrintStationsView(), useMenu(), getPrintStations(), CategoryList() (+29 more)
...
Cohesion: 0.06
Nodes (30): abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCashPaymentRequest(), createCheckout(), createPaymentIntent(), CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel() (+22 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (33): BrandingPreview(), BrandingPreviewProps, Device, Scene, SCENE_KEYS, ColorSchemeEditor(), ColorSchemeEditorProps, ColorSwatch() (+25 more)

### Community 37 - "Community 37"
Cohesion: 0.08
Nodes (28): DashboardSummary, ChoiceInput, ManageOptionsModal(), ManageOptionsModalProps, PRESETS, createCategory(), createItem(), deleteCategory() (+20 more)
...
Cohesion: 0.07
Nodes (28): CreateRestaurantForm(), RestaurantList(), RestaurantContext, RestaurantContextType, AssistanceContextValue, AssistanceRequest, getCashRequestScopeLabel(), getCashRequestStatusLabel() (+20 more)
...
Cohesion: 0.08
Nodes (26): getTrendingItems(), getImageUrl(), getTranslatedArray(), getTranslatedField(), Translatable, CategoryPills(), CategoryPillsProps, ImageLightbox() (+18 more)
...
Cohesion: 0.09
Nodes (24): createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), clearOwnedOrderIds(), getOwnedOrderIds(), ownedOrdersKey(), rememberOwnedOrder() (+16 more)
...
Cohesion: 0.09
Nodes (6): UpdatePlatformSettingsDto, PlatformSettingsController, PlatformSettingsService, RetentionService, UsersDataController, UsersDataService
...
Cohesion: 0.07
Nodes (28): 4. stripe-webhook-auditor (Stripe Integration), 5. socket-event-tracer (Realtime Events), CRITICAL, CRITICAL, CRITICAL, CRITICAL, CRITICAL, CRITICAL (+20 more)
...
Cohesion: 0.1
Nodes (15): AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result, servedEntry (+7 more)
...
Cohesion: 0.11
Nodes (19): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, EpayCheckoutForm, EpayCheckoutParams, EpayMode, EpayNotification (+11 more)
...
Cohesion: 0.12
Nodes (17): 18. analytics-accuracy (Analytics & KPIs), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)
...
Cohesion: 0.15
Nodes (8): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, SubscriptionController, PrintableQRCodes(), resolveLogoUrl()
...
Cohesion: 0.12
Nodes (16): 17. call-waiter-auditor (Assistance / Call Waiter), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+8 more)
...
Cohesion: 0.13
Nodes (15): 6. query-n1-detector (Database Performance), CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH, LOW (+7 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosItemGrid.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), File Structure (+3 more)

### Community 231 - "Community 231"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), code:typescript (// Add these imports at top of menu-crud.service.ts (alongsi), code:bash (git add apps/backend/src/menu/menu-crud.service.ts), File Structure (+3 more)
...
Cohesion: 0.27
Nodes (9): ClassicCard(), getQrCodeUrl(), MinimalCard(), PremiumCard(), PrintableQRCodesProps, PrintOrientation, PrintTemplate, normalizeTableName() (+1 more)
...
Cohesion: 0.21
Nodes (8): Files Changed, Files Changed, Fix, Fix, Problem, Problem, Seed Safety — Data Wipe Prevention (May 22, 2026), TableCard Redesign — Compact Layout + Live Timer (May 24, 2026)
...
## Knowledge Gaps
- **4704 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4699 more)
...
- **Why does `FeatureService` connect `Community 13` to `Community 133`, `Community 134`, `Community 40`, `Community 10`, `Community 172`, `Community 46`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 86`, `Community 24`, `Community 92`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 55` to `Community 36`, `Community 6`, `Community 9`, `Community 11`, `Community 13`, `Community 22`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `t` connect `Community 11` to `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 8`, `Community 9`, `Community 137`, `Community 138`, `Community 14`, `Community 18`, `Community 20`, `Community 22`, `Community 35`, `Community 36`, `Community 37`, `Community 164`, `Community 39`, `Community 41`, `Community 44`, `Community 55`, `Community 64`, `Community 198`, `Community 215`, `Community 96`, `Community 100`, `Community 239`, `Community 255`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Are the 161 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
  _`t` has 161 INFERRED edges - model-reasoned connections that need verification._
