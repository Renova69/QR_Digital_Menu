# Graph Report - QR_Digital_Menu-main  (2026-06-05)

## Corpus Check
- 496 files · ~721,684 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6098 nodes · 7936 edges · 487 communities (436 shown, 51 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d1b2d02`
...
9. `PaymentService` - 41 edges
10. `MenuCrudService` - 36 edges
...
- `CustomTooltip()` --calls--> `formatEuro()`  [EXTRACTED]
  apps/frontend/src/pages/Dashboard/AnalyticsView.tsx → apps/frontend/src/lib/currency.ts
- `main()` --calls--> `seedHelpContent()`  [EXTRACTED]
  apps/backend/prisma/seed-help-only.ts → apps/backend/prisma/seed-help-content.ts

## Communities (487 total, 51 thin omitted)
...
Cohesion: 0.03
Nodes (71): useDebouncedValue(), SITE_COOKIES, api, CheckoutResponse, closeSession(), closeSessionWithCard(), closeSessionWithCash(), createDeviceEnrollment() (+63 more)
...
Cohesion: 0.04
Nodes (54): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS (+46 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (49): NotificationBell(), PaymentToast(), useAssistance(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications() (+41 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (48): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, Order, OrderContext, OrderContextType, OrderProvider() (+40 more)
...
Cohesion: 0.08
Nodes (24): AssistanceModule, AuthModule, GoogleStrategy, OptionalJwtStrategy, DashboardModule, EventsModule, HealthController, HealthModule (+16 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (16): PaymentService, created, epayPayment, epayRestaurant, existing, existingSession, lockedFeatureService, lockedService (+8 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (20): JwtStrategy, passwordChangedAt, prisma, LocalStrategy, BillingPeriod, CheckoutTier, CreateCheckoutDto, FeatureService (+12 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (22): AuthUser, JwtAuthGuard, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto, OrderItemOptionDto, DateRangeQueryDto (+14 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (26): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, AnalyticsResult, canceledEntry (+18 more)
...
Cohesion: 0.04
Nodes (4): DashboardController, PublicMenuController, PaymentController, RestaurantsController
...
Cohesion: 0.06
Nodes (30): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, names, { result }, summary (+22 more)
...
Cohesion: 0.07
Nodes (33): CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption, useCart() (+25 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (32): CheckoutProvider, createCheckout(), createPaymentIntent(), formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual(), CheckoutPage() (+24 more)
...
Cohesion: 0.07
Nodes (15): ApiKeyGuard, mockPrisma, MenuImportController, mockFeatureService, mockPrisma, mockStorageService, tx, VALID_AVAILABILITY (+7 more)
...
Cohesion: 0.09
Nodes (26): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider(), mockUser, TestConsumer() (+18 more)
...
Cohesion: 0.08
Nodes (19): RestaurantContext, RestaurantContextType, AuditIssue, MenuCheckWidget(), bondSection, { container }, mockRestaurant, mockT (+11 more)
...
Cohesion: 0.12
Nodes (20): getMethodLabel(), PaymentDrawer(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles, openStripePayment(), PaymentDetail (+12 more)
...
Cohesion: 0.11
Nodes (13): OrdersService, burger, existingAcc, makeMenuItem(), makeRestaurant(), makeTx(), mockAuthenticatedCustomer(), order (+5 more)
...
Cohesion: 0.11
Nodes (13): EpayCheckoutForm, EpayCheckoutParams, EpayMode, EpayNotification, EpayNotificationStatus, EpayPage, EpayProvider, checksum (+5 more)
...
Cohesion: 0.11
Nodes (11): SummaryView(), usePaymentSummary(), getLoyaltyAnalytics(), getOrders(), getPaymentSummary(), LiveTablesGridProps, TableData, LoyaltyData (+3 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCategoryFilter.t), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)
...
## Knowledge Gaps
- **3521 isolated node(s):** `prisma`, `prisma`, `Stripe`, `{ PrismaClient }`, `prisma` (+3516 more)
...
- **Why does `FeatureService` connect `Community 12` to `Community 34`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 23`, `Community 24`, `Community 125`, `Community 62`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 21` to `Community 12`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 31` to `Community 128`, `Community 2`, `Community 101`, `Community 5`, `Community 7`, `Community 6`, `Community 9`, `Community 44`, `Community 50`, `Community 19`, `Community 21`, `Community 22`, `Community 53`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **What connects `prisma`, `prisma`, `Stripe` to the rest of the system?**
