...
## Summary
- 7494 nodes · 9896 edges · 569 communities (507 shown, 62 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 183 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5a9e74c4`
...
## Communities (569 total, 62 thin omitted)
...
Cohesion: 0.03
Nodes (79): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AssistanceContext, AssistanceContextType, AssistanceProvider() (+71 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (44): AuthUser, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto (+36 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (71): filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage() (+63 more)
...
Cohesion: 0.04
Nodes (31): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+23 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (55): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS (+47 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (56): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+48 more)
...
Cohesion: 0.04
Nodes (47): CreateRestaurantForm(), NotificationBell(), PaymentToast(), useAssistance(), useNotifications(), useOrders(), AssistanceContextValue, AssistanceRequest (+39 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (44): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), useMenu(), getGoogleReviewUrl() (+36 more)
...
Cohesion: 0.06
Nodes (20): AssistanceService, dto, mockEvents, mockFeatureService, mockPrisma, req, updated, CreateAssistanceDto (+12 more)
...
Cohesion: 0.08
Nodes (32): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+24 more)
...
Cohesion: 0.09
Nodes (25): DashboardSummary, getTrendingItems(), TrendingCarouselProps, createCategory(), createItem(), deleteCategory(), deleteItem(), getCategories() (+17 more)
...
Cohesion: 0.06
Nodes (31): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Call-Waiter Cooldown Bypass on Reload (May 29, 2026), CI Gate Added (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+23 more)
...
Cohesion: 0.07
Nodes (24): createDeviceEnrollment(), createStaff(), listDeviceEnrollments(), listStaff(), removeStaff(), resetStaffPin(), StaffMember, updateStaff() (+16 more)
...
Cohesion: 0.1
Nodes (19): RestaurantList(), RestaurantContext, RestaurantContextType, bondSection, { container }, mockRestaurant, mockT, store (+11 more)
...
Cohesion: 0.18
Nodes (10): code:block1 (Phase 2 (Frontend):), code:typescript (// Add to UsersService class in apps/backend/src/users/users), code:bash (git add apps/backend/src/users/users.service.ts), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), File Structure, RBAC Sprint Implementation Plan, Self-Review (+2 more)
...
- **Why does `FeatureService` connect `Community 5` to `Community 96`, `Community 67`, `Community 7`, `Community 105`, `Community 9`, `Community 74`, `Community 16`, `Community 82`, `Community 83`, `Community 148`, `Community 30`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 33` to `Community 4`, `Community 5`, `Community 11`, `Community 19`, `Community 28`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 11` to `Community 4`, `Community 6`, `Community 137`, `Community 10`, `Community 140`, `Community 13`, `Community 14`, `Community 15`, `Community 141`, `Community 19`, `Community 150`, `Community 151`, `Community 28`, `Community 33`, `Community 34`, `Community 43`, `Community 175`, `Community 176`, `Community 50`, `Community 53`, `Community 55`, `Community 60`, `Community 194`, `Community 68`, `Community 69`, `Community 324`, `Community 84`, `Community 98`, `Community 231`, `Community 109`?**
