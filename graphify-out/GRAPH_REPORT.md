...
## Corpus Check
- 489 files · ~716,677 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5992 nodes · 7767 edges · 476 communities (428 shown, 48 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6971b9fe`
...
## Communities (476 total, 48 thin omitted)
...
Cohesion: 0.05
Nodes (39): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, AuthUser, passwordChangedAt (+31 more)
...
Cohesion: 0.05
Nodes (50): useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo (+42 more)
...
Cohesion: 0.08
Nodes (37): useMenuContext(), AuditIssue, MenuCheckWidget(), getGoogleReviewUrl(), submitFeedback(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps (+29 more)
...
Cohesion: 0.09
Nodes (20): RedisIoAdapter, AssistanceModule, DashboardModule, EventsModule, FeedbackModule, HealthController, HealthModule, LoyaltyModule (+12 more)
...
Cohesion: 0.05
Nodes (37): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, RestaurantProvider(), SocketContext, SocketContextData, SocketProvider() (+29 more)
...
Cohesion: 0.07
Nodes (13): VerifyDeviceEnrollmentDto, PaymentModule, IPaymentProvider, devProvider, p, payload, result, savedEnv (+5 more)
...
Cohesion: 0.09
Nodes (27): MenuContext, MenuContextType, MenuProvider(), DashboardSummary, useMenu(), createCategory(), createItem(), deleteCategory() (+19 more)
...
Cohesion: 0.07
Nodes (14): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+6 more)
...
Cohesion: 0.08
Nodes (24): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, FontPicker(), FontPickerProps, createAssistanceRequest() (+16 more)
...
Cohesion: 0.08
Nodes (17): BillingPeriod, CheckoutTier, CreateCheckoutDto, getTierFromPrice(), IMMEDIATE_DOWNGRADE_STATUSES, PriceMap, configMock, eventEpoch (+9 more)
...
Cohesion: 0.13
Nodes (12): getTrendingItems(), getImageUrl(), getTranslatedArray(), getTranslatedField(), Translatable, ImageLightbox(), ImageLightboxProps, ItemWithOptions() (+4 more)
...
Cohesion: 0.13
Nodes (6): AuthModule, GoogleStrategy, JwtStrategy, LocalStrategy, OptionalJwtStrategy, UsersModule
...
Cohesion: 0.19
Nodes (10): ResetOwnerPasswordDto, SuperAdminConfirmationDto, TIERS, UpdatePaymentsEnabledDto, UpdateTenantStatusDto, UpdateTenantTierDto, expectSuperAdminGuards(), guardNames() (+2 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTableModal.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTopBar.tsx), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)

### Community 159 - "Community 159"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:tsx (import { BrowserRouter as Router, Routes, Route, Outlet } fr), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), code:bash (git add apps/frontend/src/App.tsx), code:typescript (// Add these imports at top of menu-crud.service.ts (alongsi), code:bash (git add apps/backend/src/menu/menu-crud.service.ts), File Structure (+3 more)
...
Cohesion: 0.2
Nodes (9): code:typescript (import { IsIn, IsOptional, IsBoolean } from 'class-validator), code:bash (git add apps/backend/src/super-admin/dto/update-tenant.dto.t), code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/SuperAdminRoute.tsx), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 10: SuperAdminRoute — frontend guard, Task 18: Build verification (+1 more)
...
## Knowledge Gaps
- **3475 isolated node(s):** `fs`, `tsxContent`, `keysInTsx`, `locales`, `jsonContent` (+3470 more)
...
- **Why does `FeatureService` connect `Community 3` to `Community 32`, `Community 8`, `Community 44`, `Community 12`, `Community 14`, `Community 20`, `Community 119`, `Community 123`, `Community 60`, `Community 30`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 41` to `Community 3`, `Community 27`, `Community 19`, `Community 13`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 19` to `Community 4`, `Community 6`, `Community 40`, `Community 41`, `Community 9`, `Community 11`, `Community 10`, `Community 13`, `Community 16`, `Community 52`, `Community 55`, `Community 124`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **What connects `fs`, `tsxContent`, `keysInTsx` to the rest of the system?**
