...
## Corpus Check
- 589 files · ~887,564 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7896 nodes · 10450 edges · 598 communities (534 shown, 64 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3675b71a`
...
## Communities (598 total, 64 thin omitted)
...
Cohesion: 0.02
Nodes (95): CreateRestaurantForm(), NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance() (+87 more)
...
Cohesion: 0.03
Nodes (78): filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage() (+70 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (75): StaffRoute(), useRestaurantContext(), AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState() (+67 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (60): draft, PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names (+52 more)
...
Cohesion: 0.05
Nodes (28): AuthUser, OptionalJwtStrategy, passwordChangedAt, prisma, DateRangeQueryDto, PaymentHistoryQueryDto, dto, RefundPaymentDto (+20 more)
...
Cohesion: 0.05
Nodes (51): CustomTooltip(), KpiCard(), KpiCardProps, AnalyticsData, abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCheckout() (+43 more)
...
Cohesion: 0.08
Nodes (40): useMenuContext(), getGoogleReviewUrl(), submitFeedback(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps, DAYS, CreateCategoryForm() (+32 more)
...
Cohesion: 0.06
Nodes (39): CartIcon(), CartContext, CartContextType, CartItem, CartProvider(), SelectedOption, useCart(), createAssistanceRequest() (+31 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (37): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, SuperAdminRoute(), AuthContext, AuthContextType (+29 more)
...
Cohesion: 0.06
Nodes (36): SettingsTab, ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo, SubscriptionTier, TIER_FEATURES (+28 more)
...
Cohesion: 0.07
Nodes (14): DashboardService, AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result (+6 more)
...
Cohesion: 0.08
Nodes (26): CartIconProps, MenuContext, MenuContextType, MenuProvider(), DashboardSummary, useMenu(), createCategory(), createItem() (+18 more)
...
Cohesion: 0.08
Nodes (19): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, BillingPeriod, CheckoutTier, CreateCheckoutDto, FeatureService (+11 more)
...
Cohesion: 0.09
Nodes (15): JwtAuthGuard, UpdatePlatformSettingsDto, ResetOwnerPasswordDto, SuperAdminConfirmationDto, TIERS, UpdatePaymentsEnabledDto, UpdateTenantStatusDto, UpdateTenantTierDto (+7 more)
...
Cohesion: 0.08
Nodes (23): RestaurantList(), RestaurantContext, RestaurantContextType, AuditIssue, MenuCheckWidget(), bondSection, { container }, disabledCreateButton (+15 more)
...
Cohesion: 0.12
Nodes (14): 10. Negative Tipping & Price Underflows, 11. Role-Based Access Control (RBAC) Bypasses, A. Feature summary, A. Feature summary, A. Feature summary, A. Feature summary, B. Files involved, B. Files involved (+6 more)
...
Cohesion: 0.18
Nodes (10): 1. rbac-guard (Role-Based Access Control), 21-Agent Codebase Audit — Complete Findings (107 total), CRITICAL, HIGH, Legend, LOW, Master Scorecard, MEDIUM (+2 more)
...
Cohesion: 0.2
Nodes (9): code:typescript (import {), code:bash (git add apps/backend/src/super-admin/super-admin.controller.), code:json ("superAdmin": {), code:bash (git add apps/frontend/src/locales/en/translation.json), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 16: i18n — add EN translation keys, Task 18: Build verification (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosItemCard.tsx), code:bash (cd apps/backend && npx tsc --noEmit && npm test -- --passWit), code:bash (cd apps/frontend && npx tsc --noEmit && npm run build), code:bash (git add -A), File Structure, Task 18: Final verification — full build + POS smoke test (+1 more)
...
## Knowledge Gaps
- **4533 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4528 more)
...
- **Why does `FeatureService` connect `Community 35` to `Community 96`, `Community 121`, `Community 71`, `Community 8`, `Community 10`, `Community 43`, `Community 11`, `Community 13`, `Community 15`, `Community 16`, `Community 86`, `Community 153`, `Community 58`, `Community 59`, `Community 95`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 17` to `Community 33`, `Community 18`, `Community 35`, `Community 6`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `t` connect `Community 6` to `Community 3`, `Community 5`, `Community 134`, `Community 7`, `Community 12`, `Community 142`, `Community 14`, `Community 17`, `Community 145`, `Community 18`, `Community 146`, `Community 21`, `Community 33`, `Community 39`, `Community 40`, `Community 180`, `Community 181`, `Community 54`, `Community 60`, `Community 61`, `Community 65`, `Community 67`, `Community 197`, `Community 73`, `Community 346`, `Community 347`, `Community 348`, `Community 97`, `Community 236`, `Community 115`, `Community 123`?**
...
- **What connects `Kt`, `ya`, `p` to the rest of the system?**
  _4533 weakly-connected nodes found - possible documentation gaps or missing edges._
