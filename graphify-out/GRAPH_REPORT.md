...
## Corpus Check
- 949 files · ~2,392,913 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17028 nodes · 21631 edges · 1530 communities (1443 shown, 87 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5449b8ba`
...
- `ReservationsView()` --calls--> `useRestaurantContext()`  [EXTRACTED]
  apps/frontend/src/pages/Dashboard/ReservationsView.tsx → apps/frontend/src/context/RestaurantContext.tsx

## Communities (1530 total, 87 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (110): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, EpayCheckoutForm, EpayCheckoutParams, EpayMode, EpayNotification (+102 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (76): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, ViewDef, mockSocket, MenuTranslationService, categories (+68 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (120): BannerSettings, TYPE_STYLES, filterConfig, FilterMode, LiveTablesView(), SITE_COOKIES, abandonCheckout(), api (+112 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (104): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), normalizeTag(), useMenu() (+96 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (79): AuthUser, JwtAuthGuard, WrapperType, DeepPartial, payment, tx, DASHBOARD_LANGUAGES, BillingPeriod (+71 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (108): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), Order, OrderContext, OrderContextType, OrderItemSelectedOption (+100 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (67): AvailabilityQueryDto, CreateReservationDto, ModifyReservationDto, BlackoutDto, CoverCountDto, ListReservationsQueryDto, ManualReservationDto, RESERVATION_ACTIONS (+59 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (93): orderStatusKeyMap, KpiCardProps, AnalyticsData, useDailyTarget(), clearHostedCheckoutMarker(), hasHostedCheckoutMarker(), PaymentBanner, UsePaymentReturnArgs (+85 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (97): RenovaBrand(), RenovaBrandProps, RenovaBrandSize, RenovaMark(), RenovaMarkProps, sizeStyles, DASHBOARD_LANGUAGES, Header() (+89 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (86): CustomerLoginModal(), CartDrawer(), cartMocks, CartIcon(), CartIconProps, CartContext, CartContextType, CartItem (+78 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (54): BulkItemUpdateDto, BulkUpdateItemsDto, AvailabilityType, CreateCategoryDto, pipe, result, CreateItemDto, Currency (+46 more)
...
Cohesion: 0.05
Nodes (35): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, UpdatePlatformSettingsDto, EventsModule, HealthController (+27 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (61): BASE_RESTAURANT, created, first, mockEvents, mockMenuTranslation, mockMenuTranslationRead, mockPrisma, mockStorage (+53 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (49): BoricaCallbackResult, BoricaCardholderInfo, BoricaCertificateStatus, BoricaCertificateValidity, BoricaCheckoutForm, BoricaCheckoutParams, BoricaMode, BoricaProvider (+41 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (44): locks, a, b, firstStarted, order, second, withKeyLock(), ImportCategoryDto (+36 more)
...
Cohesion: 0.05
Nodes (46): LoyaltyHistoryQueryDto, isLoyaltyAvailable(), addDays(), addEarnedPointBatch(), ensureLoyaltyAccount(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress() (+38 more)
...
Cohesion: 0.04
Nodes (24): buildRestaurantDateRange(), buildRestaurantPresetDateRange(), RestaurantDateRange, BASIC_KEYS, FULL_PAYLOAD, mockDashboard, mockPrisma, OWNER (+16 more)
...
Cohesion: 0.04
Nodes (19): EventsGateway, parseCookie(), client, debugSpy, emit, error, fetchSockets, first (+11 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (41): spy, storageMock, store, ThemeConsumer(), Theme, ThemeContext, ThemeContextValue, ThemeProvider() (+33 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (46): Channel, COUNTRIES, CustomerLoginModalProps, Step, BulkEditView(), csvToPayload(), ExportTab(), IMPORT_ERROR_DEFAULTS (+38 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (36): AssistanceContextValue, AssistanceRequest, getElapsedLabel(), getElapsedMinutes(), getUrgencyStyle(), RequestFilter, DashboardOrder, DashboardOrderItem (+28 more)
...
Cohesion: 0.06
Nodes (35): getMethodLabel(), PaymentDrawer(), TimelineItem(), PaymentReconciliationQueue(), PaymentReconciliationQueueProps, ReconciliationDecision, api, issue (+27 more)
...
Cohesion: 0.07
Nodes (34): RestaurantContext, RestaurantProvider(), daffi, mocks, { result, rerender }, clearOfflineShift(), ExpiringSnapshot, loadOfflineRestaurant() (+26 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (15): { AppModule }, { NestFactory }, prisma, { PrismaClient }, { RestaurantsService }, RestaurantsService, brandingDto, capturedPayload (+7 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (37): DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, roleLabel(), changePassword(), getGoogleReviewUrl(), submitFeedback(), updateProfile() (+29 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (34): FeatureFlag, SubscriptionTier, createCheckoutSession(), createPortalSession(), listStaff(), Billing, FAQ_KEYS, FEATURE_ROWS (+26 more)
...
Cohesion: 0.06
Nodes (22): OrdersService, burger, canceled, existingAcc, input, insert, LockedSessionSeed, makeMenuItem() (+14 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (27): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, PosSessionInput, first, names (+19 more)
...
Cohesion: 0.06
Nodes (35): Atomic Refund — Race Condition Fix (May 23, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Files Changed (+27 more)
...
Cohesion: 0.06
Nodes (35): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), CI Gate Added (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Files Changed (+27 more)

### Community 63 - "Community 63"
Cohesion: 0.06
Nodes (35): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), CI Gate Added (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Date Range Validation — Analytics (May 23, 2026), Files Changed (+27 more)
...
Cohesion: 0.07
Nodes (26): MenuProfitabilityPanel(), MenuProfitabilityPanelProps, CancelAnalyticsData, CancelHourRow, CancelItemRow, CategoryBreakdown, CloseoutReport, CustomerMetric (+18 more)
...
Cohesion: 0.06
Nodes (31): Auth Log Scrubbing (May 18, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), CI Gate Added (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+23 more)
...
Cohesion: 0.11
Nodes (23): syncEngine, createOrder(), asRecord(), classifySyncError(), createPosSyncEngine(), discardPosOrder(), dispatchSyncEvent(), indexedDbPosOutbox (+15 more)

### Community 101 - "Community 101"
Cohesion: 0.09
Nodes (17): createReservation(), BookingPage(), COUNTRIES, localDateISO(), parseDateString(), PREF_ICON, ACCESSIBILITY_PREFERENCES, AvailabilitySlot (+9 more)
...
Cohesion: 0.1
Nodes (6): AuthController, clearAuthTokenCookie(), setAuthTokenCookie(), TOKEN_COOKIE_CLEAR_OPTIONS, TOKEN_COOKIE_OPTIONS, UsersDataController
...
Cohesion: 0.12
Nodes (17): AssistanceProvider(), PosTheme, PosThemeContext, PosThemeContextValue, PosThemeProvider(), usePosTheme(), QueuedPosOrder, PosThemeShell() (+9 more)
...
Cohesion: 0.08
Nodes (25): Addendum — Cross-report comparison (`17.07.REPORT.md` vs `17.07.FULLREPORT.md`), code:ts (// before), code:bash (cd apps/backend), code:ts (// before), code:ts (// before), code:ts (const accounts = await this.prisma.loyaltyAccount.findMany({), code:ts (let cursor: string | undefined;), code:ts (// new helper, modeled on getRefundTotals but grouped by pro) (+17 more)
...
Cohesion: 0.09
Nodes (18): confirmCheckoutSession(), getStripeStatus(), updateOnboardingStep(), Billing, getVisibleSteps(), OnboardingPage(), PAID_TIERS, PAYMENT_TIERS (+10 more)
...
Cohesion: 0.23
Nodes (14): OrderItemDto, OrderItemOptionDto, PosSubmissionDto, CreateTableDto, UpdateTableDto, assertRestaurantActive(), DEFAULT_FULFILLMENT_MODES, DEFAULT_PAYMENT_METHODS (+6 more)
...
Cohesion: 0.15
Nodes (15): ReservationUpdatedPayload, useReservationRealtime(), cancelManageReservation(), getManageReservation(), getReservationAvailability(), getReservationConfig(), getReservationStatus(), modifyManageReservation() (+7 more)
...
Cohesion: 0.13
Nodes (13): DEFAULT_HAPPY_HOUR_DAYS, getZonedClockParts(), HappyHourConfig, isHappyHourActive(), ISO_WEEKDAY_BY_SHORT_NAME, parseTimeToMinutes(), Props, mockT (+5 more)
...
Cohesion: 0.11
Nodes (17): code:bash (git add apps/backend/package.json apps/backend/package-lock.), code:bash (git add CODING_ROADMAP.md CLAUDE.md), code:typescript (import { NestFactory } from "@nestjs/core";), code:bash (cd apps/backend && npm run build), code:bash (git add apps/backend/src/main.ts), code:typescript (// Payment / TableSession), code:bash (git add apps/frontend/src/lib/api.ts), code:bash (cd apps/backend && npm install stripe) (+9 more)
...
Cohesion: 0.19
Nodes (6): LoggingInterceptor, redactSensitivePath(), result, getRequestPath(), shouldSkipRequestLog(), stripQueryString()
...
Cohesion: 0.18
Nodes (6): PushService, cleanupError, logger, loggerError, prisma, service
...
Cohesion: 0.15
Nodes (13): API Contract, Call-Waiter, H-28: 3 reservation routes missing `@RequireFeature(RESERVATIONS)`, H-29: FREE-to-Starter no-payment upgrade path missing, H-30: `updateDataRequest` has no audit log entry, H-31: `MenuItem.weight` missing from CRUD DTOs, H-38: setTimeout in startCooldown() not cleaned up on unmount, H-39: 409/429 error acknowledged as success in UI (+5 more)
...
Cohesion: 0.17
Nodes (11): code:tsx (<p className="font-serif font-black text-foreground uppercas), code:tsx (<p className="font-serif font-black text-foreground uppercas), code:tsx (<span className="text-[11px] text-muted-foreground font-bold), code:tsx (<span className="text-[11px] text-muted-foreground font-bold), code:bash (git add apps/frontend/src/pages/Dashboard/AssistanceView.tsx), File Map, Final verification, Phase 2 — Dashboard owner UI (+3 more)
...
Cohesion: 0.14
Nodes (12): Analytics Deep-Dive Full i18n (May 24, 2026), Files Changed, Files Changed, Files Changed, Fix, Key Changes, Key Changes, Problem (+4 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosItemCard.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), File Structure (+3 more)
...
Cohesion: 0.27
Nodes (7): AllExceptionsFilter, getExceptionResponse(), getMessage(), host, json, mockedWriteAppLog, status
...
Cohesion: 0.2
Nodes (9): code:typescript (import { IsIn, IsOptional, IsBoolean } from "class-validator), code:bash (git add apps/backend/src/super-admin/dto/update-tenant.dto.t), code:tsx (import { useQuery } from "@tanstack/react-query";), code:bash (git add apps/frontend/src/pages/super-admin/OverviewPage.tsx), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 13: OverviewPage — platform stats, Task 18: Build verification (+1 more)
...
Cohesion: 0.28
Nodes (4): PushController, PushModule, ALLOWED_PUSH_HOST_SUFFIXES, ALLOWED_PUSH_HOSTS
...
## Knowledge Gaps
- **10591 isolated node(s):** `fs`, `content`, `m`, `fs`, `path` (+10586 more)
...
- **Why does `FeatureService` connect `Community 4` to `Community 0`, `Community 1`, `Community 69`, `Community 6`, `Community 10`, `Community 43`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 184`, `Community 281`, `Community 90`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `PublicMenuContent()` connect `Community 9` to `Community 8`, `Community 25`, `Community 4`, `Community 5`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 8` to `Community 2`, `Community 3`, `Community 36`, `Community 5`, `Community 38`, `Community 7`, `Community 40`, `Community 9`, `Community 163`, `Community 327`, `Community 23`, `Community 24`, `Community 126`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **What connects `fs`, `content`, `m` to the rest of the system?**
  _10591 weakly-connected nodes found - possible documentation gaps or missing edges._
