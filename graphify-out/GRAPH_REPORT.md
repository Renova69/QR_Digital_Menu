# Graph Report - QR_Digital_Menu-main  (2026-06-30)

## Corpus Check
- 629 files · ~923,977 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8185 nodes · 11337 edges · 626 communities (556 shown, 70 thin omitted)
...
## Communities (626 total, 70 thin omitted)
...
Cohesion: 0.03
Nodes (90): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), NotificationContext (+82 more)
...
Cohesion: 0.03
Nodes (78): BannerSettings, TYPE_STYLES, filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES (+70 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (48): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, OptionalJwtStrategy, passwordChangedAt, prisma, BASIC_KEYS (+40 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (63): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider() (+55 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (60): CreateRestaurantForm(), RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, RestaurantContextType (+52 more)
...
Cohesion: 0.04
Nodes (24): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, CreateStaffDto, UpdateCategoryDto (+16 more)
...
Cohesion: 0.06
Nodes (46): MenuProfitabilityPanel(), MenuProfitabilityPanelProps, CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem (+38 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (51): CancelAnalysisPanel(), CustomerKitchenPanels(), StaffPerformancePanel(), TableTurnoverPanel(), computeInsights(), Panel(), CategoryMix(), GuestSatisfaction() (+43 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (46): FeatureFlag, abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCashPaymentRequest(), createCheckout(), getSessionBill(), PendingBillPayment (+38 more)
...
Cohesion: 0.06
Nodes (46): BrandingPreview(), BrandingPreviewProps, Device, Scene, SCENE_KEYS, ColorSchemeEditor(), ColorSchemeEditorProps, ColorSwatch() (+38 more)
...
Cohesion: 0.05
Nodes (17): MenuImportService, clampLimit(), clampPage(), emptyTierCounts(), parseOptionalDate(), after, before, expiresAt (+9 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (34): billOrders, boricaCardholder, boricaPayment, boricaRestaurant, [capturedPayload], created, epayPayment, epayRestaurant (+26 more)
...
Cohesion: 0.05
Nodes (23): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, ApiKeyGuard, mockPrisma, MenuImportController (+15 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (42): ALL_FEATURE_FLAGS, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo, SubscriptionTier, TIER_FEATURES, useTier(), createCheckoutSession() (+34 more)
...
Cohesion: 0.06
Nodes (34): DashboardSummary, superAdminGetDataRequests(), superAdminGetMrr(), superAdminUpdateDataRequest(), createCategory(), createItem(), deleteCategory(), deleteItem() (+26 more)
...
Cohesion: 0.07
Nodes (17): CreateDeviceEnrollmentDto, CreateRestaurantDto, errors, keysFor(), validate(), UpdateRestaurantDto, VerifyDeviceEnrollmentDto, BRANDING_FIELD_SET (+9 more)
...
Cohesion: 0.07
Nodes (16): AuthUser, OptionalJwtAuthGuard, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto, DateRangeQueryDto, OrderQueryDto, PaymentHistoryQueryDto (+8 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (37): KpiCard(), KpiCardProps, AnalyticsData, CancelAnalyticsData, CancelHourRow, CancelItemRow, CategoryBreakdown, CloseoutReport (+29 more)
...
Cohesion: 0.08
Nodes (27): AnalyticsView(), formatDate(), SummaryView(), UpgradeBanner(), useAnalytics(), usePaymentSummary(), useScanStats(), DateRangePreset (+19 more)
...
Cohesion: 0.16
Nodes (14): UpdateOrderDto, addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), redeemAccountPoints(), batches, date (+6 more)
...
Cohesion: 0.18
Nodes (13): getFirstRewardProgress(), markRemindersSent(), LOYALTY_CONFIG_FIELDS, LOYALTY_TIER_FIELDS, TIER_FIELDS, getTierInfo(), config, defaultConfig (+5 more)
...
Cohesion: 0.22
Nodes (3): isLoyaltyAvailable(), getRewardValue(), LoyaltyService
...
Cohesion: 0.26
Nodes (7): CreateTableDto, UpdateTableDto, mockOrders, mockOwner, mockRestaurant, mockTable, session
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTopBar.tsx), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosItemGrid.tsx), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)

### Community 207 - "Community 207"
Cohesion: 0.18
Nodes (10): code:block1 (Phase 2 (Frontend):), code:tsx (import { BrowserRouter as Router, Routes, Route, Outlet } fr), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), code:bash (git add apps/frontend/src/App.tsx), File Structure, RBAC Sprint Implementation Plan, Self-Review (+2 more)
...
Cohesion: 0.47
Nodes (4): CreateZoneDto, ReorderZonesDto, ZoneOrderItem, UpdateZoneDto
...
Cohesion: 0.22
Nodes (5): getAdminLegalSettings(), updateAdminLegalSettings(), LegalSettingsPage(), LocaleKey, LOCALES
...
Cohesion: 0.25
Nodes (6): client, fetchSockets, inRoom, otherSocket, revokedSocket, token
...
## Knowledge Gaps
- **4457 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4452 more)
...
- **Why does `PublicMenuPage()` connect `Community 16` to `Community 3`, `Community 7`, `Community 14`, `Community 15`, `Community 18`, `Community 52`, `Community 23`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `FeatureService` connect `Community 7` to `Community 34`, `Community 98`, `Community 4`, `Community 12`, `Community 110`, `Community 17`, `Community 19`, `Community 117`, `Community 22`, `Community 151`, `Community 24`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `t` connect `Community 15` to `Community 1`, `Community 3`, `Community 131`, `Community 6`, `Community 8`, `Community 10`, `Community 139`, `Community 11`, `Community 395`, `Community 14`, `Community 143`, `Community 16`, `Community 144`, `Community 18`, `Community 23`, `Community 25`, `Community 32`, `Community 295`, `Community 170`, `Community 43`, `Community 172`, `Community 46`, `Community 48`, `Community 49`, `Community 189`, `Community 64`, `Community 67`, `Community 71`, `Community 83`, `Community 216`, `Community 93`, `Community 358`, `Community 235`, `Community 119`, `Community 120`?**
