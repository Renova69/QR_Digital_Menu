...
## Corpus Check
- 589 files · ~887,482 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7819 nodes · 10373 edges · 599 communities (529 shown, 70 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2458734f`
...
## Communities (599 total, 70 thin omitted)
...
Cohesion: 0.03
Nodes (86): CreateRestaurantForm(), NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance() (+78 more)
...
Cohesion: 0.04
Nodes (58): draft, PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names (+50 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (60): RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, RestaurantContextType, useRestaurantContext() (+52 more)
...
Cohesion: 0.04
Nodes (54): CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage(), api, BoricaCheckoutResponse, CheckoutResponse (+46 more)
...
Cohesion: 0.06
Nodes (32): AuthUser, JwtAuthGuard, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem (+24 more)
...
Cohesion: 0.05
Nodes (22): WrapperType, CreatePrintStationDto, CreateTableDto, UpdatePrintStationDto, UpdateTableDto, EventsGateway, parseCookie(), client (+14 more)
...
Cohesion: 0.06
Nodes (14): AssistanceController, AssistanceService, CreateAssistanceDto, CreateFeedbackDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto (+6 more)
...
Cohesion: 0.04
Nodes (19): MenuAuditController, ItemController, ItemDetailController, MenuAuditService, cat1, cat2, category, errorIssues (+11 more)
...
Cohesion: 0.08
Nodes (19): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto, UpdateMenuOptionDto (+11 more)
...
Cohesion: 0.08
Nodes (29): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+21 more)
...
Cohesion: 0.07
Nodes (30): AssistanceContextValue, AssistanceRequest, getElapsedLabel(), getElapsedMinutes(), getUrgencyStyle(), RequestFilter, filterConfig, FilterMode (+22 more)
...
Cohesion: 0.1
Nodes (29): getMethodLabel(), PaymentDrawer(), TimelineItem(), translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles (+21 more)
...
Cohesion: 0.07
Nodes (19): getDisplayUrl(), Footer(), FooterProps, linkifyPhones(), SocialBar(), SocialBarProps, advantageItems, comparisonRows (+11 more)
...
Cohesion: 0.11
Nodes (25): bgn(), Cell, dayParts, downloadAnalyticsExport(), empty(), eur(), ExportMeta, FeedbackExportData (+17 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect } from "react";), code:bash (git add apps/frontend/src/components/pos/PosOptionsDrawer.ts), code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/StaffRoute.tsx), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)

### Community 213 - "Community 213"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:tsx (import { BrowserRouter as Router, Routes, Route, Outlet } fr), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), code:bash (git add apps/frontend/src/App.tsx), File Structure (+3 more)
...
Cohesion: 0.33
Nodes (5): 21-Agent Codebase Audit — Complete Findings (107 total), Legend, Master Scorecard, Pending TODO (10 items), Wont Fix highlights (33 items)
...
- **Why does `FeatureService` connect `Community 13` to `Community 98`, `Community 40`, `Community 9`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 22`, `Community 87`, `Community 62`, `Community 153`, `Community 124`, `Community 126`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 33` to `Community 38`, `Community 8`, `Community 13`, `Community 20`, `Community 28`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `t` connect `Community 8` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `Community 142`, `Community 145`, `Community 146`, `Community 20`, `Community 27`, `Community 28`, `Community 33`, `Community 35`, `Community 38`, `Community 41`, `Community 44`, `Community 177`, `Community 50`, `Community 57`, `Community 58`, `Community 64`, `Community 194`, `Community 68`, `Community 328`, `Community 74`, `Community 219`, `Community 220`, `Community 99`, `Community 235`, `Community 236`, `Community 113`, `Community 118`, `Community 127`?**
