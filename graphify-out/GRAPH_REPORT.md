...
## Corpus Check
- 485 files · ~711,863 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5993 nodes · 7770 edges · 485 communities (436 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `803862c8`
...
## Communities (485 total, 49 thin omitted)
...
Cohesion: 0.04
Nodes (42): SITE_COOKIES, api, closeSession(), closeSessionWithCard(), closeSessionWithCash(), createDeviceEnrollment(), createOrder(), createStaff() (+34 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (32): AuthUser, CreateDeviceEnrollmentDto, CreateRestaurantDto, DateRangeQueryDto, RefundPaymentDto, errors, keysFor(), validate() (+24 more)
...
Cohesion: 0.07
Nodes (23): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, OptionalJwtStrategy, DashboardModule, EventsModule, HealthController (+15 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (36): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, names, { result }, summary (+28 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (35): useMenuContext(), AuditIssue, MenuCheckWidget(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps, DAYS, CreateCategoryForm() (+27 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (16): JwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, UpdatePlatformSettingsDto, MenuViewController, RecordViewDto, PlatformSettingsController (+8 more)
...
Cohesion: 0.07
Nodes (12): AssistanceController, AssistanceService, CreateAssistanceDto, CreateFeedbackDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto (+4 more)
...
Cohesion: 0.07
Nodes (26): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, dto, dtoWithRedirect (+18 more)
...
Cohesion: 0.08
Nodes (28): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), ALLOWED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), SuperAdminRoute(), AuthContext, AuthContextType (+20 more)
...
Cohesion: 0.09
Nodes (26): useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo, TIER_FEATURES (+18 more)
...
Cohesion: 0.09
Nodes (26): createAssistanceRequest(), getCategoryItems(), getMenuMeta(), getTrendingItems(), recordMenuView(), getImageUrl(), getTranslatedArray(), getTranslatedField() (+18 more)
...
Cohesion: 0.07
Nodes (22): RestaurantContextType, SummaryView(), usePaymentSummary(), useScanStats(), DateRangePreset, formatDate(), SummaryDateRange, useSummaryDateRange() (+14 more)
...
Cohesion: 0.07
Nodes (22): Channel, COUNTRIES, CustomerLoginModalProps, Step, DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, changePassword() (+14 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (25): FeatureFlag, SubscriptionTier, createCheckoutSession(), createPortalSession(), listStaff(), Billing, FeatureRowData, PricingPage() (+17 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (31): Analytics Deep-Dive Full i18n (May 24, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), CartContext `updateItem` Type Fix (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+23 more)
...
Cohesion: 0.08
Nodes (17): Footer(), FooterProps, linkifyPhones(), LANG_CODES, TopBar(), TopBarProps, advantageItems, comparisonRows (+9 more)
...
Cohesion: 0.1
Nodes (20): AssistanceProvider(), Order, OrderContext, OrderContextType, OrderProvider(), OrderStatus, RestaurantProvider(), SocketContext (+12 more)
...
Cohesion: 0.1
Nodes (13): AnalyticsView(), CHART_COLORS, CustomTooltip(), dayPartKeyMap, dayParts, formatDate(), formatPercent(), getChangeCopy() (+5 more)
...
Cohesion: 0.09
Nodes (17): confirmCheckoutSession(), updateOnboardingStep(), Billing, getVisibleSteps(), OnboardingPage(), PAID_TIERS, PAYMENT_TIERS, Step (+9 more)
...
Cohesion: 0.11
Nodes (19): AssistanceContext, AssistanceContextType, AssistanceRequest, useAssistance(), AssistanceContextValue, AssistanceRequest, AssistanceView(), getElapsedLabel() (+11 more)
...
Cohesion: 0.11
Nodes (15): KpiCardProps, AnalyticsData, CategoryBreakdown, OrderStatusBreakdown, PeakHour, RevenueTrendPoint, TableMetric, TopItem (+7 more)
...
Cohesion: 0.13
Nodes (14): NotificationBell(), PaymentToast(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications(), AppLayout() (+6 more)

### Community 81 - "Community 81"
Cohesion: 0.13
Nodes (12): RestaurantContext, bondSection, { container }, mockRestaurant, mockT, store, createRestaurant(), getRestaurantById() (+4 more)
...
Cohesion: 0.13
Nodes (11): DASHBOARD_LANGUAGES, Header(), BOTTOM_NAV_TABS, DASHBOARD_LANGUAGES, MOBILE_MORE_IDS, MOBILE_MORE_TABS, MOBILE_PRIMARY_TABS, TabId (+3 more)

### Community 92 - "Community 92"
Cohesion: 0.12
Nodes (13): filterConfig, FilterMode, LiveTablesView(), forceOpenSession(), getOrCreateSession(), getSessionBill(), getTableOrders(), getTableStatuses() (+5 more)
...
Cohesion: 0.13
Nodes (8): useOrders(), DashboardOrder, DashboardOrderItem, ORDER_STATUSES, OrdersContextValue, OrdersView(), statusAccent, OrderConsumer()
...
Cohesion: 0.22
Nodes (8): ResetOwnerPasswordDto, SuperAdminConfirmationDto, TIERS, UpdatePaymentsEnabledDto, UpdateTenantStatusDto, UpdateTenantTierDto, ctx, SuperAdminGuard

### Community 116 - "Community 116"
Cohesion: 0.16
Nodes (9): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+1 more)
...
Cohesion: 0.24
Nodes (3): MenuImportService, mockPrisma, tx
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCategoryFilter.t), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosSeatSelector.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), File Structure (+3 more)

### Community 165 - "Community 165"
Cohesion: 0.18
Nodes (10): code:block1 (Phase 2 (Frontend):), code:typescript (// Add to UsersService class in apps/backend/src/users/users), code:bash (git add apps/backend/src/users/users.service.ts), code:typescript (// Add to AuthController in apps/backend/src/auth/auth.contr), code:bash (git add apps/backend/src/auth/auth.controller.ts), File Structure, RBAC Sprint Implementation Plan, Self-Review (+2 more)
...
Cohesion: 0.22
Nodes (8): after, before, FREE_RESTAURANT, mockMenuImport, mockPrisma, PROFESSIONAL_RESTAURANT, result, updated
...
Cohesion: 0.22
Nodes (4): getAdminLegalSettings(), updateAdminLegalSettings(), LocaleKey, LOCALES
...
Cohesion: 0.33
Nodes (3): JwtStrategy, passwordChangedAt, prisma
...
## Knowledge Gaps
- **3475 isolated node(s):** `prisma`, `prisma`, `{ PrismaClient }`, `prisma`, `{ PrismaClient }` (+3470 more)
...
- **Why does `FeatureService` connect `Community 5` to `Community 132`, `Community 6`, `Community 7`, `Community 232`, `Community 8`, `Community 11`, `Community 14`, `Community 47`, `Community 16`, `Community 26`, `Community 29`, `Community 126`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 30` to `Community 5`, `Community 12`, `Community 21`, `Community 23`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 21` to `Community 68`, `Community 69`, `Community 70`, `Community 39`, `Community 40`, `Community 9`, `Community 10`, `Community 12`, `Community 80`, `Community 81`, `Community 183`, `Community 58`, `Community 91`, `Community 28`, `Community 30`?**
