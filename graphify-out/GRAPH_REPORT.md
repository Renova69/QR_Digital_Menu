# Graph Report - QR_Digital_Menu-main  (2026-06-19)

## Corpus Check
- 577 files · ~863,160 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7619 nodes · 10076 edges · 584 communities (516 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4803d346`
...
## Communities (584 total, 68 thin omitted)
...
Cohesion: 0.04
Nodes (67): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+59 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (58): filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage() (+50 more)
...
Cohesion: 0.06
Nodes (33): AuthUser, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto (+25 more)
...
Cohesion: 0.05
Nodes (25): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto (+17 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (47): MenuContext, MenuContextType, useMenuContext(), DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, changePassword(), getGoogleReviewUrl() (+39 more)
...
Cohesion: 0.07
Nodes (27): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, EventsModule, HealthController, HealthModule (+19 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (34): OptionalJwtStrategy, passwordChangedAt, prisma, AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews (+26 more)
...
Cohesion: 0.1
Nodes (27): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider(), mockUser, TestConsumer() (+19 more)
...
Cohesion: 0.11
Nodes (26): CustomTooltip(), getTrendingItems(), formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual(), getImageUrl(), getTranslatedArray() (+18 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (30): analyticsData, paymentRecord, sheets, xlsxMocks, bgn(), Cell, downloadMenuExport(), eur() (+22 more)
...
Cohesion: 0.07
Nodes (24): useAssistance(), useOrders(), AssistanceView(), OperationsView(), OperationsViewProps, SUB_TABS, SubTabId, DashboardOrder (+16 more)
...
Cohesion: 0.08
Nodes (21): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+13 more)
...
Cohesion: 0.11
Nodes (26): downloadMenuXLSX(), bgn(), Cell, dayParts, downloadAnalyticsExport(), empty(), eur(), ExportMeta (+18 more)
...
Cohesion: 0.09
Nodes (23): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, Order, OrderContext, OrderContextType, OrderProvider() (+15 more)
...
Cohesion: 0.07
Nodes (22): CheckoutPage, CookiePolicyPage, CustomerProfilePage, DashboardPage, DeviceEnrollPage, DeviceLoginPage, FeedbackPage, HelpCenterPage (+14 more)
...
Cohesion: 0.08
Nodes (21): abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCheckout(), createPaymentIntent(), BillData, BillItem, BillOrder (+13 more)
...
Cohesion: 0.11
Nodes (18): KpiCard(), KpiCardProps, AnalyticsData, CategoryBreakdown, OrderStatusBreakdown, PeakHour, RevenueTrendPoint, TableMetric (+10 more)
...
Cohesion: 0.12
Nodes (16): RestaurantList(), RestaurantContext, RestaurantContextType, RestaurantProvider(), AuditIssue, MenuCheckWidget(), getScanStats(), ScanStats (+8 more)
...
Cohesion: 0.13
Nodes (16): CreateRestaurantForm(), NotificationBell(), PaymentToast(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications() (+8 more)
...
Cohesion: 0.19
Nodes (15): MenuProvider(), useMenu(), createCategory(), createItem(), deleteCategory(), deleteItem(), getCategories(), getItems() (+7 more)
...
Cohesion: 0.2
Nodes (7): CreateRestaurantDto, errors, keysFor(), validate(), UpdateRestaurantDto, BRANDING_FONT_NAMES, SUPPORTED_TARGET_LANGUAGE_CODES
...
Cohesion: 0.22
Nodes (9): code:block1 (Create:), code:tsx (import { QRCodeSVG } from "qrcode.react";), code:bash (git add apps/frontend/src/components/pos/PosQRBill.tsx), code:tsx (import PosSplitBill from "./PosSplitBill";), code:tsx (<PosSplitBill total={total} />), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), File Structure, Task 16: PosQRBill — QR code for session bill (+1 more)

### Community 258 - "Community 258"
Cohesion: 0.22
Nodes (9): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), code:tsx (import DeviceLoginPage from "./pages/DeviceLoginPage";), code:tsx ({/* Inside <Route element={<PublicLayout />}> */}), code:bash (git add apps/frontend/src/App.tsx), File Structure, Task 5.1: Create DeviceLoginPage (PIN Keypad UI) (+1 more)
...
Cohesion: 0.32
Nodes (6): AssistanceContextValue, AssistanceRequest, getElapsedLabel(), getElapsedMinutes(), getUrgencyStyle(), RequestFilter
...
## Knowledge Gaps
- **4328 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4323 more)
...
- **Why does `FeatureService` connect `Community 7` to `Community 34`, `Community 101`, `Community 39`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 78`, `Community 112`, `Community 87`, `Community 88`, `Community 29`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 40` to `Community 32`, `Community 4`, `Community 7`, `Community 46`, `Community 30`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `t` connect `Community 4` to `Community 5`, `Community 10`, `Community 267`, `Community 14`, `Community 15`, `Community 144`, `Community 20`, `Community 148`, `Community 149`, `Community 23`, `Community 158`, `Community 30`, `Community 32`, `Community 35`, `Community 36`, `Community 40`, `Community 42`, `Community 46`, `Community 180`, `Community 181`, `Community 54`, `Community 56`, `Community 59`, `Community 60`, `Community 64`, `Community 198`, `Community 72`, `Community 332`, `Community 79`, `Community 89`, `Community 90`, `Community 220`, `Community 97`, `Community 104`, `Community 234`, `Community 127`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Are the 152 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
  _`t` has 152 INFERRED edges - model-reasoned connections that need verification._
