# Graph Report - QR_Digital_Menu-main  (2026-06-20)

## Corpus Check
- 591 files · ~891,348 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8052 nodes · 10624 edges · 598 communities (530 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `380fd98a`
...
6. `Fixed Issues & Bug Resolutions Log` - 68 edges
7. `PaymentService` - 65 edges
8. `useAuth()` - 61 edges
9. `PrismaService` - 57 edges
...
## Communities (598 total, 68 thin omitted)
...
Cohesion: 0.03
Nodes (91): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), NotificationContext (+83 more)
...
Cohesion: 0.03
Nodes (82): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), bondSection (+74 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (74): filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage() (+66 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (63): draft, PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names (+55 more)
...
Cohesion: 0.05
Nodes (31): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, burger, call, existingAcc, makeMenuItem(), makeRestaurant() (+23 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (48): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, AuditIssue (+40 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (36): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, OptionalJwtStrategy, passwordChangedAt, prisma, AnalyticsResult (+28 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (52): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+44 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (32): AuthUser, DateRangeQueryDto, RefundPaymentDto, SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, VALID_AVAILABILITY (+24 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (52): AnalyticsData, CategoryBreakdown, OrderStatusBreakdown, PeakHour, RevenueTrendPoint, TableMetric, TopItem, bgn() (+44 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (51): getMethodLabel(), PaymentDrawer(), TimelineItem(), translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles (+43 more)
...
Cohesion: 0.09
Nodes (22): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, EventsModule, HealthController, HealthModule (+14 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (12): DashboardService, RestaurantsService, brandingDto, capturedPayload, deleted, dto, expected, restaurant (+4 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (37): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider() (+29 more)
...
Cohesion: 0.07
Nodes (27): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, FontPicker(), FontPickerProps, createAssistanceRequest() (+19 more)
...
Cohesion: 0.07
Nodes (26): abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCheckout(), createPaymentIntent(), CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel(), interpolateNameFallback() (+18 more)
...
Cohesion: 0.07
Nodes (27): billOrders, boricaCardholder, boricaPayment, boricaRestaurant, [capturedPayload], created, epayPayment, epayRestaurant (+19 more)
...
Cohesion: 0.12
Nodes (15): CreateRestaurantForm(), RestaurantList(), RestaurantContext, RestaurantContextType, useScanStats(), getScanStats(), ScanStats, createRestaurant() (+7 more)
...
Cohesion: 0.13
Nodes (9): EpayProvider, checksum, decoded, encoded, form, multiple, multipleNewline, multipleSpace (+1 more)
...
Cohesion: 0.17
Nodes (12): addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), markRemindersSent(), redeemAccountPoints(), batches, date (+4 more)
...
Cohesion: 0.19
Nodes (3): CreateTableDto, UpdateTableDto, TablesController
...
Cohesion: 0.19
Nodes (5): ImageLightbox(), ImageLightboxProps, SubscriptionController, PrintableQRCodes(), resolveLogoUrl()
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosSeatSelector.tsx), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/StaffRoute.tsx), File Structure (+3 more)
...
Cohesion: 0.2
Nodes (9): code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/SuperAdminRoute.tsx), code:typescript (import { Test, TestingModule } from '@nestjs/testing';), code:bash (git add apps/backend/test/super-admin.e2e-spec.ts), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 10: SuperAdminRoute — frontend guard, Task 17: Backend e2e smoke test (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/context/AuthContext.tsx), code:bash (git add apps/frontend/src/context/AuthContext.tsx apps/front), code:tsx (// apps/frontend/src/components/StaffRoute.tsx), code:tsx (// apps/frontend/src/components/ProtectedRoute.tsx), code:bash (git add apps/frontend/src/components/StaffRoute.tsx apps/fro), File Structure, Task 2.1: Clean Up AuthContext (+1 more)
...
## Knowledge Gaps
- **4676 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4671 more)
...
- **Why does `FeatureService` connect `Community 14` to `Community 133`, `Community 38`, `Community 8`, `Community 170`, `Community 10`, `Community 12`, `Community 46`, `Community 17`, `Community 18`, `Community 83`, `Community 24`, `Community 58`, `Community 59`, `Community 93`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 39` to `Community 35`, `Community 13`, `Community 14`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `t` connect `Community 13` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 136`, `Community 11`, `Community 15`, `Community 16`, `Community 20`, `Community 23`, `Community 282`, `Community 156`, `Community 160`, `Community 161`, `Community 35`, `Community 39`, `Community 173`, `Community 175`, `Community 53`, `Community 56`, `Community 63`, `Community 196`, `Community 197`, `Community 69`, `Community 216`, `Community 347`, `Community 348`, `Community 96`, `Community 97`, `Community 239`, `Community 115`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Are the 156 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
  _`t` has 156 INFERRED edges - model-reasoned connections that need verification._
