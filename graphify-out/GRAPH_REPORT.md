# Graph Report - QR_Digital_Menu-main  (2026-06-02)

## Corpus Check
- 483 files · ~705,931 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5944 nodes · 7675 edges · 480 communities (426 shown, 54 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cfe13eec`
...
6. `useAuth()` - 56 edges
7. `PrismaService` - 52 edges
8. `3. Feature Deep Dive` - 51 edges
9. `MenuCrudService` - 32 edges
10. `FeatureService` - 30 edges
...
## Communities (480 total, 54 thin omitted)
...
Cohesion: 0.04
Nodes (50): filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), SITE_COOKIES, api, createTable(), createZone() (+42 more)
...
Cohesion: 0.04
Nodes (49): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), Order, OrderContext, OrderContextType (+41 more)
...
Cohesion: 0.07
Nodes (25): AuthUser, OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem, basePayload, dto (+17 more)
...
Cohesion: 0.07
Nodes (36): CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption, useCart() (+28 more)
...
Cohesion: 0.1
Nodes (21): AssistanceModule, DashboardModule, EventsModule, HealthController, HealthModule, LoyaltyModule, MenuImportModule, MenuViewModule (+13 more)
...
Cohesion: 0.08
Nodes (30): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), ALLOWED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), SuperAdminRoute() (+22 more)
...
Cohesion: 0.08
Nodes (27): CartDrawer(), hasTierFeature(), createPaymentIntent(), formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual(), CheckoutPage() (+19 more)
...
Cohesion: 0.08
Nodes (18): CreateDeviceEnrollmentDto, CreateRestaurantDto, errors, keysFor(), validate(), UpdateRestaurantDto, BRANDING_FIELD_SET, BRANDING_FIELDS (+10 more)
...
Cohesion: 0.06
Nodes (27): ErrorBoundary, Props, State, renderWithProviders(), SocketProvider(), CheckoutPage, CookiePolicyPage, CustomerProfilePage (+19 more)
...
Cohesion: 0.09
Nodes (11): CreateTableDto, UpdateTableDto, EventsGateway, parseCookie(), client, token, mockOrders, mockOwner (+3 more)
...
Cohesion: 0.09
Nodes (17): RestaurantContext, RestaurantContextType, RestaurantProvider(), bondSection, { container }, mockRestaurant, mockT, store (+9 more)
...
Cohesion: 0.09
Nodes (16): getTierFromPrice(), IMMEDIATE_DOWNGRADE_STATUSES, PRICE_MAP, PriceMap, configMock, eventEpoch, mockCheckoutCreate, mockConstructEvent (+8 more)
...
Cohesion: 0.12
Nodes (7): AuthModule, GoogleStrategy, JwtStrategy, passwordChangedAt, prisma, LocalStrategy, OptionalJwtStrategy
...
Cohesion: 0.13
Nodes (11): OrdersService, burger, existingAcc, makeMenuItem(), makeRestaurant(), makeTx(), order, runAt() (+3 more)
...
Cohesion: 0.18
Nodes (6): CreateZoneDto, ReorderZonesDto, ZoneOrderItem, UpdateZoneDto, TableZonesController, TableZonesModule

### Community 81 - "Community 81"
Cohesion: 0.12
Nodes (15): createDeviceEnrollment(), createStaff(), listDeviceEnrollments(), removeStaff(), resetStaffPin(), StaffMember, updateStaff(), DeviceEnrollment (+7 more)
...
Cohesion: 0.29
Nodes (8): AnalyticsView(), SummaryView(), useAnalytics(), usePaymentSummary(), useScanStats(), useSummaryDateRange(), getLoyaltyAnalytics(), getPaymentSummary()
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosItemGrid.tsx), code:tsx (import { useState, useEffect } from "react";), code:bash (git add apps/frontend/src/components/pos/PosOptionsDrawer.ts), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), File Structure (+3 more)
...
Cohesion: 0.24
Nodes (7): DateRangePreset, formatDate(), SummaryDateRange, CustomDateInput(), DateRangeFilterProps, isoToDisplayDate(), PRESET_DAYS
...
## Knowledge Gaps
- **3455 isolated node(s):** `prisma`, `prisma`, `{ PrismaClient }`, `prisma`, `{ PrismaClient }` (+3450 more)
...
- **Why does `FeatureService` connect `Community 8` to `Community 71`, `Community 7`, `Community 9`, `Community 11`, `Community 76`, `Community 46`, `Community 17`, `Community 122`, `Community 28`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 14` to `Community 8`, `Community 16`, `Community 19`, `Community 24`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 19` to `Community 65`, `Community 3`, `Community 5`, `Community 6`, `Community 39`, `Community 10`, `Community 12`, `Community 110`, `Community 47`, `Community 14`, `Community 24`, `Community 124`, `Community 31`?**
