...
## Summary
- 7494 nodes · 9896 edges · 570 communities (507 shown, 63 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 183 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cdb49509`
...
## Communities (570 total, 63 thin omitted)
...
Cohesion: 0.03
Nodes (67): CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage(), api, BoricaCheckoutResponse, CheckoutResponse (+59 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (41): AuthUser, JwtAuthGuard, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, BillingPeriod, CheckoutTier (+33 more)
...
Cohesion: 0.04
Nodes (62): RestaurantContextType, AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate() (+54 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (59): NotificationBell(), PaymentToast(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications(), Order (+51 more)
...
Cohesion: 0.04
Nodes (22): MenuAuditController, CategoryController, CategoryDetailController, ItemController, ItemDetailController, MenuAuditService, cat1, cat2 (+14 more)
...
Cohesion: 0.05
Nodes (25): AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result, servedEntry (+17 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (42): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), useOrders(), AssistanceContextValue, AssistanceRequest (+34 more)
...
Cohesion: 0.06
Nodes (13): CreatePrintStationDto, UpdatePrintStationDto, EventsGateway, parseCookie(), client, fetchSockets, inRoom, otherSocket (+5 more)
...
Cohesion: 0.08
Nodes (32): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider() (+24 more)
...
Cohesion: 0.11
Nodes (9): CreateStaffDto, UpdateStaffDto, isPinRole(), PIN_LOGIN_ROLES, mockBcryptCompare, mockBcryptHash, mockUser, real (+1 more)
...
Cohesion: 0.11
Nodes (16): CreateRestaurantForm(), RestaurantList(), RestaurantContext, bondSection, { container }, mockRestaurant, mockT, store (+8 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosSeatSelector.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), File Structure (+3 more)
...
- **Why does `FeatureService` connect `Community 5` to `Community 97`, `Community 34`, `Community 35`, `Community 6`, `Community 40`, `Community 74`, `Community 13`, `Community 20`, `Community 93`, `Community 152`, `Community 122`, `Community 123`, `Community 61`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 31` to `Community 5`, `Community 7`, `Community 18`, `Community 22`, `Community 30`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 7` to `Community 4`, `Community 8`, `Community 10`, `Community 11`, `Community 142`, `Community 14`, `Community 16`, `Community 145`, `Community 18`, `Community 146`, `Community 22`, `Community 30`, `Community 31`, `Community 36`, `Community 174`, `Community 175`, `Community 46`, `Community 59`, `Community 63`, `Community 193`, `Community 69`, `Community 326`, `Community 82`, `Community 84`, `Community 85`, `Community 216`, `Community 217`, `Community 98`, `Community 232`, `Community 110`, `Community 124`?**
