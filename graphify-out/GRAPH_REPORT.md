...
## Summary
- 7627 nodes · 10094 edges · 578 communities (510 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 187 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76d21613`
...
Cohesion: 0.03
Nodes (85): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), NotificationContext (+77 more)
...
Cohesion: 0.03
Nodes (63): filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage() (+55 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (35): AuthUser, JwtAuthGuard, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, BillingPeriod, CheckoutTier (+27 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (51): CartIconProps, MenuContext, MenuContextType, useMenuContext(), AuditIssue, MenuCheckWidget(), getGoogleReviewUrl(), submitFeedback() (+43 more)
...
Cohesion: 0.05
Nodes (55): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+47 more)
...
Cohesion: 0.05
Nodes (50): CustomTooltip(), KpiCard(), KpiCardProps, AnalyticsData, abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCheckout() (+42 more)
...
Cohesion: 0.09
Nodes (25): AssistanceModule, AuthModule, GoogleStrategy, DashboardModule, EventsModule, FeedbackModule, HealthController, HealthModule (+17 more)
...
Cohesion: 0.06
Nodes (38): CartIcon(), CartContext, CartContextType, CartItem, CartProvider(), SelectedOption, useCart(), createAssistanceRequest() (+30 more)
...
Cohesion: 0.13
Nodes (10): PinLoginMeta, LocalStrategy, CreateStaffDto, UpdateStaffDto, isPinRole(), PIN_LOGIN_ROLES, mockBcryptCompare, mockBcryptHash (+2 more)
...
Cohesion: 0.15
Nodes (11): AssistanceContextValue, AssistanceRequest, AssistanceView(), getElapsedLabel(), getElapsedMinutes(), getUrgencyStyle(), RequestFilter, formatElapsed() (+3 more)
...
Cohesion: 0.19
Nodes (12): DEFAULT_HAPPY_HOUR_DAYS, getZonedClockParts(), HappyHourConfig, isHappyHourActive(), ISO_WEEKDAY_BY_SHORT_NAME, parseTimeToMinutes(), CheckoutPage(), base (+4 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTableModal.tsx), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCategoryFilter.t), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), File Structure (+3 more)

### Community 214 - "Community 214"
Cohesion: 0.18
Nodes (10): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), File Structure, RBAC Sprint Implementation Plan, Self-Review (+2 more)
...
- **Why does `FeatureService` connect `Community 6` to `Community 96`, `Community 36`, `Community 101`, `Community 9`, `Community 73`, `Community 11`, `Community 107`, `Community 15`, `Community 16`, `Community 17`, `Community 82`, `Community 155`, `Community 61`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 20` to `Community 33`, `Community 10`, `Community 19`, `Community 6`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 10` to `Community 3`, `Community 5`, `Community 7`, `Community 137`, `Community 12`, `Community 13`, `Community 14`, `Community 19`, `Community 20`, `Community 148`, `Community 149`, `Community 147`, `Community 25`, `Community 33`, `Community 37`, `Community 38`, `Community 55`, `Community 59`, `Community 62`, `Community 67`, `Community 196`, `Community 332`, `Community 80`, `Community 220`, `Community 221`, `Community 97`, `Community 103`, `Community 235`, `Community 114`, `Community 116`, `Community 125`, `Community 126`?**
