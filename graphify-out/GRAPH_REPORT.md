...
## Summary
- 6021 nodes · 7825 edges · 492 communities (433 shown, 59 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21553e75`
...
## Communities (492 total, 59 thin omitted)
...
Cohesion: 0.03
Nodes (55): SITE_COOKIES, api, closeSession(), createDeviceEnrollment(), createStaff(), createTable(), createZone(), deleteTable() (+47 more)
...
Cohesion: 0.06
Nodes (30): AuthUser, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto (+22 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (40): isLoyaltyAvailable(), addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress(), getRewardValue(), markRemindersSent() (+32 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (38): useMenuContext(), getGoogleReviewUrl(), submitFeedback(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps, DAYS, CreateCategoryForm() (+30 more)
...
Cohesion: 0.04
Nodes (43): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, RestaurantProvider(), SocketContext, SocketContextData, SocketProvider() (+35 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (36): useAssistance(), Order, OrderContext, OrderContextType, OrderProvider(), OrderStatus, useOrders(), AssistanceContextValue (+28 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (37): CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption, useCart() (+29 more)
...
Cohesion: 0.07
Nodes (31): CartDrawer(), CustomTooltip(), KpiCardProps, createPaymentIntent(), formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual() (+23 more)
...
Cohesion: 0.08
Nodes (21): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, BillingPeriod, CheckoutTier (+13 more)
...
Cohesion: 0.06
Nodes (9): MenuAuditController, CategoryController, CategoryDetailController, ItemController, ItemDetailController, MenuAuditService, MenuModule, MenuOptionController (+1 more)
...
Cohesion: 0.1
Nodes (12): AssistanceService, CreateAssistanceDto, CreateFeedbackDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto, UpdateAssistanceDto (+4 more)
...
Cohesion: 0.14
Nodes (15): AssistanceModule, DashboardModule, EventsModule, FeedbackModule, MenuImportModule, OrdersModule, PlatformSettingsModule, PrismaModule (+7 more)
...
Cohesion: 0.1
Nodes (10): AuthModule, GoogleStrategy, LocalStrategy, OptionalJwtStrategy, VerifyDeviceEnrollmentDto, PaymentModule, DeviceEnrollmentController, RestaurantsModule (+2 more)
...
Cohesion: 0.08
Nodes (16): CategoryPills(), CategoryPillsProps, Footer(), FooterProps, linkifyPhones(), advantageItems, comparisonRows, faqItems (+8 more)
...
Cohesion: 0.21
Nodes (11): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto (+3 more)
...
Cohesion: 0.1
Nodes (11): AnalyticsView(), CHART_COLORS, dayPartKeyMap, dayParts, formatDate(), formatPercent(), getChangeCopy(), MetricCard() (+3 more)
...
Cohesion: 0.12
Nodes (11): mockFeatureService, mockPrisma, mockStorageService, tx, StorageModule, ProcessedUpload, sharp, mockConfigService (+3 more)
...
Cohesion: 0.11
Nodes (18): code:bash (git add CODING_ROADMAP.md CLAUDE.md), code:typescript (import {), code:typescript (import { Module } from '@nestjs/common';), code:bash (cd apps/backend && npm test -- --no-coverage), code:bash (git add apps/backend/src/payment/payment.controller.ts apps/), code:typescript (// Payment / TableSession), code:bash (git add apps/frontend/src/lib/api.ts), code:tsx (import { useState, useEffect } from 'react';) (+10 more)
...
Cohesion: 0.21
Nodes (8): SummaryView(), useAnalytics(), usePaymentSummary(), useScanStats(), getLoyaltyAnalytics(), getPaymentSummary(), QuickAction, QuickActionsRowProps
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/pages/pos/PosPage.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTopBar.tsx), code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/StaffRoute.tsx), File Structure (+3 more)
...
- **Why does `FeatureService` connect `Community 6` to `Community 32`, `Community 64`, `Community 7`, `Community 71`, `Community 75`, `Community 17`, `Community 55`, `Community 121`, `Community 26`, `Community 29`, `Community 126`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 12` to `Community 28`, `Community 6`, `Community 23`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 28` to `Community 128`, `Community 3`, `Community 4`, `Community 67`, `Community 38`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 44`, `Community 12`, `Community 46`, `Community 14`, `Community 113`?**
