# Graph Report - QR_Digital_Menu-main  (2026-06-04)

## Corpus Check
- 488 files · ~715,166 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6021 nodes · 7825 edges · 490 communities (432 shown, 58 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `921b77e8`
...
6. `useAuth()` - 56 edges
7. `PrismaService` - 53 edges
8. `3. Feature Deep Dive` - 51 edges
9. `MenuCrudService` - 36 edges
10. `FeatureService` - 33 edges
...
- `downloadMenuXLSX()` --calls--> `h()`  [INFERRED]
  apps/frontend/src/pages/Dashboard/MenuImportExportView.tsx → apps/frontend/src/lib/analyticsExport.ts
- `main()` --calls--> `seedHelpContent()`  [EXTRACTED]
  apps/backend/prisma/seed-help-only.ts → apps/backend/prisma/seed-help-content.ts
- `main()` --calls--> `seedHelpContent()`  [EXTRACTED]
  apps/backend/prisma/seed.ts → apps/backend/prisma/seed-help-content.ts

## Communities (490 total, 58 thin omitted)
...
Cohesion: 0.03
Nodes (52): SITE_COOKIES, api, closeSession(), createDeviceEnrollment(), createStaff(), createTable(), createZone(), deleteTable() (+44 more)
...
Cohesion: 0.05
Nodes (39): OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem, basePayload, dto, errors (+31 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (39): useMenuContext(), getGoogleReviewUrl(), submitFeedback(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps, DAYS, CreateCategoryForm() (+31 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (24): AuthUser, JwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, CreateDeviceEnrollmentDto, DateRangeQueryDto, RefundPaymentDto (+16 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (35): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, names, { result }, summary (+27 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (36): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), Order, OrderContext, OrderContextType (+28 more)
...
Cohesion: 0.06
Nodes (24): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, JwtStrategy, passwordChangedAt (+16 more)
...
Cohesion: 0.09
Nodes (25): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider(), mockUser, TestConsumer() (+17 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (28): FontPicker(), FontPickerProps, createAssistanceRequest(), createPaymentIntent(), getCategoryItems(), getMenuMeta(), recordMenuView(), BRANDING_FONT_NAMES (+20 more)
...
Cohesion: 0.06
Nodes (27): AppLayout(), CheckoutPage, CookiePolicyPage, CustomerProfilePage, DashboardPage, DeviceEnrollPage, DeviceLoginPage, FeedbackPage (+19 more)
...
Cohesion: 0.08
Nodes (24): ErrorBoundary, Props, State, NotificationBell(), PaymentToast(), renderWithProviders(), NotificationContext, NotificationContextType (+16 more)

### Community 38 - "Community 38"
Cohesion: 0.11
Nodes (9): AssistanceService, CreateAssistanceDto, CreateFeedbackDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto, UpdateAssistanceDto (+1 more)
...
Cohesion: 0.16
Nodes (14): AssistanceModule, DashboardModule, EventsModule, FeedbackModule, MenuImportModule, OrdersModule, PlatformSettingsModule, PrismaModule (+6 more)
...
Cohesion: 0.08
Nodes (18): RestaurantContext, RestaurantContextType, AuditIssue, MenuCheckWidget(), bondSection, { container }, mockRestaurant, mockT (+10 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (19): CategoryPills(), CategoryPillsProps, Footer(), FooterProps, linkifyPhones(), LANG_CODES, TopBar(), TopBarProps (+11 more)
...
Cohesion: 0.13
Nodes (9): RestaurantsService, brandingDto, capturedPayload, deleted, dto, expected, restaurant, updated (+1 more)
...
Cohesion: 0.1
Nodes (21): OrderProvider(), RestaurantProvider(), SocketContext, SocketContextData, SocketProvider(), useSocket(), filterConfig, FilterMode (+13 more)
...
Cohesion: 0.1
Nodes (12): AnalyticsView(), CHART_COLORS, dayPartKeyMap, dayParts, formatDate(), formatPercent(), getChangeCopy(), MetricCard() (+4 more)

### Community 65 - "Community 65"
Cohesion: 0.1
Nodes (12): getTierFromPrice(), configMock, eventEpoch, mockCheckoutCreate, mockConstructEvent, mockCustomersCreate, mockPortalCreate, mockSessionRetrieve (+4 more)

### Community 66 - "Community 66"
Cohesion: 0.09
Nodes (17): confirmCheckoutSession(), generateStripeConnectLink(), updateOnboardingStep(), Billing, getVisibleSteps(), OnboardingPage(), PAID_TIERS, PAYMENT_TIERS (+9 more)
...
Cohesion: 0.12
Nodes (12): AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result, servedEntry (+4 more)
...
Cohesion: 0.13
Nodes (5): CreateStaffDto, UpdateStaffDto, isPinRole(), PIN_LOGIN_ROLES, UsersService

### Community 75 - "Community 75"
Cohesion: 0.14
Nodes (6): VerifyDeviceEnrollmentDto, PaymentModule, DeviceEnrollmentController, DeviceEnrollmentService, RestaurantsModule, TranslationModule

### Community 76 - "Community 76"
Cohesion: 0.12
Nodes (13): csvToPayload(), downloadMenuXLSX(), KNOWN_ALLERGENS, parseCSVLine(), ParsedMenu, parseVariants(), splitTags(), SubTabId (+5 more)
...
Cohesion: 0.12
Nodes (11): SummaryView(), usePaymentSummary(), useScanStats(), getLoyaltyAnalytics(), getPaymentSummary(), LiveTablesGridProps, TableData, LoyaltyData (+3 more)
...
Cohesion: 0.13
Nodes (4): EventsGateway, parseCookie(), client, token
...
Cohesion: 0.16
Nodes (5): AuthModule, GoogleStrategy, LocalStrategy, OptionalJwtStrategy, UsersModule
...
Cohesion: 0.15
Nodes (10): AnalyticsData, CategoryBreakdown, OrderStatusBreakdown, PeakHour, RevenueTrendPoint, TableMetric, TopItem, getAnalytics() (+2 more)
...
Cohesion: 0.26
Nodes (7): CreateHelpContentDto, ReorderHelpContentDto, ReorderItem, UpdateHelpContentDto, dto, mockService, HelpContentModule
...
Cohesion: 0.21
Nodes (11): burger, existingAcc, makeMenuItem(), makeRestaurant(), makeTx(), mockAuthenticatedCustomer(), order, runAt() (+3 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCategoryFilter.t), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosItemCard.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), File Structure (+3 more)
...
Cohesion: 0.29
Nodes (5): COOKIE_OPTIONS, LocalAuthGuard, CreateAuthDto, PinLoginDto, UpdateAuthDto
...
Cohesion: 0.32
Nodes (5): KpiCardProps, formatComparisonLabel(), formatDateShort(), KpiRow(), KpiRowProps
...
## Knowledge Gaps
- **3489 isolated node(s):** `prisma`, `prisma`, `{ PrismaClient }`, `prisma`, `{ PrismaClient }` (+3484 more)
...
- **Why does `FeatureService` connect `Community 8` to `Community 131`, `Community 100`, `Community 38`, `Community 6`, `Community 70`, `Community 74`, `Community 11`, `Community 14`, `Community 24`, `Community 27`, `Community 28`, `Community 126`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 26` to `Community 8`, `Community 25`, `Community 21`, `Community 13`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 25` to `Community 66`, `Community 3`, `Community 5`, `Community 37`, `Community 7`, `Community 133`, `Community 9`, `Community 10`, `Community 45`, `Community 13`, `Community 48`, `Community 56`, `Community 26`, `Community 92`?**
