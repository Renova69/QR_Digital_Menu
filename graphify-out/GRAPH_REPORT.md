...
## Corpus Check
- 712 files · ~1,004,601 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8887 nodes · 12442 edges · 665 communities (579 shown, 86 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 230 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `391149ef`
...
## Communities (665 total, 86 thin omitted)
...
Cohesion: 0.02
Nodes (87): BannerSettings, TYPE_STYLES, filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage() (+79 more)
...
Cohesion: 0.06
Nodes (55): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, BoricaCardholderInfo, EpayCheckoutForm, EpayCheckoutParams, EpayMode (+47 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (64): CreateRestaurantForm(), RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), OrderProvider(), RestaurantContext (+56 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (40): BASIC_KEYS, FULL_PAYLOAD, mockDashboard, mockPrisma, OWNER, PRO_ONLY_KEYS, result, DashboardViewsService (+32 more)
...
Cohesion: 0.06
Nodes (35): AuthUser, JwtAuthGuard, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto (+27 more)
...
Cohesion: 0.07
Nodes (48): Channel, COUNTRIES, CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider(), useMenuContext() (+40 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (45): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names, { result } (+37 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (30): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto, UpdateMenuOptionDto (+22 more)
...
Cohesion: 0.05
Nodes (36): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, PinLoginMeta, JwtStrategy (+28 more)
...
Cohesion: 0.09
Nodes (24): AssistanceModule, AuthModule, DashboardModule, EventsModule, MenuImportModule, MenuViewController, MenuViewModule, OrdersModule (+16 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (39): FontPicker(), FontPickerProps, createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), BRANDING_FONT_NAMES, BRANDING_FONTS (+31 more)
...
Cohesion: 0.05
Nodes (43): ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo, SubscriptionTier, TIER_FEATURES, useTier() (+35 more)
...
Cohesion: 0.06
Nodes (14): DashboardService, AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, PREMIUM_KEYS (+6 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (37): BrandingPreview(), BrandingPreviewProps, Device, Scene, SCENE_KEYS, ColorSchemeEditor(), ColorSchemeEditorProps, ColorSwatch() (+29 more)
...
Cohesion: 0.06
Nodes (13): AuthController, COOKIE_OPTIONS, setTokenCookie(), GoogleAuthGuard, NONCE_COOKIE_OPTIONS, ctx, opts, res (+5 more)
...
Cohesion: 0.08
Nodes (23): PatronService, MenuAllergenSummary, ReservationAllergensService, ReservationReminderService, dueRow, { service, findMany, updateMany, notify }, ACCESSIBILITY_PREFERENCES, CUSTOMER_PREFERENCE_SET (+15 more)
...
Cohesion: 0.06
Nodes (29): RestaurantContextType, SummaryView(), UpgradeBanner(), usePaymentSummary(), useScanStats(), DateRangePreset, formatDate(), SummaryDateRange (+21 more)
...
Cohesion: 0.08
Nodes (22): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, ApiKeyGuard, mockPrisma, VALID_AVAILABILITY (+14 more)
...
Cohesion: 0.09
Nodes (22): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, burger, call, canceled, existingAcc, insert (+14 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (24): getMenu(), CartChoiceTranslationSource, CartItemTranslationSource, CartTranslationCategory, LiveMenuItem, LiveMenuOption, resolveCartChoiceName(), resolveCartItemName() (+16 more)
...
Cohesion: 0.15
Nodes (5): UpdatePlatformSettingsDto, PlatformSettingsService, expectSuperAdminGuards(), guardNames(), UsersDataService

### Community 109 - "Community 109"
Cohesion: 0.1
Nodes (17): baseDto, dto, enabledSettings, FUTURE, LATER, liveReservation, p2002, PAST (+9 more)
...
Cohesion: 0.15
Nodes (16): PaymentRecord, analyticsData, paymentRecord, sheets, xlsxMocks, bgn(), Cell, downloadMenuExport() (+8 more)
...
Cohesion: 0.15
Nodes (14): addDays(), addEarnedPointBatch(), ensureLoyaltyAccount(), expireAccountPoints(), getExpiringPointBatches(), logger, markRemindersSent(), redeemAccountPoints() (+6 more)
...
Cohesion: 0.17
Nodes (13): COPY, getReservationNotificationCopy(), normalizeReservationNotificationLocale(), NotificationCopy, ReservationNotificationKind, ReservationNotificationLocale, decodeEntities(), fillTemplate() (+5 more)
...
Cohesion: 0.21
Nodes (3): ReservationAvailabilityService, { service }, starts
...
Cohesion: 0.27
Nodes (7): sendViaSmsGateway(), smsGatewayConfigured(), SmsProvider, SmsSendResult, body, fetchMock, originalEnv

### Community 209 - "Community 209"
Cohesion: 0.29
Nodes (7): AvailabilityQueryDto, CreateReservationDto, ModifyReservationDto, errors, keysFor(), validate(), SUPPORTED_TARGET_LANGUAGE_CODES
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosItemCard.tsx), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), code:tsx (import { QRCodeSVG } from "qrcode.react";), code:bash (git add apps/frontend/src/components/pos/PosQRBill.tsx), File Structure (+3 more)

### Community 228 - "Community 228"
Cohesion: 0.18
Nodes (10): code:block1 (Phase 2 (Frontend):), code:typescript (// Add to UsersService class in apps/backend/src/users/users), code:bash (git add apps/backend/src/users/users.service.ts), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), File Structure, RBAC Sprint Implementation Plan, Self-Review (+2 more)
...
Cohesion: 0.29
Nodes (6): body, error, fetchMock, originalEnv, restaurant, sendEmail
...
## Knowledge Gaps
- **4766 isolated node(s):** `fs`, `content`, `m`, `Kt`, `ya` (+4761 more)
...
- **Why does `PublicMenuPage()` connect `Community 23` to `Community 3`, `Community 10`, `Community 18`, `Community 19`, `Community 21`, `Community 55`, `Community 29`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `FeatureService` connect `Community 19` to `Community 35`, `Community 6`, `Community 136`, `Community 137`, `Community 9`, `Community 43`, `Community 12`, `Community 17`, `Community 20`, `Community 22`, `Community 60`, `Community 63`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `t` connect `Community 10` to `Community 3`, `Community 4`, `Community 7`, `Community 138`, `Community 139`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 21`, `Community 23`, `Community 151`, `Community 26`, `Community 29`, `Community 159`, `Community 163`, `Community 164`, `Community 37`, `Community 38`, `Community 45`, `Community 46`, `Community 50`, `Community 53`, `Community 57`, `Community 65`, `Community 76`, `Community 78`, `Community 79`, `Community 210`, `Community 85`, `Community 235`, `Community 236`, `Community 110`, `Community 114`, `Community 252`?**
...
- **What connects `fs`, `content`, `m` to the rest of the system?**
  _4766 weakly-connected nodes found - possible documentation gaps or missing edges._
