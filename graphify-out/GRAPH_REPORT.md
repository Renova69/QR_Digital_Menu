...
## Corpus Check
- 576 files · ~860,915 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7608 nodes · 10052 edges · 569 communities (505 shown, 64 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34769882`
...
## Communities (569 total, 64 thin omitted)
...
Cohesion: 0.03
Nodes (80): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), bondSection (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (66): filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage() (+58 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (28): JwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency (+20 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (38): AuthUser, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto (+30 more)
...
Cohesion: 0.08
Nodes (44): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), useMenu(), getGoogleReviewUrl(), submitFeedback(), CategoryList() (+36 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (26): PinLoginMeta, OptionalJwtStrategy, passwordChangedAt, prisma, WrapperType, CreatePrintStationDto, CreateTableDto, UpdatePrintStationDto (+18 more)
...
Cohesion: 0.05
Nodes (46): AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate(), formatPercent() (+38 more)
...
Cohesion: 0.07
Nodes (35): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider() (+27 more)
...
Cohesion: 0.08
Nodes (15): CreateRestaurantDto, errors, keysFor(), validate(), UpdateRestaurantDto, VerifyDeviceEnrollmentDto, BRANDING_FIELD_SET, BRANDING_FIELDS (+7 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (3): LoyaltyController, RestaurantsController, SuperAdminController
...
Cohesion: 0.07
Nodes (29): getTrendingItems(), getImageUrl(), getTranslatedArray(), getTranslatedField(), Translatable, CategoryPills(), CategoryPillsProps, ImageLightbox() (+21 more)
...
Cohesion: 0.1
Nodes (25): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+17 more)
...
Cohesion: 0.09
Nodes (23): FontPicker(), FontPickerProps, createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), BRANDING_FONT_NAMES, BRANDING_FONTS (+15 more)
...
Cohesion: 0.16
Nodes (11): CategoryBreakdown, OrderStatusBreakdown, PeakHour, RevenueTrendPoint, TableMetric, TopItem, getAnalytics(), OrdersOverviewChart() (+3 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosSeatSelector.tsx), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), File Structure (+3 more)

### Community 205 - "Community 205"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:typescript (// Add to UsersService class in apps/backend/src/users/users), code:bash (git add apps/backend/src/users/users.service.ts), code:typescript (// Add to AuthController in apps/backend/src/auth/auth.contr), code:bash (git add apps/backend/src/auth/auth.controller.ts), code:typescript (// Add these imports at top of menu-crud.service.ts (alongsi), code:bash (git add apps/backend/src/menu/menu-crud.service.ts), File Structure (+3 more)
...
Cohesion: 0.21
Nodes (8): COOKIE_SAMESITE Default Changed from 'lax' to 'none' in Production, Cross-Origin Cookie & CSRF Fix — Production Deployment (May 16, 2026), CSRF Cross-Origin Compatibility, Files Changed, Frontend API Base URL — Production Cross-Origin Mode, Key Changes, Staff Credential Model Hardening (May 29, 2026), Summary
...
## Knowledge Gaps
- **4326 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4321 more)
...
- **Why does `FeatureService` connect `Community 8` to `Community 32`, `Community 35`, `Community 7`, `Community 104`, `Community 10`, `Community 42`, `Community 12`, `Community 13`, `Community 15`, `Community 79`, `Community 118`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 61` to `Community 37`, `Community 8`, `Community 46`, `Community 14`, `Community 19`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `t` connect `Community 14` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 11`, `Community 140`, `Community 141`, `Community 142`, `Community 16`, `Community 19`, `Community 26`, `Community 36`, `Community 37`, `Community 170`, `Community 43`, `Community 46`, `Community 186`, `Community 61`, `Community 320`, `Community 321`, `Community 66`, `Community 72`, `Community 73`, `Community 210`, `Community 85`, `Community 86`, `Community 223`, `Community 99`, `Community 111`, `Community 119`, `Community 120`?**
