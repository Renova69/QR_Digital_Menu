# Graph Report - QR_Digital_Menu-main  (2026-08-02)

## Corpus Check
- 1041 files · ~2,581,645 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17682 nodes · 22817 edges · 1550 communities (1466 shown, 84 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8671e0c8`
...
2. `EventsGateway` - 75 edges
3. `useAuth()` - 69 edges
4. `Fixed Issues & Bug Resolutions Log` - 69 edges
5. `Fixed Issues & Bug Resolutions Log` - 69 edges
6. `Fixed Issues & Bug Resolutions Log` - 69 edges
7. `Fixed Issues & Bug Resolutions Log` - 69 edges
8. `Fixed Issues & Bug Resolutions Log` - 69 edges
9. `Fixed Issues & Bug Resolutions Log` - 69 edges
10. `Fixed Issues & Bug Resolutions Log` - 69 edges

## Surprising Connections (you probably didn't know these)
- `constraintKeys()` --calls--> `walk()`  [INFERRED]
  apps/backend/src/menu-import/dto/import-menu.dto.spec.ts → scripts/check-prisma-raw-void.js
- `constraintKeys()` --calls--> `walk()`  [INFERRED]
  apps/backend/src/orders/dto/create-order.dto.spec.ts → scripts/check-prisma-raw-void.js
- `SummaryCard()` --calls--> `cn()`  [EXTRACTED]
  apps/frontend/src/components/subscription/BillingView.tsx → apps/frontend/src/lib/utils.ts
- `CustomerProfilePage()` --calls--> `useAuth()`  [EXTRACTED]
  apps/frontend/src/pages/CustomerProfilePage.tsx → apps/frontend/src/context/AuthContext.tsx
- `normalizeTag()` --calls--> `resolveTag()`  [EXTRACTED]
  apps/frontend/src/pages/Dashboard/MenuImportExportView.tsx → apps/frontend/src/lib/menuTags.ts

## Communities (1550 total, 84 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (140): BannerSettings, TYPE_STYLES, SITE_COOKIES, abandonCheckout(), api, AssistanceRequestQuery, AssistanceRequestType, BoricaCheckoutResponse (+132 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (116): BulkEditCellProps, MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), PrintStationsView() (+108 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (127): CustomerLoginModal(), BulkEditCell(), CartDrawer(), cartMocks, CartIcon(), CartIconProps, CartContext, CartContextType (+119 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (75): RecordConsentInput, ViewDef, created, dto, items, mockPrisma, updated, calls (+67 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (76): AvailabilityQueryDto, CreateReservationDto, ModifyReservationDto, BlackoutDto, CoverCountDto, ListReservationsQueryDto, ManualReservationDto, RESERVATION_ACTIONS (+68 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (91): useRestaurantContext(), DashboardButton, DashboardButtonProps, dashboardButtonVariants, button, onClick, { rerender }, dashboardSurface (+83 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (59): AuthUser, JwtAuthGuard, DASHBOARD_LANGUAGES, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto, CreateDeviceEnrollmentDto, CreatePaymentIntentDto (+51 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (79): AssistanceContext, AssistanceContextType, AssistancePage, AssistanceRequest, useAssistance(), RestaurantProvider(), daffi, mocks (+71 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (78): Channel, COUNTRIES, CustomerLoginModalProps, Step, BulkEditView(), DashboardProfileModal(), DashboardProfileModalProps, DashboardUser (+70 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (78): formatNotificationTimeAgo(), NotificationBell(), notificationMocks, now, translate, PaymentToast(), NotificationContext, NotificationContextType (+70 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (96): API requirements, Database migration requirements, Expected execution process, Frontend requirements, Implementation constraints, Important principle, Main objective, Processing model (+88 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (68): RenovaBrand(), RenovaBrandProps, RenovaBrandSize, RenovaMark(), RenovaMarkProps, sizeStyles, DASHBOARD_LANGUAGES, Header() (+60 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (31): WrapperType, DeepPartial, payment, tx, CreatePrintStationDto, UpdatePrintStationDto, EventsGateway, parseCookie() (+23 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (62): BulkUpdateOrderStatusDto, CreateOrderDto, OrderItemDto, OrderItemOptionDto, PosSubmissionDto, baseItem, basePayload, dto (+54 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (64): ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), hasTierFeature(), SubscriptionInfo, SubscriptionTier, TIER_FEATURES (+56 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (61): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), Order, OrderContext, OrderContextType, OrderItemSelectedOption (+53 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (36): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, { AppModule }, { NestFactory }, prisma, { PrismaClient } (+28 more)
...
Cohesion: 0.04
Nodes (59): BoricaCardholderDetails, CheckoutProvider, getMenu(), PendingBillPayment, dateKeyFormatter(), ExpiringPointBatch, ExpiringPointGroup, formatLoyaltyExpiryDate() (+51 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (42): ImportMenuDto, categories, invalid, items, payload, valid, ApiKeyGuard, mockPrisma (+34 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (47): apiMocks, nativeSetTimeout, socketMocks, timeout, base, body, CERT_PEM, { createPublicKey } (+39 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (38): LoyaltyHistoryQueryDto, isLoyaltyAvailable(), mockFeatureService, LoyaltyController, mockFeatureService, mockLoyaltyService, query, req (+30 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (50): ReservationUpdatedPayload, useReservationRealtime(), cancelManageReservation(), createReservation(), getManageReservation(), getReservationAvailability(), getReservationConfig(), getReservationStatus() (+42 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (64): 📊 Fix Complexity vs Impact, 🔴 Full System Audit Report — July 17, 2026, 🔵 LOW FINDINGS (79 total) — Notable, 🟡 MEDIUM FINDINGS (87 total) — Key Highlights, ✅ PASSED — No Issues Found, Per-Subsystem Status, Severity Summary, 🎯 Top 10 Fix Priorities (+56 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (27): CreateFeedbackDto, CreateFeedbackInvitationDto, CreateVisitFeedbackDto, FeedbackListQueryDto, FeedbackSummaryQueryDto, PaginatedResult, PaginationDto, FeedbackController (+19 more)

### Community 25 - "Community 25"
Cohesion: 0.07
Nodes (49): BulkEditCardList(), BulkEditCardListProps, BulkEditGrid(), BulkEditGridProps, BulkEditGroup, CellPos, BulkEditToolbar(), BulkEditToolbarProps (+41 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (26): AuthController, dto, mockAuthService, mockJwtAuthGuard, mockLocalAuthGuard, mockResult, req, res (+18 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (29): UpdatePlatformSettingsDto, PlatformSettingsService, dto, mockPrisma, mockTx, payload, singletonSettings, updatedSettings (+21 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (28): PinLoginMeta, existingUser, fetchMock, futureDate, hashedCode, mockCompare, mockHash, newUser (+20 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (42): BrandingPreview(), BrandingPreviewProps, Device, Scene, SCENE_KEYS, ColorSchemeEditor(), ColorSchemeEditorProps, ColorSwatchProps (+34 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (39): getMethodLabel(), PaymentDrawer(), TimelineItem(), PaymentReconciliationQueue(), PaymentReconciliationQueueProps, QueueAction, ReconciliationDecision, api (+31 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (48): data, filePath, fs, locales, localesDir, path, data, filePath (+40 more)
...
Cohesion: 0.05
Nodes (12): VerifyDeviceEnrollmentDto, DeviceEnrollmentController, dto, mockSvc, DeviceEnrollmentService, RestaurantsController, dto, mockDeviceEnrollment (+4 more)

### Community 41 - "Community 41"
Cohesion: 0.15
Nodes (31): SettleAllocationDto, SettlePartialDto, SplitMode, BillPaymentScope, billScopeFromCashRequest(), billScopeFromCheckoutScope(), billScopeFromPayment(), billScopesEqual() (+23 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (23): BillingPeriod, CheckoutTier, CreateCheckoutDto, SubscriptionController, ForceTierExpiryRow, getTierFromPrice(), GraceExpiryRow, IMMEDIATE_DOWNGRADE_STATUSES (+15 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (16): BRANDING_FIELD_SET, BRANDING_FIELDS, dto, dtoCopy, result, stripBrandingFields(), RestaurantsService, brandingDto (+8 more)

### Community 44 - "Community 44"
Cohesion: 0.05
Nodes (31): buildRestaurantDateRange(), buildRestaurantPresetDateRange(), RestaurantDateRange, AnalyticsResult, canceledEntry, defaultAggregate, directTrend, end (+23 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (40): billOrders, boricaCardholder, boricaPayment, boricaRestaurant, [capturedPayload], created, DeepPartial, epayPayment (+32 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (30): ConsentCategoryKey, ConsentContext, ConsentContextValue, ConsentProvider(), storageKeyFor(), StoredConsentState, consent, ConsentConsumer() (+22 more)

### Community 48 - "Community 48"
Cohesion: 0.1
Nodes (35): CancelAnalysisPanel(), CustomerKitchenPanels(), StaffPerformancePanel(), TableTurnoverPanel(), computeInsights(), insights, Panel(), CategoryMix() (+27 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (16): CreateZoneDto, ReorderZonesDto, ZoneOrderItem, UpdateZoneDto, dto, mockZonesService, req, TableZonesController (+8 more)

### Community 51 - "Community 51"
Cohesion: 0.08
Nodes (31): PosProvider(), syncEngine, { result }, useCombined(), usePosOfflineSync(), createOrder(), asRecord(), classifySyncError() (+23 more)

### Community 52 - "Community 52"
Cohesion: 0.06
Nodes (35): bothTranslationsReady, buildOrderService(), createDedicatedPrisma(), createOrderSessionFixture(), createReservationFixture(), createRestaurantFixture(), crud, emitPrintJob (+27 more)
...
Cohesion: 0.07
Nodes (26): PushSubscriptionKeysDto, SubscribePushDto, PushController, mockPushService, req, subscription, PushModule, ALLOWED_PUSH_HOST_SUFFIXES (+18 more)
...
Cohesion: 0.05
Nodes (37): 1. Fully Configurable VIP Tiers (Per Restaurant), 2. Automated Expiry Reminder System (Cron + Manual Endpoint), 3. Frontend — API-Driven Tier Display (No More Client-Side Tier Calculations), `apps/backend/src/loyalty/loyalty.controller.ts`, `apps/backend/src/loyalty/loyalty-ledger.utils.ts`, `apps/backend/src/loyalty/loyalty.module.ts`, `apps/backend/src/loyalty/loyalty.service.ts`, `apps/frontend/src/pages/CheckoutPage.tsx` (+29 more)
...
Cohesion: 0.06
Nodes (35): API Contract, Call-Waiter, Future-Break, H-21: Unbounded `payment.findMany({})` in export path, H-22: Unbounded `loyaltyAccount.findMany` without `take`, H-23: `order.findMany` without pagination in loyalty `getHistory()`, H-24: `restaurant.findUnique` without `select` in POS order creation hot path, H-25: Stuck print jobs never promoted to FAILED (+27 more)
...
Cohesion: 0.06
Nodes (35): Auth Log Scrubbing (May 18, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Files Changed (+27 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (35): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Files Changed, Files Changed (+27 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (35): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Custom Date Filter Heading — Analytics Deep-Dive (May 24, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Files Changed (+27 more)
...
Cohesion: 0.08
Nodes (30): BRAND_NAMES, CANONICAL_SOURCE_TEXTS, CONDIMENTS, DISH_NAMES, GlossaryKind, GROUPS, HOT_DRINKS, INGREDIENTS (+22 more)
...
Cohesion: 0.07
Nodes (22): BASE_RESTAURANT, created, first, mockEvents, mockMenuTranslation, mockMenuTranslationRead, mockPrisma, mockStorage (+14 more)

### Community 79 - "Community 79"
Cohesion: 0.06
Nodes (32): C-10: Zero `React.memo` anywhere — every component re-renders on any state change, C-11: Only 2 ErrorBoundary instances — root boundary blanks entire app, C-12: JA: 604/3212 keys (18.8%), RU: 613/3212 (19.1%), AR: 604/3212 (18.8%), C-13: DE/FR/IT/ES/ZH: 100 keys missing each, C-14: Missing `relationMode = "prisma"` in datasource, C-15: Unguarded `CREATE TYPE` in migration, C-16: `payment:refundRequired` emitted but NO frontend listener exists, C-17: Cross-tab cooldown bypass (+24 more)
...
Cohesion: 0.09
Nodes (22): usePos(), useIdleTimer(), buildTableSessionCheckoutUrl(), Category, PosCategoryFilter(), PosCategoryFilterProps, MenuOption, PosItemCard() (+14 more)

### Community 91 - "Community 91"
Cohesion: 0.07
Nodes (26): CancelAnalyticsData, CancelHourRow, CancelItemRow, CategoryBreakdown, CloseoutReport, CustomerMetric, CustomerMetricsData, DailyTargetData (+18 more)

### Community 92 - "Community 92"
Cohesion: 0.06
Nodes (31): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Custom Date Filter Heading — Analytics Deep-Dive (May 24, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Files Changed (+23 more)
...
Cohesion: 0.08
Nodes (15): PaymentNotificationFeedItem, PaymentNotificationFeedService, PaymentNotificationKind, core, prisma, readThrough, service, cardholder (+7 more)

### Community 95 - "Community 95"
Cohesion: 0.07
Nodes (18): SplitProvider, PaymentSettlementService, core, { lockOrder, service, session, tx }, prisma, service, session, tx (+10 more)

### Community 96 - "Community 96"
Cohesion: 0.1
Nodes (11): AssistanceController, AssistanceService, dto, mockEvents, mockFeatureService, mockPrisma, req, updated (+3 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (30): Auth Architecture — httpOnly Cookies + Vite Proxy (Dev) / Cross-Origin (Prod), CI Gate, code:bash (# NVM for Windows), code:bash (cd apps/backend), code:bash (cd apps/backend), code:bash (FORCE_SEED_WIPE=true npm run seed), code:bash (npm run seed:help), code:bash (npm run dev) (+22 more)
...
Cohesion: 0.07
Nodes (29): code:text (UI action), code:text (PRODUCTION_READINESS_AUDIT.md), code:markdown (# Production Readiness Audit), Dynamic translation, Identity and account security, Menu management and public menu, Non-negotiable operating rules, Ordering (+21 more)
...
Cohesion: 0.09
Nodes (14): isoToJsWeekday(), jsToIsoWeekday(), AvailabilityType, CreateCategoryDto, pipe, result, UpdateCategoryDto, allowedTypes (+6 more)
...
Cohesion: 0.07
Nodes (28): Barcodes, Binary Garbage Filtering, Control Characters (0x00-0x1F), DLE Commands (0x10 prefix), ESC Commands (0x1B prefix), ESC/POS Commands Reference - Implementation Status, Extended Commands, Extended Commands (+20 more)

### Community 108 - "Community 108"
Cohesion: 0.07
Nodes (3): mockSvc, req, SuperAdminController
...
Cohesion: 0.07
Nodes (27): Audit Quality And Scope, Consolidated Audit Fix Plan - July 18, 2026, Cross-Report Addendum Disposition, Execution Plan, Feature Projects, July 22 Formal Branch Review Remediation, Local Verification Evidence, No Code Fix / Close With Evidence (+19 more)
...
Cohesion: 0.07
Nodes (27): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), CI Gate Added (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Fix (+19 more)
...
Cohesion: 0.09
Nodes (15): MenuAuditController, mockAudit, req, MenuAuditService, cat1, cat2, category, errorIssues (+7 more)
...
Cohesion: 0.09
Nodes (25): Backend (`apps/backend`), Backend architecture, code:bash (npm run dev      # runs both apps (backend :3000, frontend :), code:bash (npm run start:dev      # NestJS watch mode), code:bash (npm run dev      # vite --host (strictPort, fails fast on co), code:json ([{ "name": "Medium Well", "priceModifier": 0.00 }, ...]), Conventions & gotchas, Deplotyment (+17 more)

### Community 136 - "Community 136"
Cohesion: 0.08
Nodes (25): 🔷 Analytics XLSX Export ✅ (May 19, 2026), Code Review Fixes (May 8, 2026), 🔷 Dashboard Vertical Sidebar ✅ (May 18, 2026), End-to-End Flow, 🔷 GDPR / Legal Module ✅ (May 18, 2026), 🔷 Help Center CMS ✅ (May 22, 2026), 🔷 Landing FAQ on Home Page ✅ (May 21, 2026), Live Table View (+17 more)

### Community 137 - "Community 137"
Cohesion: 0.08
Nodes (24): content, fs, m, content, fs, m, content, fs (+16 more)

### Community 138 - "Community 138"
Cohesion: 0.14
Nodes (13): ALLERGEN_KEYS, DIETARY_KEYS, isPresetTagKey(), MENU_TAG_KEY_SET, MENU_TAG_KEYS, EntityType, Field, ItemLike (+5 more)
...
Cohesion: 0.1
Nodes (14): EpayCheckoutForm, EpayCheckoutParams, EpayMode, EpayNotification, EpayNotificationStatus, EpayPage, EpayProvider, checksum (+6 more)

### Community 141 - "Community 141"
Cohesion: 0.08
Nodes (25): Addendum — Cross-report comparison (`17.07.REPORT.md` vs `17.07.FULLREPORT.md`), C-6 — "double AT TIME ZONE" in dashboard.service.ts:353,433,1058,1164, C-7 — "expiry reminder cron marks sent without sending" in loyalty.service.ts:545, code:sql (-- "createdAt" is TIMESTAMP(3) WITHOUT TIME ZONE but Prisma ), code:bash (cd apps/backend), code:ts (/**), code:ts (/**), code:ts (// before) (+17 more)
...
Cohesion: 0.08
Nodes (24): Addendum — Cross-report comparison (`17.07.REPORT.md` vs `17.07.FULLREPORT.md`), C-6 — "double AT TIME ZONE" in dashboard.service.ts:353,433,1058,1164, C-7 — "expiry reminder cron marks sent without sending" in loyalty.service.ts:545, code:sql (-- "createdAt" is TIMESTAMP(3) WITHOUT TIME ZONE but Prisma ), code:ts (// before), code:bash (cd apps/backend), code:ts (/**), code:ts (/**) (+16 more)
...
Cohesion: 0.08
Nodes (24): QR Digital Menu Domain, Staff Ordering, Upselling, QR Digital Menu Domain, Staff Ordering, Upselling, QR Digital Menu Domain, Staff Ordering (+16 more)
...
Cohesion: 0.08
Nodes (25): 🔷 Analytics XLSX Export ✅ (May 19, 2026), 🔷 Dashboard Vertical Sidebar ✅ (May 18, 2026), Duplicate Subscription Prevention, End-to-End Flow, 🔷 GDPR / Legal Module ✅ (May 18, 2026), 🔷 Help Center CMS ✅ (May 22, 2026), 🔷 Landing FAQ on Home Page ✅ (May 21, 2026), 🔷 Menu Import/Export — Combined Dashboard Tab ✅ (May 16, 2026) (+17 more)
...
Cohesion: 0.1
Nodes (12): CreateItemDto, dto, payload, tagsError, UpdateItemDto, allowedTypes, ItemController, ItemDetailController (+4 more)

### Community 157 - "Community 157"
Cohesion: 0.08
Nodes (21): baseDto, dto, enabledSettings, FUTURE, LATER, liveReservation, p2002, PAST (+13 more)
...
Cohesion: 0.08
Nodes (24): Auth Architecture — httpOnly Cookies + Vite Proxy (Dev) / Cross-Origin (Prod), CI Gate, code:bash (# NVM for Windows), code:bash (cd apps/backend), code:bash (cd apps/backend), code:bash (FORCE_SEED_WIPE=true npm run seed), code:bash (npm run seed:help), code:bash (npm run dev) (+16 more)
...
Cohesion: 0.08
Nodes (24): CI Gate, code:bash (# NVM for Windows), code:bash (cd apps/backend), code:bash (cd apps/backend), code:bash (FORCE_SEED_WIPE=true npm run seed), code:bash (npm run seed:help), code:bash (npm run dev), code:powershell (.\deploy.ps1) (+16 more)
...
Cohesion: 0.08
Nodes (24): 1. Database Schema Updates (Prisma), 2. Backend Implementation, 3. Frontend Implementation, 4. Files Modified, 5. Pending / Known Issues, 6. Testing Checklist, `apps/backend/prisma/schema.prisma`, Auth Updates (`apps/backend/src/auth`) (+16 more)
...
Cohesion: 0.15
Nodes (15): BoricaCallbackResult, BoricaCardholderInfo, BoricaCertificateStatus, BoricaCertificateValidity, BoricaCheckoutForm, BoricaCheckoutParams, BoricaMode, BoricaProvider (+7 more)
...
Cohesion: 0.11
Nodes (7): PaymentHistoryQueryDto, dto, PaymentReportingService, CoreMock, EventsMock, openIssue, PrismaMock

### Community 178 - "Community 178"
Cohesion: 0.14
Nodes (4): PaymentSessionService, error, prisma, service

### Community 179 - "Community 179"
Cohesion: 0.14
Nodes (9): CreateHelpContentDto, ReorderHelpContentDto, ReorderItem, UpdateHelpContentDto, HelpContentController, dto, mockReq, mockService (+1 more)

### Community 180 - "Community 180"
Cohesion: 0.09
Nodes (15): createHelpContent(), deleteHelpContent(), getAdminHelpContent(), reorderHelpContent(), updateHelpContent(), DashboardCategoryDialogProps, DashboardItemDialogProps, DashboardItemType (+7 more)

### Community 181 - "Community 181"
Cohesion: 0.13
Nodes (15): RestaurantContextType, SummaryView(), usePaymentSummary(), useScanStats(), DateRangePreset, formatDate(), SummaryDateRange, { result } (+7 more)

### Community 182 - "Community 182"
Cohesion: 0.09
Nodes (16): renderWithProviders(), consentMocks, { container }, i18nMocks, renderBanner(), renderWithProviders(), apiMocks, cartMocks (+8 more)
...
Cohesion: 0.23
Nodes (11): getReservationDetailLabels(), getReservationNotificationCopy(), getReservationSmsStatus(), normalizeReservationNotificationLocale(), copy, labels, buildBookingDetails(), decodeEntities() (+3 more)

### Community 185 - "Community 185"
Cohesion: 0.1
Nodes (19): result, COPY, DETAILS, NotificationCopy, ReservationDetailLabels, ReservationNotificationKind, ReservationNotificationLocale, ReservationOccasionKey (+11 more)

### Community 186 - "Community 186"
Cohesion: 0.13
Nodes (17): Currency, dto, invalid, payload, tagsError, valid, ImportCategoryDto, ImportChoiceDto (+9 more)

### Community 187 - "Community 187"
Cohesion: 0.14
Nodes (5): TranslationService, CYRILLIC_LANGUAGES, isGarbageTranslation(), KNOWN_HALLUCINATION_PATTERNS, LATIN_LANGUAGES

### Community 188 - "Community 188"
Cohesion: 0.16
Nodes (16): MenuProfitabilityPanel(), MenuProfitabilityPanelProps, formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual(), formatStackedDual(), CheckoutPage() (+8 more)
...
Cohesion: 0.09
Nodes (21): 10. Security and tenant-isolation assessment, 11. Data-integrity and concurrency assessment, 12. Payments assessment, 13. Realtime/WebSocket assessment, 14. Frontend reliability assessment, 15. Backend and API assessment, 16. Production configuration assessment, 17. Test-quality and coverage gaps (+13 more)
...
Cohesion: 0.09
Nodes (21): 1. Fully Configurable VIP Tiers (Per Restaurant), 2. Automated Expiry Reminder System (Cron + Manual Endpoint), 3. Frontend — API-Driven Tier Display (No More Client-Side Tier Calculations), `apps/backend/src/loyalty/loyalty.controller.ts`, `apps/backend/src/loyalty/loyalty-ledger.utils.ts`, `apps/backend/src/loyalty/loyalty.module.ts`, `apps/backend/src/loyalty/loyalty.service.ts`, `apps/frontend/src/pages/CheckoutPage.tsx` (+13 more)
...
Cohesion: 0.14
Nodes (10): BulkItemUpdateDto, BulkUpdateItemsDto, BulkItemController, dto, mockBulkEdit, req, BULK_EDIT_ITEM_SELECT, BulkUpdateResult (+2 more)

### Community 198 - "Community 198"
Cohesion: 0.1
Nodes (18): apiMocks, billWithProviders(), boundaryLine, coveredLine, fullPriceLine, i18nMocks, initialBill, onCashRequestCreated (+10 more)
...
Cohesion: 0.1
Nodes (12): orderStatusKeyMap, KpiCardProps, AnalyticsData, { container }, formatComparisonLabel(), formatDateShort(), KpiRow(), KpiRowProps (+4 more)
...
Cohesion: 0.1
Nodes (21): Audit Quality And Scope, Consolidated Audit Fix Plan - July 18, 2026, Cross-Report Addendum Disposition, Execution Plan, Feature Projects, July 22 Formal Branch Review Remediation, Local Verification Evidence, No Code Fix / Close With Evidence (+13 more)

### Community 203 - "Community 203"
Cohesion: 0.16
Nodes (9): CreateMenuOptionDto, UpdateMenuOptionDto, ImageRefExclusions, MenuOptionController, MenuOptionDetailController, dto, mockCrud, req (+1 more)

### Community 204 - "Community 204"
Cohesion: 0.15
Nodes (10): isBearerJwtAuthEnabled(), RuntimeEnvironment, RuntimeEnvironmentVariables, validateRuntimeEnvironment(), JwtStrategy, passwordChangedAt, prisma, OptionalJwtStrategy (+2 more)

### Community 206 - "Community 206"
Cohesion: 0.1
Nodes (19): actual, baseMock, bill, confirmBtn, markAsQueued, markAsSubmittedMock, minusBtn, openBtn (+11 more)

### Community 207 - "Community 207"
Cohesion: 0.19
Nodes (17): getTableStatuses(), getZones(), canUseCachedCatalog(), loadPosTables(), loadPosZones(), PosTableStatus, tableSnapshotKey(), tables (+9 more)

### Community 208 - "Community 208"
Cohesion: 0.14
Nodes (17): analyticsData, paymentRecord, rows, sheets, t, xlsxMocks, bgn(), Cell (+9 more)

### Community 209 - "Community 209"
Cohesion: 0.13
Nodes (13): executePrintOnce(), executionQueue, fingerprintTicket(), PrintIdentityConflictError, PrintLedgerRecord, PrintLedgerState, PrintLedgerStore, PrintOutcomeUncertainError (+5 more)
...
Cohesion: 0.14
Nodes (16): assessMigrationIntegrity(), countMigrationIntegrityBlockers(), CountRow, CurrencyRow, main(), MigrationIntegrityIssue, MigrationIntegrityResult, MigrationRow (+8 more)

### Community 212 - "Community 212"
Cohesion: 0.13
Nodes (16): CONTEXT_SET, CONTEXT_WEIGHTS, ContextualItem, getTimeUpsellContexts(), scoreUpsellItems(), instant, items, UpsellContext (+8 more)

### Community 214 - "Community 214"
Cohesion: 0.14
Nodes (9): BoricaCheckoutService, BoricaMock, ConfigMock, CoreMock, error, expired, payment, PrismaMock (+1 more)

### Community 215 - "Community 215"
Cohesion: 0.15
Nodes (8): DashboardController, BASIC_KEYS, FULL_PAYLOAD, mockDashboard, mockPrisma, OWNER, PRO_ONLY_KEYS, result

### Community 216 - "Community 216"
Cohesion: 0.15
Nodes (8): PlatformSettingsController, dto, mockSvc, settings, expectSuperAdminGuards(), guardNames(), ctx, SuperAdminGuard

### Community 217 - "Community 217"
Cohesion: 0.11
Nodes (17): analytics, button, categories, categoryList, dashboard, help, itemList, items (+9 more)

### Community 218 - "Community 218"
Cohesion: 0.11
Nodes (18): CI Gate, code:bash (# NVM for Windows), code:bash (cd apps/backend), code:bash (cd apps/backend), code:bash (FORCE_SEED_WIPE=true npm run seed), code:bash (npm run seed:help), code:bash (npm run dev), Prerequisites (+10 more)
...
Cohesion: 0.14
Nodes (5): PaymentProviderConfigService, config, context, service, url
...
Cohesion: 0.11
Nodes (16): Backend architecture, code:json ([{ "name": "Medium Well", "priceModifier": 0.00 }, ...]), Conventions & gotchas, Deplotyment, Environment & DB, Frontend architecture, graphify, Key concept: `submitted` flag (+8 more)
...
Cohesion: 0.11
Nodes (18): 10.1 Quick Wins (Low Effort, High Impact), 10.2 Architecture Improvements, 10.3 Missing Features That Competitors Have, 10.4 Modern Tech Opportunities, 10.5 Security Hardening — ALL RESOLVED (Phase 21, May 10-11, 2026), 10.6 Performance & Scale, 10.7 Monetization & Business Model Enhancements, 10. Strategic Improvement Opportunities (+10 more)
...
Cohesion: 0.18
Nodes (16): adjudicate(), backupEntityOnce(), deleteFieldKey(), EntitySnapshot, EntityType, Field, isProtectedValue(), JSON_KEY_BY_FIELD (+8 more)

### Community 248 - "Community 248"
Cohesion: 0.15
Nodes (5): NotificationDeliveryService, existing, payload, { service, prisma }, { service, prisma, provider }

### Community 249 - "Community 249"
Cohesion: 0.2
Nodes (11): isRetryableStatus(), ProductionNotificationProvider, blockedResult(), sendViaSmsGateway(), smsGatewayConfigured(), SmsProvider, SmsSendOptions, SmsSendResult (+3 more)
...
Cohesion: 0.12
Nodes (17): Data Model, Database-Level Double-Booking Protection, Existing Models to Extend, New Enums, New Models, `Reservation`, `ReservationBlackout`, `ReservationDeposit` (+9 more)
...
Cohesion: 0.12
Nodes (16): Architecture: Single Source of Truth, Bug 1 — Happy Hour Ignored Timezone, Bug 2 — VIP Tiers Were Hardcoded (Ignored Dashboard Settings), Bug 3 — Free Item Redemption Still Charged Options, Bug 4 — `reminderSentAt` Was Never Written (Reminder System Inoperative), Bug 5 — `Promise.all` Inside Prisma Transaction (Potential Deadlock), Bugs Found and Fixed, code:typescript (import { DateTime } from "luxon";) (+8 more)

### Community 255 - "Community 255"
Cohesion: 0.12
Nodes (16): Backend architecture, code:json ([{ "name": "Medium Well", "priceModifier": 0.00 }, ...]), Conventions & gotchas, Deployment, Environment & DB, Frontend architecture, graphify, Key concept: `submitted` flag (+8 more)
...
Cohesion: 0.16
Nodes (12): verifyDeviceEnrollment(), DeviceEnrollmentResult, EnrollState, getApiMessage(), isAlreadyUsedEnrollmentError(), isSharedDeviceDisabledError(), SharedDeviceConfig, localStorageMock (+4 more)

### Community 265 - "Community 265"
Cohesion: 0.15
Nodes (9): PosCartItem, PosContext, PosContextType, PosSession, PosSessionInput, RESTORABLE_ACTIVE_SEATS, SessionBill, mapSessionBillToPosHistoryItems() (+1 more)

### Community 266 - "Community 266"
Cohesion: 0.13
Nodes (11): CustomDateInput(), DatePickerTrigger, DatePickerTriggerProps, DateRangeFilterProps, parseDateString(), PRESET_DAYS, { datePickerMock }, labels (+3 more)

### Community 267 - "Community 267"
Cohesion: 0.17
Nodes (9): styles, parseSetupUrl(), Props, SetupQrScannerProps, styles, AgentConfig, clearConfig(), loadConfig() (+1 more)

### Community 268 - "Community 268"
Cohesion: 0.12
Nodes (13): acquireWakeLockMock, CONFIG, first, firstStatuses, { handlers, socket }, ioMock, printLedger, releaseWakeLockMock (+5 more)
...
Cohesion: 0.12
Nodes (16): Phase 22: Payment Provider Expansion ✅ (June 2026), Phase 23: Print Station System ✅ (June 2026), Phase 24: Analytics Deep-Dive v2/v3 ✅ (June 2026), Phase 25: i18n Expansion — 12 Locales ✅ (June 2026), Phase 26: Split Bill ✅ (June 2026), Phase 27: Service Points ✅ (June 2026), Phase 28: Web Push Notifications ✅ (June 2026), Phase 29: Context-Aware Upselling ✅ (June 2026) (+8 more)
...
Cohesion: 0.12
Nodes (16): 8. Medium findings, PRD-006 — Backend lint exceeds its enforced warning budget, PRD-007 — The canonical build and its documented safe fallback are not reliable, PRD-008 — Backend concurrency e2e is broken by a stale gateway fixture, PRD-009 — Browser critical journeys hang after all assertions pass, PRD-010 — The pre-production verifier reports migration corruption but exits successfully, PRD-011 — A committed order can be returned as failed and retried without a public idempotency key, PRD-012 — Authentication throttling is per process, not distributed (+8 more)
...
Cohesion: 0.21
Nodes (9): NotificationDeliveryController, NotificationDeliveryRequest, ClaimedDelivery, EnqueueDeliveryInput, DeliveryPayload, NOTIFICATION_PROVIDER, NotificationProvider, ProviderDeliveryResult (+1 more)
...
Cohesion: 0.13
Nodes (14): Agents Dispatched, Call-Waiter (call-waiter-auditor), Cart→Order Core Path (cart-order-consistency), Full Codebase Audit Report — 2026-07-17, Immediate (CRITICAL — money, data loss, security), LOW (summary — 15 findings), Loyalty (loyalty-integrity), Next sprint (+6 more)
...
Cohesion: 0.14
Nodes (13): account, accounts, body, existingAccount, expiresAt, fetchMock, mockDeliveries, mockFeatureService (+5 more)
...
Cohesion: 0.25
Nodes (11): AdjustLoyaltyPointsDto, ClearLoyaltyPointsDto, ResetOwnerPasswordDto, SuperAdminConfirmationDto, SuperAdminImportMenuDto, TIERS, UpdateDataRequestDto, UpdatePaymentsEnabledDto (+3 more)
...
Cohesion: 0.16
Nodes (11): superAdminGetDataRequests(), superAdminUpdateDataRequest(), NEXT_STATUS, STATUS_STYLES, confirm, mockedGetDataRequests, mockedUpdateDataRequest, renderPage() (+3 more)
...
Cohesion: 0.16
Nodes (8): getSuperAdminStats(), formatMoney(), maxTierCount(), OverviewPage(), TIER_ORDER, TIER_STYLES, TierComparison(), TierCounts

### Community 326 - "Community 326"
Cohesion: 0.21
Nodes (11): classifyConnectError(), clearConnectTimeout(), ConnectionStatus, emit(), isPrivateServerUrl(), PrintJobPayload, startSocketService(), StatusListener (+3 more)

### Community 327 - "Community 327"
Cohesion: 0.18
Nodes (10): range, print, image_to_escpos_raster(), image_to_gs_v_raster(), main(), Convert image to ESC * column-based raster format.      Args:         image_p, Convert image to GS v 0 raster format.      Args:         image_path: Path to, run_verification() (+2 more)
...
Cohesion: 0.14
Nodes (14): 10.1 Quick Wins (Low Effort, High Impact), 10.2 Architecture Improvements, 10.3 Missing Features That Competitors Have, 10.4 Modern Tech Opportunities, 10.5 Security Hardening — ALL RESOLVED (Phase 21, May 10-11, 2026), 10.6 Performance & Scale, 10.7 Monetization & Business Model Enhancements, 10. Strategic Improvement Opportunities (+6 more)
...
Cohesion: 0.18
Nodes (6): ConsentController, RecordConsentDto, body, mockConsentService, ConsentService, mockPrisma

### Community 346 - "Community 346"
Cohesion: 0.19
Nodes (10): formatPaymentAmount(), formatPaymentProvider(), ReviewCard(), ReviewInbox(), ReviewInboxProps, api, renderInbox(), view (+2 more)
...
Cohesion: 0.15
Nodes (13): 21. Staging smoke-test checklist, STG-01 — Immutable deploy, readiness and termination (P0), STG-02 — Authentication, authorization and tenant isolation (P0), STG-03 — Menu, translation, upload and public PWA (P1), STG-04 — Order idempotency and table-session concurrency (P0), STG-05 — Cross-instance realtime and Redis degradation (P0), STG-06 — Durable printer delivery (P0), STG-07 — Payments, refunds and reconciliation (P0) (+5 more)
...
Cohesion: 0.17
Nodes (4): ErrorBoundary, Props, State, RouteGroupErrorBoundaryProps
...
Cohesion: 0.26
Nodes (9): RecentOrdersProps, Table, TableBody, TableCaption, TableCell, TableFooter, TableHead, TableHeader (+1 more)
...
Cohesion: 0.21
Nodes (8): getAndroidApiVersion(), LogEntry, Props, requestAndroidNotificationPermission(), styles, StatusUpdate, isIgnoringBatteryOptimizations(), requestBatteryOptimizationExemption()

### Community 369 - "Community 369"
Cohesion: 0.17
Nodes (12): 10. Testing Checklist (May 2026), 11. Rating, 3. Orders Service Updates, 5. Files Changed (May 2026 Rewrite), 7. My Verification Concerns, 8. Minor Items to Review, 9. Final System Values, Areas Needing Verification (+4 more)
...
Cohesion: 0.17
Nodes (12): API Contract, H-28: 3 reservation routes missing `@RequireFeature(RESERVATIONS)`, H-29: FREE-to-Starter no-payment upgrade path missing, H-30: `updateDataRequest` has no audit log entry, H-31: `MenuItem.weight` missing from CRUD DTOs, H-36: `closeSessionWithProvider` uses stale balance, H-37: Card payment confirm/cancel + table CRUD lack FeatureGuard, 🟠 HIGH FINDINGS (+4 more)
...
Cohesion: 0.14
Nodes (12): Analytics Deep-Dive Full i18n (May 24, 2026), Auth Log Scrubbing (May 18, 2026), Files Changed, Files Changed, Files Changed, Fix, Key Changes, Key Changes (+4 more)
...
Cohesion: 0.27
Nodes (8): getBackendReadinessUrl(), fetchImpl, sleep, waitForBackend(), configuredTimeout, env, fileEnv, readinessUrl
...
Cohesion: 0.2
Nodes (8): sendToPrinter(), { client }, { client, handlers }, createConnection, rejection, result, SocketHandler, writeError
...
Cohesion: 0.18
Nodes (10): 1. App Overview, 2. Tech Stack, 3. Features, 4. Quick Start (Monorepo Workflow), 6. Database Schema, 7. Scaling Plan, 8. API Endpoints, code:bash (# 1. Install dependencies at the root) (+2 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTopBar.tsx), code:tsx (import { useState, useEffect } from "react";), code:bash (git add apps/frontend/src/components/pos/PosOptionsDrawer.ts), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)

### Community 425 - "Community 425"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/context/AuthContext.tsx), code:typescript (// Add to UsersService class in apps/backend/src/users/users), code:bash (git add apps/backend/src/users/users.service.ts), code:bash (git add apps/frontend/src/context/AuthContext.tsx apps/front), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), File Structure (+3 more)
...
Cohesion: 0.22
Nodes (5): ReservationReminderService, dueRow, { service, findMany, enqueueMany }, { service, findMany, prepare, enqueueMany }, { service, findMany, updateMany, notify }

### Community 454 - "Community 454"
Cohesion: 0.2
Nodes (8): missing, notesUpdate, { prisma, service, tx, updated }, { request, service, tx }, { service, tx }, statusUpdate, valid, wrong

### Community 455 - "Community 455"
Cohesion: 0.2
Nodes (8): backendOrigin, BENIGN_PROXY_CODES, env, isProxyLabel, now, originalError, PROXY_ERROR_LABELS, quietLogger

### Community 456 - "Community 456"
Cohesion: 0.2
Nodes (7): StaffCreatedModalProps, { container }, defaultProps, mockT, onClose, qrSvg, writeText
...
Cohesion: 0.2
Nodes (9): code:typescript (import { IsIn, IsOptional, IsBoolean } from "class-validator), code:bash (git add apps/backend/src/super-admin/dto/update-tenant.dto.t), code:typescript (import {), code:bash (git add apps/backend/src/super-admin/super-admin.controller.), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 18: Build verification, Task 4: DTOs — create update-tenant DTO (+1 more)
...
Cohesion: 0.2
Nodes (10): C-10: Zero `React.memo` in the frontend, C-11: Only 2 ErrorBoundary instances, C-12 / C-13: i18n coverage — confirmed, worse for JA/RU/AR than for DE/FR/IT/ES/ZH, C-16: `payment:refundRequired` emitted, zero frontend listeners, C-1: Payment stuck PENDING forever after session closes before Stripe confirms, C-2: MyPOS card-terminal payments have zero provider confirmation, C-3: Payment secrets encrypted under JWT_SECRET fallback, C-4: Unsalted single-round SHA256 key derivation (+2 more)
...
Cohesion: 0.2
Nodes (9): 🟠 Confirmed HIGH, Downgraded to backlog / verify-only (real but low current risk), Frontend, Payments / Money, POS session concurrency, RBAC / Infra / Misc, Recommended fix order, REFUTED — do not act on these (+1 more)
...
Cohesion: 0.22
Nodes (6): bill, first, names, { result }, second, summary
...
Cohesion: 0.31
Nodes (7): error, getNodeVersionError(), parseNodeMajor(), assert, error, {
  getNodeVersionError,
  parseNodeMajor,
}, test
...
Cohesion: 0.22
Nodes (9): Changes made, Cost controls, Current implementation found, Database changes, Remaining risks, Required final report, Safety and correctness, Translation flow (+1 more)
...
Cohesion: 0.22
Nodes (9): API Contract, H-28: 3 reservation routes missing `@RequireFeature(RESERVATIONS)`, H-29: FREE-to-Starter no-payment upgrade path missing, H-30: `updateDataRequest` has no audit log entry, H-31: `MenuItem.weight` missing from CRUD DTOs, 🟠 HIGH FINDINGS, RBAC, Subscription (+1 more)
...
Cohesion: 0.25
Nodes (5): menuItems, menuMeta, openCart, reservationConfig, reservationRequest

### Community 599 - "Community 599"
Cohesion: 0.25
Nodes (6): apiMock, bill, { onFullyPaid, onOpenChange }, partiallyPaidBill, renderDrawer(), stableTranslation
...
Cohesion: 0.25
Nodes (8): Batching, Character usage tracking, DeepL integration requirements, Glossary usage, Limits, Retries and failures, Use context for short menu content, Use DeepL only for dynamic restaurant content
...
Cohesion: 0.25
Nodes (8): Changed-field detection, Manual overrides, Outdated translations, Permanent storage, Public menu fallback, Source language, Translation behaviour, Translation trigger
...
Cohesion: 0.33
Nodes (3): ReservationRedirectController, mockSvc, res
...
Cohesion: 0.29
Nodes (7): code:ts (// before), code:ts (// before), code:ts (const accounts = await this.prisma.loyaltyAccount.findMany({), code:ts (let cursor: string | undefined;), H-10 — Revenue KPIs include PENDING_PAYMENT (abandoned online checkouts), H-22 — Unbounded `loyaltyAccount.findMany` in owner-triggered reminder endpoints, Tier 1 — Fix now (revenue-visible correctness + unbounded owner-facing query)
...
Cohesion: 0.29
Nodes (7): Backend (`apps/backend`), code:bash (npm run dev      # runs both apps (backend :3000, frontend :), code:bash (npm run start:dev      # NestJS watch mode), code:bash (npm run dev      # vite --host (strictPort, fails fast on co), Frontend (`apps/frontend`), Reference docs, Root (turbo orchestrated)
...
Cohesion: 0.33
Nodes (3): fetchReservationAnalytics(), mockPrisma, now
...
Cohesion: 0.33
Nodes (6): code:ts (// before), code:ts (// new helper, modeled on getRefundTotals but grouped by pro), code:ts (const [collected, refunded, byMethod, refundedByMethod] = aw), H-23 — Unbounded `order.findMany` in loyalty `getHistory()`, H-9 — `paymentsByMethod` breakdown doesn't net refunds (per-method only), Tier 2 — Fix soon (lower blast radius, still real)
...
Cohesion: 0.33
Nodes (6): code:powershell (.\deploy.ps1), code:bash (cd apps/backend), Deploy Backend (Cloud Run), Deploy Frontend (Vercel), Key Production Env Vars, Production Deployment

### Community 815 - "Community 815"
Cohesion: 0.33
Nodes (6): Auth Architecture — httpOnly Cookies + Vite Proxy (Dev) / Cross-Origin (Prod), code:javascript (// vite.config.js — proxy configuration (dev only)), CSRF protection, Development: Same-Origin Vite Proxy, How authentication works, Production: Cross-Origin (Vercel → Cloud Run)
...
Cohesion: 0.33
Nodes (6): 7. High findings, PRD-001 — A print job can be physically printed more than once, PRD-002 — Production silently degrades to instance-local realtime state, PRD-003 — Reminder records can claim success without delivery and can duplicate across instances, PRD-004 — High-severity advisories are installed on production request paths, PRD-005 — Recovery from database loss or a bad release is not demonstrated

### Community 821 - "Community 821"
Cohesion: 0.33
Nodes (6): 5. Directory Structure (Monorepo), Backend Details, code:block2 (apps/), code:block3 (apps/backend/src/), code:block4 (frontend/), Frontend (React + Vite)

### Community 822 - "Community 822"
Cohesion: 0.33
Nodes (5): code:bash (npm test), Coverage and lint, File naming, Test boundaries, Testing
...
Cohesion: 0.33
Nodes (6): 6. TrendingCarousel Skeleton Loader (P1), code:tsx (if (loading || trendingItems.length === 0) return null;), code:block8 (Page loads → [gap where carousel will be] → data arrives → [), code:block9 (Page loads → [skeleton placeholder] → data arrives → [skelet), Problem, What Changed
...
Cohesion: 0.33
Nodes (6): P0.1 Captured payment after session close, P0.2 BORICA ambiguous/late payment recovery, P0.3 POS/table-session order race, P0.4 Payment credential key migration, P0.5 Deployment gate for the repair migration, P0 - Fix First
...
Cohesion: 0.4
Nodes (3): fetchMock, originalEnv, provider
...
Cohesion: 0.5
Nodes (4): GLOSSARY, main(), SAMPLE_TEXTS, translate()
...
Cohesion: 0.4
Nodes (5): 4. Audit coverage, Blockers and limitations, Fully inspected, Not inspected, Partially inspected

### Community 926 - "Community 926"
Cohesion: 0.4
Nodes (5): 9. Low and informational findings, PRD-021 — Abandoned restaurant-logo uploads can leave unreferenced objects, PRD-022 — Unknown DTO properties are stripped rather than rejected, PRD-023 — Audit host npm differs from the repository-pinned package manager, PRD-024 — Documentation and deployment artifacts have drifted from current behavior
...
Cohesion: 0.4
Nodes (5): 9. Inline SVGs → Lucide Icons (P2), CartDrawer (`components/cart/CartDrawer.tsx`), CustomerLoginModal (`components/auth/CustomerLoginModal.tsx`), Problem, What Changed
...
}, mockWakeLockModule, nativeModules
...
Cohesion: 0.5
Nodes (4): Failure tests, Integration tests, Testing requirements, Unit tests
...
Cohesion: 0.5
Nodes (4): 20. Prioritized remediation plan, P0 — must fix before production, P1 — fix before general availability, P2 — fix soon after launch
...
Cohesion: 0.5
Nodes (4): 3. Checkout Back Navigation (P0), code:tsx (// NEW: Explicit back-to-menu URL), Problem, What Changed
...
Cohesion: 0.67
Nodes (3): 4. Frontend Updates Needed, Checkout Page (`CheckoutPage.tsx`), Customer Profile (`CustomerProfilePage.tsx`)
...
Cohesion: 0.67
Nodes (3): Dynamic content, Static translations, Target architecture

### Community 1432 - "Community 1432"
Cohesion: 0.67
Nodes (3): 1\. Static application translations, 2\. Dynamic restaurant menu content, Project context
...
Cohesion: 0.67
Nodes (3): H-36: `closeSessionWithProvider` uses stale balance, H-37: Card payment confirm/cancel + table CRUD lack FeatureGuard, POS Session
...
## Knowledge Gaps
- **10975 isolated node(s):** `fs`, `content`, `m`, `fs`, `path` (+10970 more)
...
- **Why does `FeatureService` connect `Community 6` to `Community 4`, `Community 12`, `Community 13`, `Community 16`, `Community 19`, `Community 21`, `Community 28`, `Community 40`, `Community 41`, `Community 42`, `Community 45`, `Community 176`, `Community 52`, `Community 319`, `Community 203`, `Community 204`, `Community 78`, `Community 215`, `Community 94`, `Community 95`, `Community 96`, `Community 230`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `PublicMenuContent()` connect `Community 2` to `Community 11`, `Community 29`, `Community 6`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 11` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 199`, `Community 14`, `Community 15`, `Community 18`, `Community 51`, `Community 90`, `Community 188`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **What connects `fs`, `content`, `m` to the rest of the system?**
  _10975 weakly-connected nodes found - possible documentation gaps or missing edges._
