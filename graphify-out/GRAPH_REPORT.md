...
## Corpus Check
- 597 files · ~908,644 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8203 nodes · 10948 edges · 599 communities (530 shown, 69 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 196 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1c0c9c9`
...
## Communities (599 total, 69 thin omitted)
...
Cohesion: 0.03
Nodes (82): RestaurantList(), RestaurantContext, useRestaurantContext(), SettingsTab, SettingsView(), bondSection, { container }, disabledCreateButton (+74 more)
...
Cohesion: 0.03
Nodes (78): RestaurantContextType, filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage() (+70 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (58): OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem, basePayload, dto, errors (+50 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (54): draft, PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names (+46 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (56): Channel, COUNTRIES, CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider(), useMenuContext() (+48 more)
...
Cohesion: 0.04
Nodes (60): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, NotificationContext, NotificationContextType (+52 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (22): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto (+14 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (27): OptionalJwtStrategy, passwordChangedAt, prisma, BASIC_KEYS, FULL_PAYLOAD, mockDashboard, mockPrisma, OWNER (+19 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (31): AuthUser, CreateDeviceEnrollmentDto, CreateRestaurantDto, DateRangeQueryDto, RefundPaymentDto, errors, keysFor(), validate() (+23 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (47): AnalyticsView(), CategoryMix(), CHART_COLORS, CustomTooltip(), dayPartKeyMap, dayParts, EmptyState(), formatDate() (+39 more)
...
Cohesion: 0.07
Nodes (38): CustomerLoginModal(), CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider() (+30 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (44): CreateRestaurantForm(), useAssistance(), useOrders(), AssistanceContextValue, AssistanceRequest, AssistanceView(), getCashRequestScopeLabel(), getCashRequestStatusLabel() (+36 more)
...
Cohesion: 0.06
Nodes (42): BrandingPreview(), BrandingPreviewProps, Device, Scene, SCENE_KEYS, ColorSchemeEditor(), ColorSchemeEditorProps, ColorSwatch() (+34 more)
...
Cohesion: 0.07
Nodes (36): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), SuperAdminRoute(), AuthContext (+28 more)
...
Cohesion: 0.05
Nodes (39): KpiCard(), KpiCardProps, AnalyticsData, CancelAnalyticsData, CancelHourRow, CancelItemRow, CategoryBreakdown, CloseoutReport (+31 more)
...
Cohesion: 0.08
Nodes (12): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, FeatureService, isPinRole(), PIN_LOGIN_ROLES, mockBcryptCompare (+4 more)
...
Cohesion: 0.06
Nodes (32): billOrders, boricaCardholder, boricaPayment, boricaRestaurant, [capturedPayload], created, epayPayment, epayRestaurant (+24 more)
...
Cohesion: 0.07
Nodes (26): BoricaCardholderDetails, CheckoutProvider, createCashPaymentRequest(), createCheckout(), createPaymentIntent(), PendingBillPayment, CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel() (+18 more)
...
Cohesion: 0.09
Nodes (22): DashboardSummary, createCategory(), createItem(), deleteCategory(), deleteItem(), getCategories(), getItems(), updateCategory() (+14 more)

### Community 53 - "Community 53"
Cohesion: 0.11
Nodes (27): bgn(), Cell, CloseoutReport, dayParts, downloadAnalyticsExport(), empty(), eur(), exportCloseoutXlsx() (+19 more)
...
Cohesion: 0.12
Nodes (7): UpdatePlatformSettingsDto, PlatformSettingsModule, PlatformSettingsService, RetentionService, UsersDataController, UsersDataModule, UsersDataService
...
Cohesion: 0.07
Nodes (27): Analytics Deep-Dive Full i18n (May 24, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Fixed Issues & Bug Resolutions Log (+19 more)
...
Cohesion: 0.11
Nodes (21): abandonCheckout(), createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), clearOwnedOrderIds(), getOwnedOrderIds(), ownedOrdersKey() (+13 more)

### Community 70 - "Community 70"
Cohesion: 0.1
Nodes (21): TimelineItem(), MetricCard(), PaymentsView(), SettingCard(), cn(), SummaryCard(), formatElapsed(), statusConfig (+13 more)
...
Cohesion: 0.1
Nodes (21): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, EpayCheckoutForm, EpayCheckoutParams, EpayMode, EpayNotification (+13 more)
...
Cohesion: 0.14
Nodes (15): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+7 more)
...
Cohesion: 0.11
Nodes (18): code:bash (cd apps), code:bash (npm install socket.io-client), code:json ({), code:json ({), code:bash (npx expo prebuild --platform android), code:bash (git add apps/printer-agent/), code:typescript (// apps/printer-agent/src/store/config.ts), code:tsx (// apps/printer-agent/src/screens/SetupScreen.tsx) (+10 more)

### Community 121 - "Community 121"
Cohesion: 0.12
Nodes (13): getSessionBill(), SessionBill, settlePartial(), SplitProvider, eur(), Mode, PosSplitDrawer(), PosSplitDrawerProps (+5 more)
...
Cohesion: 0.12
Nodes (17): 3. loyalty-integrity (Loyalty Math), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)
...
Cohesion: 0.12
Nodes (17): 14. print-station-auditor (Receipt Printers), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)
...
Cohesion: 0.12
Nodes (16): 2. pos-session-auditor (POS Session Lifecycle), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+8 more)

### Community 146 - "Community 146"
Cohesion: 0.12
Nodes (16): 15. auth-strategy-auditor (Authentication Perimeter), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+8 more)
...
Cohesion: 0.13
Nodes (14): code:bash (git add CODING_ROADMAP.md CLAUDE.md), code:typescript (import {), code:typescript (import { Module } from '@nestjs/common';), code:bash (cd apps/backend && npm test -- --no-coverage), code:bash (git add apps/backend/src/payment/payment.controller.ts apps/), code:typescript (// Payment / TableSession), code:bash (git add apps/frontend/src/lib/api.ts), code:bash (stripe listen --forward-to localhost:3000/api/payments/webho) (+6 more)
...
Cohesion: 0.24
Nodes (10): buildEscPosTicket(), CMD, DEFAULTS, divider(), fmtTime(), PrintTicket, ReceiptTemplate, result (+2 more)
...
Cohesion: 0.36
Nodes (5): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, PrintItem, GenerateTokenDto
...
Cohesion: 0.2
Nodes (9): code:typescript (import { IsIn, IsOptional, IsBoolean } from 'class-validator), code:bash (git add apps/backend/src/super-admin/dto/update-tenant.dto.t), code:tsx (import { Outlet, NavLink } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/super-admin/SuperAdminLayout), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 11: SuperAdminLayout — dark sidebar layout, Task 18: Build verification (+1 more)
...
Cohesion: 0.21
Nodes (8): Files Changed, Files Changed, Implementation, Key Changes, Public Menu Footer + Social Icons (May 23, 2026), Staff Creation Race & Duplicate Handling (May 25, 2026), Summary, Summary
...
## Knowledge Gaps
- **4728 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4723 more)
...
- **Why does `FeatureService` connect `Community 35` to `Community 163`, `Community 37`, `Community 7`, `Community 42`, `Community 139`, `Community 12`, `Community 13`, `Community 173`, `Community 14`, `Community 16`, `Community 85`, `Community 21`, `Community 89`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 69` to `Community 35`, `Community 9`, `Community 11`, `Community 17`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `t` connect `Community 9` to `Community 3`, `Community 5`, `Community 389`, `Community 8`, `Community 11`, `Community 141`, `Community 15`, `Community 17`, `Community 18`, `Community 20`, `Community 23`, `Community 26`, `Community 161`, `Community 38`, `Community 166`, `Community 48`, `Community 53`, `Community 54`, `Community 56`, `Community 59`, `Community 65`, `Community 69`, `Community 70`, `Community 201`, `Community 86`, `Community 218`, `Community 352`, `Community 103`, `Community 246`, `Community 247`, `Community 121`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Are the 162 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
...
- **What connects `Kt`, `ya`, `p` to the rest of the system?**
  _4728 weakly-connected nodes found - possible documentation gaps or missing edges._
