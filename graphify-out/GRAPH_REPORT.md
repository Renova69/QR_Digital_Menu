...
## Summary
- 7902 nodes · 10467 edges · 591 communities (521 shown, 70 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 189 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `56794f1e`
...
## Communities (591 total, 70 thin omitted)
...
Cohesion: 0.04
Nodes (59): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, PinLoginMeta, AuthUser (+51 more)
...
Cohesion: 0.03
Nodes (80): filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage() (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (63): CreateRestaurantForm(), RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, RestaurantContextType (+55 more)
...
Cohesion: 0.04
Nodes (61): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, AuthContext (+53 more)
...
Cohesion: 0.04
Nodes (21): MenuAuditController, CategoryController, CategoryDetailController, ItemController, ItemDetailController, MenuAuditService, cat1, cat2 (+13 more)
...
Cohesion: 0.06
Nodes (40): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+32 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (39): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), useMenu(), CategoryList() (+31 more)
...
Cohesion: 0.08
Nodes (23): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, CreateStaffDto, UpdateCategoryDto (+15 more)
...
Cohesion: 0.06
Nodes (11): EventsGateway, parseCookie(), client, fetchSockets, inRoom, otherSocket, revokedSocket, token (+3 more)
...
Cohesion: 0.07
Nodes (10): UpdatePlatformSettingsDto, PlatformSettingsController, PlatformSettingsService, expectSuperAdminGuards(), guardNames(), ctx, SuperAdminGuard, RetentionService (+2 more)
...
Cohesion: 0.08
Nodes (12): CreateFeedbackDto, OrderQueryDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto, FeedbackController, FeedbackModule (+4 more)
...
Cohesion: 0.07
Nodes (25): Channel, COUNTRIES, CustomerLoginModalProps, Step, DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, changePassword() (+17 more)
...
Cohesion: 0.06
Nodes (31): Atomic Refund — Race Condition Fix (May 23, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Dashboard Purple/Violet Luxury Redesign (May 24, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+23 more)
...
Cohesion: 0.08
Nodes (23): FontPicker(), FontPickerProps, abandonCheckout(), createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), BRANDING_FONT_NAMES (+15 more)
...
Cohesion: 0.07
Nodes (25): BoricaCardholderDetails, CheckoutProvider, createCheckout(), createPaymentIntent(), CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel(), interpolateNameFallback(), Translate (+17 more)
...
Cohesion: 0.19
Nodes (12): CustomerLoginModal(), ClassicCard(), getQrCodeUrl(), MinimalCard(), PremiumCard(), PrintableQRCodes(), PrintableQRCodesProps, PrintOrientation (+4 more)

### Community 146 - "Community 146"
Cohesion: 0.14
Nodes (13): 10. migration-safety (Prisma Migrations), 21-Agent Codebase Audit — Complete Findings (107 total), CRITICAL, CRITICAL, HIGH, HIGH, Historical Pending TODO (superseded; 0 explicit `**[TODO]**` finding rows now), Legend (+5 more)
...
Cohesion: 0.23
Nodes (6): errors, keysFor(), validate(), UpdateRestaurantDto, BRANDING_FONT_NAMES, SUPPORTED_TARGET_LANGUAGE_CODES
...
Cohesion: 0.22
Nodes (9): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCategoryFilter.t), code:tsx (import PosSplitBill from "./PosSplitBill";), code:tsx (<PosSplitBill total={total} />), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), File Structure, Task 17: Integration — wire Phase D components into PosCartDrawer (+1 more)
...
Cohesion: 0.29
Nodes (7): 7. seed-safety-auditor (Seed Scripts), CRITICAL, CRITICAL, HIGH, HIGH, MEDIUM, MEDIUM
...
- **Why does `FeatureService` connect `Community 3` to `Community 64`, `Community 97`, `Community 34`, `Community 37`, `Community 12`, `Community 109`, `Community 142`, `Community 18`, `Community 21`, `Community 123`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 59` to `Community 3`, `Community 7`, `Community 39`, `Community 10`, `Community 16`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `t` connect `Community 7` to `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 140`, `Community 13`, `Community 15`, `Community 144`, `Community 16`, `Community 17`, `Community 27`, `Community 39`, `Community 41`, `Community 49`, `Community 50`, `Community 177`, `Community 59`, `Community 62`, `Community 68`, `Community 74`, `Community 75`, `Community 226`, `Community 98`, `Community 125`?**
