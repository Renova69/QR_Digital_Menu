...
## Corpus Check
- 702 files · ~998,417 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8833 nodes · 12339 edges · 681 communities (590 shown, 91 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 230 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76a8b0a1`
...
## Communities (681 total, 91 thin omitted)
...
Cohesion: 0.02
Nodes (99): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), NotificationContext (+91 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (93): filterConfig, FilterMode, LiveTablesView(), abandonCheckout(), api, AssistanceRequestType, BoricaCheckoutResponse, CashPaymentRequestScope (+85 more)
...
Cohesion: 0.04
Nodes (54): CreateRestaurantForm(), RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, RestaurantContextType (+46 more)
...
Cohesion: 0.07
Nodes (48): useMenuContext(), AuditIssue, MenuCheckWidget(), PrintStationsView(), getGoogleReviewUrl(), getPrintStations(), submitFeedback(), cn() (+40 more)
...
Cohesion: 0.05
Nodes (45): SettingsTab, SettingsView(), ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo, SubscriptionTier (+37 more)
...
Cohesion: 0.08
Nodes (31): CartDrawer(), CartIcon(), CartIconProps, useCart(), getTrendingItems(), formatBgn(), formatDualCurrency(), formatEuro() (+23 more)
...
Cohesion: 0.07
Nodes (33): FontPicker(), FontPickerProps, createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), BRANDING_FONT_NAMES, BRANDING_FONTS (+25 more)
...
Cohesion: 0.08
Nodes (13): AssistanceService, CreateAssistanceDto, CreateFeedbackDto, OrderQueryDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto (+5 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (33): bondSection, { container }, disabledCreateButton, mockAuthState, mockRestaurant, mockT, store, createDeviceEnrollment() (+25 more)
...
Cohesion: 0.14
Nodes (19): AssistanceModule, AuthModule, DashboardModule, EventsModule, FeedbackModule, MenuImportModule, MenuViewModule, OrdersModule (+11 more)
...
Cohesion: 0.07
Nodes (24): CategoryPills(), CategoryPillsProps, Footer(), FooterProps, linkifyPhones(), LANG_CODES, TopBar(), TopBarProps (+16 more)

### Community 57 - "Community 57"
Cohesion: 0.08
Nodes (23): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, CartChoiceTranslationSource, CartItemTranslationSource, CartTranslationCategory (+15 more)
...
Cohesion: 0.15
Nodes (4): RestaurantsService, mockFeature, networkErr, resourceMissingError
...
Cohesion: 0.16
Nodes (16): MenuContext, MenuContextType, MenuProvider(), useMenu(), createCategory(), createItem(), deleteCategory(), deleteItem() (+8 more)
...
Cohesion: 0.2
Nodes (7): AvailabilityType, CreateCategoryDto, CreateMenuOptionDto, UpdateCategoryDto, UpdateMenuOptionDto, allowedTypes, MenuOptionController
...
Cohesion: 0.11
Nodes (18): code:bash (git add CODING_ROADMAP.md CLAUDE.md), code:typescript (import { NestFactory } from '@nestjs/core';), code:bash (cd apps/backend && npm run build), code:bash (git add apps/backend/src/main.ts), code:typescript (import { PaymentModule } from './payment/payment.module';), code:typescript (LoyaltyModule,), code:bash (cd apps/backend && npm test -- --no-coverage), code:bash (git add apps/backend/src/app.module.ts) (+10 more)
...
Cohesion: 0.14
Nodes (12): CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem, basePayload, dto, errors, UpdateOrderDto (+4 more)
...
Cohesion: 0.15
Nodes (6): CreateItemDto, Currency, UpdateItemDto, allowedTypes, ItemController, ItemDetailController
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)
...
- **Why does `PublicMenuPage()` connect `Community 29` to `Community 3`, `Community 7`, `Community 8`, `Community 41`, `Community 209`, `Community 20`, `Community 25`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `FeatureService` connect `Community 7` to `Community 32`, `Community 6`, `Community 39`, `Community 10`, `Community 171`, `Community 172`, `Community 14`, `Community 112`, `Community 17`, `Community 248`, `Community 24`, `Community 90`, `Community 123`, `Community 31`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `t` connect `Community 8` to `Community 3`, `Community 4`, `Community 135`, `Community 136`, `Community 393`, `Community 394`, `Community 12`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 149`, `Community 25`, `Community 27`, `Community 29`, `Community 157`, `Community 161`, `Community 34`, `Community 163`, `Community 162`, `Community 41`, `Community 42`, `Community 43`, `Community 46`, `Community 49`, `Community 53`, `Community 56`, `Community 57`, `Community 190`, `Community 191`, `Community 321`, `Community 69`, `Community 74`, `Community 210`, `Community 107`, `Community 252`?**
