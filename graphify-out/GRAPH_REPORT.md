...
## Corpus Check
- 576 files · ~860,857 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7608 nodes · 10052 edges · 562 communities (500 shown, 62 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57bf0576`
...
## Communities (562 total, 62 thin omitted)
...
Cohesion: 0.03
Nodes (72): api, BoricaCheckoutResponse, CheckoutResponse, createDeviceEnrollment(), createStaff(), createTable(), createZone(), deleteTable() (+64 more)
...
Cohesion: 0.04
Nodes (62): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), bondSection (+54 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (37): AuthUser, JwtStrategy, passwordChangedAt, prisma, CreateDeviceEnrollmentDto, CreateRestaurantDto, DateRangeQueryDto, RefundPaymentDto (+29 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (57): RestaurantContextType, AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate() (+49 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (57): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider() (+49 more)
...
Cohesion: 0.04
Nodes (26): JwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, CreateStaffDto, UpdatePlatformSettingsDto, UpdateStaffDto, ResetOwnerPasswordDto (+18 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (54): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), useNotifications() (+46 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (36): PinLoginMeta, WrapperType, CreatePrintStationDto, CreateTableDto, UpdatePrintStationDto, UpdateTableDto, burger, call (+28 more)
...
Cohesion: 0.05
Nodes (24): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+16 more)

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (36): useMenuContext(), getGoogleReviewUrl(), submitFeedback(), CategoryList(), CategoryRow(), CategorySettingsModal(), CategorySettingsModalProps, DAYS (+28 more)
...
Cohesion: 0.07
Nodes (32): CreateRestaurantForm(), RestaurantList(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, RestaurantContext, RestaurantProvider() (+24 more)
...
Cohesion: 0.08
Nodes (29): MenuContext, MenuContextType, MenuProvider(), DashboardSummary, useMenu(), createCategory(), createItem(), deleteCategory() (+21 more)
...
Cohesion: 0.06
Nodes (27): DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, changePassword(), confirmCheckoutSession(), generateStripeConnectLink(), updateOnboardingStep(), updateProfile() (+19 more)
...
Cohesion: 0.17
Nodes (11): code:typescript (import React, { useEffect, useState } from "react";), code:bash (cd apps/frontend && npx tsc --noEmit), code:bash (git add apps/frontend/src/pages/CustomerProfilePage.tsx), code:typescript (import { useState } from "react";), code:typescript (import { createPortal } from "react-dom";), code:bash (cd apps/frontend && npx tsc --noEmit), code:bash (git add apps/frontend/src/components/cart/CartIcon.tsx apps/), File Map (+3 more)
...
Cohesion: 0.21
Nodes (8): Dashboard Purple/Violet Luxury Redesign (May 24, 2026), Files Changed, Files Changed, Fix, Key Changes, Problem, Stripe Webhook — Raw Body Handling (May 19, 2026), Summary
...
- **Why does `FeatureService` connect `Community 8` to `Community 4`, `Community 37`, `Community 6`, `Community 12`, `Community 14`, `Community 15`, `Community 79`, `Community 16`, `Community 18`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 47` to `Community 39`, `Community 8`, `Community 9`, `Community 10`, `Community 22`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `t` connect `Community 9` to `Community 1`, `Community 133`, `Community 5`, `Community 7`, `Community 136`, `Community 137`, `Community 10`, `Community 138`, `Community 13`, `Community 17`, `Community 19`, `Community 147`, `Community 22`, `Community 27`, `Community 29`, `Community 39`, `Community 169`, `Community 170`, `Community 44`, `Community 47`, `Community 49`, `Community 317`, `Community 62`, `Community 189`, `Community 318`, `Community 72`, `Community 73`, `Community 212`, `Community 85`, `Community 226`, `Community 98`, `Community 117`?**
