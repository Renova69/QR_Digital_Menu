# Graph Report - QR_Digital_Menu-main  (2026-07-02)

## Corpus Check
- 663 files · ~969,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8474 nodes · 11744 edges · 664 communities (577 shown, 87 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 215 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a0a508fe`
...
7. `Fixed Issues & Bug Resolutions Log` - 68 edges
8. `PrismaService` - 66 edges
9. `useAuth()` - 65 edges
10. `EventsGateway` - 57 edges
...
## Communities (664 total, 87 thin omitted)
...
Cohesion: 0.02
Nodes (93): BannerSettings, TYPE_STYLES, RestaurantContextType, CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage() (+85 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (97): CreateRestaurantForm(), NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance() (+89 more)
...
Cohesion: 0.06
Nodes (55): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, BoricaCardholderInfo, EpayNotification, EpayPage, MYPOS_TEST_PRIVATE_KEY (+47 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (53): BASIC_KEYS, FULL_PAYLOAD, mockDashboard, mockPrisma, OWNER, PRO_ONLY_KEYS, result, AnalyticsResult (+45 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (46): AuthUser, JwtAuthGuard, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto (+38 more)
...
Cohesion: 0.06
Nodes (60): CancelAnalysisPanel(), CustomerKitchenPanels(), StaffPerformancePanel(), TableTurnoverPanel(), computeInsights(), Panel(), CategoryMix(), GuestSatisfaction() (+52 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (55): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, useRestaurantContext(), SettingsTab, SettingsView() (+47 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (48): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names, { result } (+40 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (39): RedisIoAdapter, ALLOWED_LEVELS, asFiniteNumber(), asLevel(), asString(), ClientLogLevel, ClientLogsController, CONTROL_CHAR_PATTERN (+31 more)
...
Cohesion: 0.05
Nodes (48): ApiKeyPanel(), csvToPayload(), ExportTab(), FileImporter(), ImportTab(), KNOWN_ALLERGENS, MenuImportExportView(), parseCSVLine() (+40 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (27): JWT_VERIFY_ERROR_NAMES, OptionalJwtAuthGuard, err, guard, info, user, ok, Alignment (+19 more)

### Community 18 - "Community 18"
Cohesion: 0.1
Nodes (35): MenuContext, MenuContextType, useMenuContext(), AuditIssue, MenuCheckWidget(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps (+27 more)
...
Cohesion: 0.05
Nodes (38): MenuProfitabilityPanel(), MenuProfitabilityPanelProps, CancelAnalyticsData, CancelHourRow, CancelItemRow, CategoryBreakdown, CloseoutReport, CustomerMetric (+30 more)
...
Cohesion: 0.15
Nodes (17): AssistanceModule, DashboardModule, EventsModule, FeedbackModule, MenuImportModule, MenuViewModule, OrdersModule, PlatformSettingsModule (+9 more)
...
Cohesion: 0.11
Nodes (20): CartDrawer(), getTrendingItems(), formatBgn(), formatDualCurrency(), formatInlineDual(), getImageUrl(), getTranslatedArray(), getTranslatedField() (+12 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (25): DashboardSummary, superAdminGetDataRequests(), superAdminGetMrr(), superAdminUpdateDataRequest(), NEXT_STATUS, STATUS_STYLES, TYPE_STYLES, TIER_COLORS (+17 more)
...
Cohesion: 0.06
Nodes (31): Auth Log Scrubbing (May 18, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), CartContext `updateItem` Type Fix (May 18, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+23 more)
...
Cohesion: 0.09
Nodes (14): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, BillingPeriod, CheckoutTier, CreateCheckoutDto, FeatureService (+6 more)
...
Cohesion: 0.08
Nodes (24): AssistanceContextValue, AssistanceRequest, getCashRequestScopeLabel(), getCashRequestStatusLabel(), getElapsedLabel(), getElapsedMinutes(), getRequestTitle(), getUrgencyStyle() (+16 more)
...
Cohesion: 0.14
Nodes (13): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, CreateAssistanceDto, CreateFeedbackDto (+5 more)
...
Cohesion: 0.2
Nodes (11): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto, UpdateMenuOptionDto (+3 more)
...
Cohesion: 0.12
Nodes (13): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, getGoogleReviewUrl(), submitFeedback(), FeedbackPage() (+5 more)
...
Cohesion: 0.18
Nodes (13): MenuProvider(), useMenu(), createCategory(), createItem(), deleteCategory(), deleteItem(), getCategories(), getItems() (+5 more)
...
Cohesion: 0.18
Nodes (3): UpdatePlatformSettingsDto, PlatformSettingsService, UsersDataService
...
Cohesion: 0.14
Nodes (9): BASE_RESTAURANT, mockEvents, mockMenuTranslation, mockPrisma, mockStorage, mockTranslation, option, spy (+1 more)
...
Cohesion: 0.23
Nodes (6): getField(), MyposProvider, form, notifyBody, { privateKey, publicKey }, result
...
Cohesion: 0.24
Nodes (4): VerifyDeviceEnrollmentDto, PaymentModule, DeviceEnrollmentController, TranslationModule
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosSeatSelector.tsx), code:tsx (import { QRCodeSVG } from "qrcode.react";), code:bash (git add apps/frontend/src/components/pos/PosQRBill.tsx), File Structure (+3 more)
...
Cohesion: 0.5
Nodes (3): WrapperType, CreatePrintStationDto, UpdatePrintStationDto
...
Cohesion: 0.33
Nodes (5): DashboardProfileModal(), DashboardProfileModalProps, DashboardUser, changePassword(), updateProfile()
...
Cohesion: 0.5
Nodes (3): mockFeature, networkErr, resourceMissingError
...
## Knowledge Gaps
- **4627 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4622 more)
...
- **Why does `PublicMenuPage()` connect `Community 29` to `Community 4`, `Community 11`, `Community 46`, `Community 19`, `Community 54`, `Community 22`, `Community 58`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `FeatureService` connect `Community 58` to `Community 163`, `Community 6`, `Community 7`, `Community 8`, `Community 135`, `Community 39`, `Community 108`, `Community 15`, `Community 51`, `Community 88`, `Community 125`, `Community 95`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `t` connect `Community 11` to `Community 3`, `Community 4`, `Community 138`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 275`, `Community 22`, `Community 151`, `Community 23`, `Community 152`, `Community 27`, `Community 29`, `Community 35`, `Community 420`, `Community 40`, `Community 43`, `Community 44`, `Community 47`, `Community 179`, `Community 180`, `Community 309`, `Community 54`, `Community 63`, `Community 69`, `Community 72`, `Community 202`, `Community 78`, `Community 225`, `Community 226`, `Community 101`, `Community 115`, `Community 243`, `Community 377`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Are the 180 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
  _`t` has 180 INFERRED edges - model-reasoned connections that need verification._
