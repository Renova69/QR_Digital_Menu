# Graph Report - QR_Digital_Menu-main  (2026-06-28)

## Corpus Check
- 634 files · ~926,985 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8179 nodes · 11317 edges · 617 communities (550 shown, 67 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 212 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7325da42`
...
## Communities (617 total, 67 thin omitted)
...
Cohesion: 0.02
Nodes (98): RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, useRestaurantContext(), SettingsTab (+90 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (88): BannerSettings, TYPE_STYLES, filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage() (+80 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (90): CreateRestaurantForm(), NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance() (+82 more)
...
Cohesion: 0.03
Nodes (68): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names, { result } (+60 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (70): CancelAnalysisPanel(), CustomerKitchenPanels(), StaffPerformancePanel(), TableTurnoverPanel(), computeInsights(), MenuProfitabilityPanel(), MenuProfitabilityPanelProps, Panel() (+62 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (29): OptionalJwtStrategy, passwordChangedAt, prisma, BASIC_KEYS, FULL_PAYLOAD, mockDashboard, mockPrisma, OWNER (+21 more)
...
Cohesion: 0.05
Nodes (34): PinLoginMeta, AuthUser, JwtStrategy, passwordChangedAt, prisma, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto (+26 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (43): OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto, OrderQueryDto, UpdateOrderDto, isLoyaltyAvailable(), addDays() (+35 more)
...
Cohesion: 0.09
Nodes (25): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, EventsModule, FeedbackModule, HealthController (+17 more)
...
Cohesion: 0.07
Nodes (31): RedisIoAdapter, ALLOWED_LEVELS, asLevel(), asString(), ClientLogLevel, ClientLogsController, CONTROL_CHAR_PATTERN, safeContext() (+23 more)
...
Cohesion: 0.13
Nodes (37): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, BoricaCardholderInfo, EpayNotification, EpayPage, BillPaymentScope (+29 more)
...
Cohesion: 0.08
Nodes (32): CartDrawer(), CartIcon(), CartIconProps, useCart(), getTrendingItems(), CartChoiceTranslationSource, CartItemTranslationSource, CartTranslationCategory (+24 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (34): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, DashboardProfileModal(), DashboardProfileModalProps, DashboardUser (+26 more)
...
Cohesion: 0.06
Nodes (29): baseItem, basePayload, constraintKeys(), dto, errors, ImportCategoryDto, ImportChoiceDto, ImportItemDto (+21 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (34): RestaurantContextType, AnalyticsView(), formatDate(), SummaryView(), UpgradeBanner(), useAnalytics(), useFeature(), usePaymentSummary() (+26 more)
...
Cohesion: 0.06
Nodes (8): EventsGateway, parseCookie(), client, fetchSockets, inRoom, otherSocket, revokedSocket, token
...
Cohesion: 0.05
Nodes (33): billOrders, boricaCardholder, boricaPayment, boricaRestaurant, [capturedPayload], created, epayPayment, epayRestaurant (+25 more)
...
Cohesion: 0.07
Nodes (19): BASE_RESTAURANT, mockMenuTranslation, mockPrisma, mockStorage, mockTranslation, option, spy, MenuTranslationService (+11 more)
...
Cohesion: 0.08
Nodes (27): FontPicker(), FontPickerProps, createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), BRANDING_FONT_NAMES, BRANDING_FONTS (+19 more)
...
Cohesion: 0.09
Nodes (24): DashboardSummary, createCategory(), createItem(), deleteCategory(), deleteItem(), getCategories(), getItems(), updateCategory() (+16 more)

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (10): cardholder, pairs, pending, Provider, { service }, { service, payments }, BoricaCheckoutService, MyposCheckoutService (+2 more)

### Community 55 - "Community 55"
Cohesion: 0.09
Nodes (9): JwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, CreateTableDto, UpdateTableDto, MenuImportController, UsersDataController (+1 more)
...
Cohesion: 0.08
Nodes (24): abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCashPaymentRequest(), createCheckout(), PendingBillPayment, CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel() (+16 more)
...
Cohesion: 0.08
Nodes (16): ForceTierExpiryRow, getTierFromPrice(), GraceExpiryRow, IMMEDIATE_DOWNGRADE_STATUSES, PriceMap, configMock, eventEpoch, mockCheckoutCreate (+8 more)
...
Cohesion: 0.12
Nodes (17): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, burger, call, existingAcc, makeMenuItem(), makeRestaurant() (+9 more)
...
Cohesion: 0.14
Nodes (12): CreateRestaurantDto, errors, keysFor(), validate(), UpdateRestaurantDto, BRANDING_FIELD_SET, BRANDING_FIELDS, stripBrandingFields() (+4 more)
...
Cohesion: 0.15
Nodes (12): getField(), MYPOS_TEST_PRIVATE_KEY, MYPOS_TEST_PUBLIC_CERT, MyposCheckoutForm, MyposCheckoutParams, MyposMode, MyposNotificationResult, MyposProvider (+4 more)
...
Cohesion: 0.18
Nodes (14): CartContext, CartContextType, CartItem, CartProvider(), SelectedOption, CartCurrency, CartItem, isFiniteNumber() (+6 more)
...
Cohesion: 0.2
Nodes (8): apiMocks, billWithProviders(), i18nMocks, onCashRequestCreated, onSuccess, socketMocks, submitSpy, twoOrderBill()

### Community 192 - "Community 192"
Cohesion: 0.24
Nodes (3): ImageLightbox(), ImageLightboxProps, SubscriptionController
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosItemCard.tsx), code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/StaffRoute.tsx), File Structure (+3 more)
...
Cohesion: 0.21
Nodes (8): Custom Date Filter Heading — Analytics Deep-Dive (May 24, 2026), Files Changed, Files Changed, Fix, Key Changes, Problem, Summary, Table Zones/Sections (May 24, 2026)
...
## Knowledge Gaps
- **4456 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4451 more)
...
- **Why does `FeatureService` connect `Community 12` to `Community 96`, `Community 99`, `Community 38`, `Community 41`, `Community 10`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 20`, `Community 55`, `Community 151`, `Community 90`, `Community 92`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 44` to `Community 5`, `Community 39`, `Community 8`, `Community 12`, `Community 21`, `Community 23`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `t` connect `Community 8` to `Community 3`, `Community 4`, `Community 5`, `Community 132`, `Community 7`, `Community 141`, `Community 142`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 27`, `Community 39`, `Community 43`, `Community 44`, `Community 173`, `Community 172`, `Community 48`, `Community 56`, `Community 62`, `Community 192`, `Community 69`, `Community 70`, `Community 74`, `Community 75`, `Community 79`, `Community 216`, `Community 217`, `Community 349`, `Community 102`, `Community 232`, `Community 115`, `Community 124`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Are the 179 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
  _`t` has 179 INFERRED edges - model-reasoned connections that need verification._
