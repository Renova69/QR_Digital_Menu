...
## Corpus Check
- 483 files · ~707,900 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5951 nodes · 7682 edges · 481 communities (426 shown, 55 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ab096360`
...
Cohesion: 0.03
Nodes (60): filterConfig, FilterMode, LiveTablesView(), SITE_COOKIES, api, closeSession(), createDeviceEnrollment(), createStaff() (+52 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (56): NotificationBell(), PaymentToast(), useAssistance(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications() (+48 more)
...
Cohesion: 0.05
Nodes (53): useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo (+45 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (41): useMenuContext(), AuditIssue, MenuCheckWidget(), getGoogleReviewUrl(), submitFeedback(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (25): AuthUser, JwtStrategy, passwordChangedAt, prisma, BillingPeriod, CheckoutTier, CreateCheckoutDto, DateRangeQueryDto (+17 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (32): AnalyticsView(), CHART_COLORS, CustomTooltip(), dayPartKeyMap, dayParts, formatDate(), formatPercent(), getChangeCopy() (+24 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (37): OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem, basePayload, dto, errors (+29 more)
...
Cohesion: 0.06
Nodes (20): BASE_RESTAURANT, mockMenuTranslation, mockPrisma, mockTranslation, option, spy, MenuTranslationService, categories (+12 more)
...
Cohesion: 0.08
Nodes (13): AssistanceService, CreateAssistanceDto, CreateFeedbackDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto, UpdateAssistanceDto (+5 more)
...
Cohesion: 0.1
Nodes (19): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto (+11 more)

### Community 25 - "Community 25"
Cohesion: 0.07
Nodes (17): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, CreateTableDto, UpdateTableDto (+9 more)
...
Cohesion: 0.09
Nodes (27): hasTierFeature(), createAssistanceRequest(), getCategoryItems(), getMenuMeta(), getTrendingItems(), recordMenuView(), getImageUrl(), getTranslatedArray() (+19 more)
...
Cohesion: 0.15
Nodes (15): AssistanceModule, DashboardModule, EventsModule, FeedbackModule, MenuImportModule, MenuViewModule, OrdersModule, PlatformSettingsModule (+7 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (8): MenuAuditController, CategoryDetailController, ItemController, ItemDetailController, MenuAuditService, MenuModule, MenuOptionController, MenuOptionDetailController
...
Cohesion: 0.08
Nodes (15): isLoyaltyAvailable(), LoyaltyService, account, accounts, BASE_RESTAURANT, candidate, connErr, expiresAt (+7 more)
...
Cohesion: 0.15
Nodes (11): CreateDeviceEnrollmentDto, CreateRestaurantDto, errors, keysFor(), validate(), UpdateRestaurantDto, BRANDING_FIELD_SET, BRANDING_FIELDS (+3 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTopBar.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:tsx (import { QRCodeSVG } from "qrcode.react";), code:bash (git add apps/frontend/src/components/pos/PosQRBill.tsx), File Structure (+3 more)
...
## Knowledge Gaps
- **3461 isolated node(s):** `prisma`, `prisma`, `{ PrismaClient }`, `prisma`, `{ PrismaClient }` (+3456 more)
...
- **Why does `FeatureService` connect `Community 8` to `Community 67`, `Community 10`, `Community 12`, `Community 76`, `Community 46`, `Community 19`, `Community 24`, `Community 25`, `Community 125`, `Community 30`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 31` to `Community 8`, `Community 18`, `Community 27`, `Community 13`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 18` to `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 11`, `Community 109`, `Community 13`, `Community 16`, `Community 48`, `Community 50`, `Community 126`, `Community 31`?**
