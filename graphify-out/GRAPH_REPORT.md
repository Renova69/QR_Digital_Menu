# Graph Report - QR_Digital_Menu-main  (2026-06-13)

## Corpus Check
- 564 files · ~843,329 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7494 nodes · 9896 edges · 568 communities (506 shown, 62 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 183 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5843693`
...
7. `useAuth()` - 59 edges
8. `PrismaService` - 55 edges
9. `PaymentService` - 54 edges
...
## Communities (568 total, 62 thin omitted)
...
Cohesion: 0.03
Nodes (80): RestaurantContextType, AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate() (+72 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (45): AuthUser, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto (+37 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (69): CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage(), api, BoricaCheckoutResponse, CheckoutResponse (+61 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (63): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AssistanceContext, AssistanceContextType, AssistanceProvider() (+55 more)
...
Cohesion: 0.04
Nodes (58): NotificationBell(), PaymentToast(), useAssistance(), NotificationContext, NotificationContextType, NotificationProvider(), PaymentNotification, useNotifications() (+50 more)
...
Cohesion: 0.04
Nodes (56): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS (+48 more)
...
Cohesion: 0.04
Nodes (37): AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result, servedEntry (+29 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (27): AssistanceModule, AuthModule, GoogleStrategy, OptionalJwtStrategy, DashboardModule, EventsModule, HealthController, HealthModule (+19 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (42): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), useMenu(), getGoogleReviewUrl() (+34 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (40): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, names, { result }, summary (+32 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (28): RedisIoAdapter, ALLOWED_LEVELS, asLevel(), asString(), ClientLogLevel, ClientLogsController, CONTROL_CHAR_PATTERN, safeContext() (+20 more)
...
Cohesion: 0.07
Nodes (32): BoricaCallbackResult, BoricaCardholderInfo, BoricaCheckoutForm, BoricaCheckoutParams, BoricaMode, BoricaProvider, buildMInfo(), buildMobilePhone() (+24 more)
...
Cohesion: 0.07
Nodes (27): CreateRestaurantForm(), RestaurantList(), RestaurantContext, RestaurantProvider(), useSocket(), filterConfig, FilterMode, LiveTablesView() (+19 more)

### Community 35 - "Community 35"
Cohesion: 0.09
Nodes (23): styles, io, Props, styles, LogEntry, Props, styles, sendToPrinter() (+15 more)
...
Cohesion: 0.09
Nodes (10): LocalStrategy, CreateStaffDto, UpdateStaffDto, isPinRole(), PIN_LOGIN_ROLES, mockBcryptCompare, mockBcryptHash, mockUser (+2 more)
...
Cohesion: 0.09
Nodes (22): FontPicker(), FontPickerProps, createAssistanceRequest(), getCategoryItems(), getMenuMeta(), recordMenuView(), BRANDING_FONT_NAMES, BRANDING_FONTS (+14 more)
...
Cohesion: 0.12
Nodes (9): buildEscPosTicket(), CMD, divider(), PrintItem, PrintTicket, result, text(), WIN1251 (+1 more)
...
Cohesion: 0.08
Nodes (22): abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createCheckout(), createPaymentIntent(), BillData, BillItem, BillOrder (+14 more)
...
Cohesion: 0.14
Nodes (22): bgn(), Cell, dayParts, downloadAnalyticsExport(), empty(), eur(), ExportMeta, FeedbackExportData (+14 more)
...
Cohesion: 0.13
Nodes (17): CreatePrintStationDto, UpdatePrintStationDto, burger, call, existingAcc, makeMenuItem(), makeRestaurant(), makeTx() (+9 more)

### Community 85 - "Community 85"
Cohesion: 0.12
Nodes (17): AgentToken, PrintStation, PrintStationsView(), StationHealth, SummaryCardProps, createPrintStation(), deletePrintStation(), generateAgentToken() (+9 more)
...
Cohesion: 0.12
Nodes (10): categories, mockFeatureService, mockPrisma, mockStorageService, tx, sharp, mockConfigService, mockS3Send (+2 more)

### Community 105 - "Community 105"
Cohesion: 0.12
Nodes (10): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, ImageLightbox(), ImageLightboxProps, SubscriptionController (+2 more)
...
Cohesion: 0.15
Nodes (16): c(), o(), be(), De(), dn(), ei(), En(), ht() (+8 more)
...
Cohesion: 0.18
Nodes (3): HelpContentController, dto, mockService
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/components/pos/PosSeatSelector.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)

### Community 211 - "Community 211"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/context/AuthContext.tsx), code:bash (git add apps/frontend/src/context/AuthContext.tsx apps/front), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), File Structure (+3 more)
...
Cohesion: 0.2
Nodes (9): code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/SuperAdminRoute.tsx), code:tsx (import { Outlet, NavLink } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/super-admin/SuperAdminLayout), Self-Review Notes, Super-Admin Dashboard Implementation Plan, Task 10: SuperAdminRoute — frontend guard, Task 11: SuperAdminLayout — dark sidebar layout (+1 more)
...
Cohesion: 0.43
Nodes (6): ResetOwnerPasswordDto, SuperAdminConfirmationDto, TIERS, UpdatePaymentsEnabledDto, UpdateTenantStatusDto, UpdateTenantTierDto
...
## Knowledge Gaps
- **4284 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4279 more)
...
- **Why does `FeatureService` connect `Community 5` to `Community 96`, `Community 103`, `Community 8`, `Community 104`, `Community 74`, `Community 12`, `Community 13`, `Community 14`, `Community 49`, `Community 84`, `Community 151`, `Community 60`, `Community 31`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 56` to `Community 4`, `Community 5`, `Community 7`, `Community 19`, `Community 28`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 4` to `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 142`, `Community 15`, `Community 16`, `Community 143`, `Community 19`, `Community 28`, `Community 33`, `Community 34`, `Community 44`, `Community 174`, `Community 175`, `Community 176`, `Community 52`, `Community 56`, `Community 62`, `Community 320`, `Community 193`, `Community 321`, `Community 69`, `Community 82`, `Community 85`, `Community 217`, `Community 218`, `Community 95`, `Community 230`, `Community 105`, `Community 109`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Are the 151 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
