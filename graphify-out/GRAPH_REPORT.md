# Graph Report - QR_Digital_Menu-main  (2026-06-03)

## Corpus Check
- 487 files · ~716,011 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5980 nodes · 7753 edges · 487 communities (436 shown, 51 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `110d1c47`
...
Cohesion: 0.03
Nodes (61): filterConfig, FilterMode, LiveTablesView(), SITE_COOKIES, api, createDeviceEnrollment(), createStaff(), createTable() (+53 more)
...
Cohesion: 0.05
Nodes (51): useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo (+43 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (41): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), AuditIssue, MenuCheckWidget(), useMenu(), getGoogleReviewUrl() (+33 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (37): PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, names, { result }, summary (+29 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (21): JwtAuthGuard, AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto (+13 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (36): useAssistance(), Order, OrderContext, OrderContextType, OrderStatus, useOrders(), AssistanceContextValue, AssistanceRequest (+28 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (19): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, JwtStrategy, MenuViewService (+11 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (22): AssistanceModule, AuthModule, GoogleStrategy, OptionalJwtStrategy, DashboardModule, EventsModule, FeedbackModule, HealthController (+14 more)
...
Cohesion: 0.05
Nodes (11): MenuAuditController, CategoryController, CategoryDetailController, ItemController, ItemDetailController, MenuAuditService, MenuModule, MenuOptionController (+3 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (38): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, OrderProvider(), RestaurantProvider(), SocketContext, SocketContextData (+30 more)
...
Cohesion: 0.11
Nodes (18): AuthUser, DateRangeQueryDto, RefundPaymentDto, PaymentModule, FeatureFlag, FeatureGuard, RESTAURANT_SELECT, ctx (+10 more)
...
Cohesion: 0.09
Nodes (27): createAssistanceRequest(), getCategoryItems(), getMenuMeta(), getTrendingItems(), recordMenuView(), getImageUrl(), getTranslatedArray(), getTranslatedField() (+19 more)
...
Cohesion: 0.07
Nodes (23): ErrorBoundary, Props, State, DASHBOARD_LANGUAGES, Header(), NotificationBell(), PaymentToast(), renderWithProviders() (+15 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (19): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, CartDrawer(), CartIcon(), CartIconProps (+11 more)
...
Cohesion: 0.09
Nodes (8): LocalStrategy, CreateStaffDto, UpdateStaffDto, assertManagerOrOwner(), StaffController, isPinRole(), PIN_LOGIN_ROLES, UsersService

### Community 36 - "Community 36"
Cohesion: 0.11
Nodes (25): addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress(), getRewardValue(), markRemindersSent(), redeemAccountPoints() (+17 more)
...
Cohesion: 0.09
Nodes (16): RestaurantContext, RestaurantContextType, bondSection, { container }, mockRestaurant, mockT, store, getScanStats() (+8 more)
...
Cohesion: 0.09
Nodes (14): getTierFromPrice(), IMMEDIATE_DOWNGRADE_STATUSES, PriceMap, configMock, eventEpoch, mockCheckoutCreate, mockConstructEvent, mockCustomersCreate (+6 more)

### Community 55 - "Community 55"
Cohesion: 0.1
Nodes (4): CreateTableDto, UpdateTableDto, TablesController, TablesService
...
Cohesion: 0.14
Nodes (19): createPaymentIntent(), formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual(), BillData, BillItem, BillOrder (+11 more)

### Community 65 - "Community 65"
Cohesion: 0.13
Nodes (12): OptionalJwtAuthGuard, CreateOrderDto, OrderItemDto, OrderItemOptionDto, baseItem, basePayload, dto, errors (+4 more)
...
Cohesion: 0.09
Nodes (11): CHART_COLORS, CustomTooltip(), dayPartKeyMap, dayParts, formatDate(), formatPercent(), getChangeCopy(), MetricCard() (+3 more)
...
Cohesion: 0.16
Nodes (13): CreateDeviceEnrollmentDto, CreateRestaurantDto, errors, keysFor(), validate(), UpdateRestaurantDto, BRANDING_FIELD_SET, BRANDING_FIELDS (+5 more)
...
Cohesion: 0.13
Nodes (12): OrdersService, burger, existingAcc, makeMenuItem(), makeRestaurant(), makeTx(), mockAuthenticatedCustomer(), order (+4 more)
...
Cohesion: 0.2
Nodes (3): stripBrandingFields(), RestaurantsService, mockFeature
...
Cohesion: 0.15
Nodes (6): passwordChangedAt, prisma, BillingPeriod, CheckoutTier, CreateCheckoutDto, FeatureService
...
Cohesion: 0.15
Nodes (12): created, existing, existingSession, lockedFeatureService, lockedService, mockFeatureService, newSession, payment (+4 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/context/AuthContext.tsx), code:bash (git add apps/frontend/src/context/AuthContext.tsx apps/front), code:tsx (import { BrowserRouter as Router, Routes, Route, Outlet } fr), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/App.tsx), File Structure (+3 more)
...
## Knowledge Gaps
- **3467 isolated node(s):** `prisma`, `prisma`, `{ PrismaClient }`, `prisma`, `{ PrismaClient }` (+3462 more)
...
- **Why does `FeatureService` connect `Community 92` to `Community 65`, `Community 35`, `Community 100`, `Community 133`, `Community 36`, `Community 71`, `Community 8`, `Community 10`, `Community 74`, `Community 76`, `Community 22`, `Community 27`, `Community 126`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 26` to `Community 32`, `Community 20`, `Community 23`, `Community 92`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 20` to `Community 32`, `Community 3`, `Community 68`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 137`, `Community 14`, `Community 49`, `Community 26`, `Community 31`?**
