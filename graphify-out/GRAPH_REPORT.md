...
## Corpus Check
- 576 files · ~861,696 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7614 nodes · 10062 edges · 576 communities (510 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4601bdd3`
...
## Communities (576 total, 66 thin omitted)
...
Cohesion: 0.03
Nodes (82): filterConfig, FilterMode, LiveTablesView(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage() (+74 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (81): DASHBOARD_LANGUAGES, Header(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AssistanceContext, AssistanceContextType, AssistanceProvider() (+73 more)
...
Cohesion: 0.04
Nodes (49): AuthUser, JwtStrategy, passwordChangedAt, prisma, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateOrderDto, OrderItemDto (+41 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (65): ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), useRestaurantContext(), AnalyticsView(), CategoryMix(), CHART_COLORS (+57 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (37): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+29 more)
...
Cohesion: 0.04
Nodes (49): CustomerLoginModal(), CartDrawer(), CustomTooltip(), KpiCard(), KpiCardProps, FeatureFlag, BoricaCardholderDetails, CheckoutProvider (+41 more)
...
Cohesion: 0.05
Nodes (45): NotificationBell(), PaymentToast(), useAssistance(), useNotifications(), useOrders(), AssistanceContextValue, AssistanceRequest, AssistanceView() (+37 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (23): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, EventsModule, FeedbackModule, HealthController (+15 more)
...
Cohesion: 0.06
Nodes (18): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto, UpdateMenuOptionDto (+10 more)
...
Cohesion: 0.05
Nodes (13): JwtAuthGuard, BillingPeriod, CheckoutTier, CreateCheckoutDto, CreateStaffDto, CreateTableDto, UpdateStaffDto, UpdateTableDto (+5 more)
...
Cohesion: 0.06
Nodes (36): SettingsTab, ALL_FEATURE_FLAGS, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo, SubscriptionTier, TIER_FEATURES, useTier() (+28 more)
...
Cohesion: 0.06
Nodes (23): OptionalJwtStrategy, passwordChangedAt, prisma, AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews (+15 more)
...
Cohesion: 0.06
Nodes (31): Atomic Refund — Race Condition Fix (May 23, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), COOKIE_SAMESITE Default Changed from 'lax' to 'none' in Production, Core Stability & Checkout, Cross-Origin Cookie & CSRF Fix — Production Deployment (May 16, 2026), CSRF Cross-Origin Compatibility, CSS / Design System (May 4, 2026) (+23 more)
...
Cohesion: 0.07
Nodes (24): bondSection, { container }, disabledCreateButton, mockAuthState, mockRestaurant, mockT, store, createDeviceEnrollment() (+16 more)
...
Cohesion: 0.1
Nodes (20): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, burger, call, existingAcc, makeMenuItem(), makeRestaurant() (+12 more)
...
Cohesion: 0.13
Nodes (20): useMenuContext(), AuditIssue, MenuCheckWidget(), PrintStationsView(), CategoryList(), CategoryRow(), CategorySettingsModal(), CreateItemForm() (+12 more)
...
Cohesion: 0.15
Nodes (14): CreateCategoryForm(), EditItemFormProps, ChoiceInput, ManageOptionsModal(), ManageOptionsModalProps, PRESETS, MenuOption, Input (+6 more)
...
Cohesion: 0.18
Nodes (9): COOKIE_OPTIONS, PinLoginMeta, LocalAuthGuard, CreateAuthDto, PinLoginDto, UpdateAuthDto, VerifyRegistrationDto, isPinRole() (+1 more)

### Community 111 - "Community 111"
Cohesion: 0.14
Nodes (11): getPrintStations(), getDisplayUrl(), CategorySettingsModalProps, DAYS, SocialBar(), SocialBarProps, uploadCategoryImage(), AvailabilityType (+3 more)
...
Cohesion: 0.14
Nodes (8): DashboardSummary, Order, OrderStatus, PaginatedResponse, StaffMember, SuperAdminStats, TenantDetail, TenantSummary
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { Outlet } from "react-router-dom";), code:bash (git add apps/frontend/src/pages/pos/PosLayout.tsx), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:tsx (import { useState } from "react";), code:bash (git add apps/frontend/src/components/pos/PosSplitBill.tsx), File Structure (+3 more)

### Community 215 - "Community 215"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/context/AuthContext.tsx), code:typescript (// Add to UsersService class in apps/backend/src/users/users), code:bash (git add apps/backend/src/users/users.service.ts), code:bash (git add apps/frontend/src/context/AuthContext.tsx apps/front), code:tsx ({/* Shared Device Mode */}), code:bash (git add apps/frontend/src/pages/Dashboard/SettingsView.tsx), File Structure (+3 more)
...
Cohesion: 0.21
Nodes (8): Files Changed, Files Changed, Key Changes, Key Changes, Staff Creation Race & Duplicate Handling (May 25, 2026), Staff Credential Model Hardening (May 29, 2026), Summary, Summary
...
- **Why does `FeatureService` connect `Community 6` to `Community 32`, `Community 36`, `Community 104`, `Community 8`, `Community 73`, `Community 11`, `Community 13`, `Community 110`, `Community 15`, `Community 17`, `Community 60`, `Community 95`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 96` to `Community 4`, `Community 6`, `Community 7`, `Community 136`, `Community 20`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `t` connect `Community 7` to `Community 3`, `Community 4`, `Community 136`, `Community 10`, `Community 12`, `Community 14`, `Community 144`, `Community 18`, `Community 147`, `Community 20`, `Community 21`, `Community 148`, `Community 158`, `Community 40`, `Community 45`, `Community 47`, `Community 181`, `Community 62`, `Community 198`, `Community 74`, `Community 330`, `Community 84`, `Community 85`, `Community 220`, `Community 96`, `Community 105`, `Community 234`, `Community 111`, `Community 123`, `Community 124`?**
