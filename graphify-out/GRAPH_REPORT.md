# Graph Report - QR_Digital_Menu-main  (2026-06-21)

## Corpus Check
- 593 files · ~895,890 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8101 nodes · 10735 edges · 599 communities (533 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ce043ef`
...
5. `Chat Conversation` - 80 edges
6. `PaymentService` - 75 edges
7. `Fixed Issues & Bug Resolutions Log` - 68 edges
8. `useAuth()` - 61 edges
9. `PrismaService` - 58 edges
...
## Communities (599 total, 66 thin omitted)
...
Cohesion: 0.03
Nodes (68): RestaurantContextType, api, AssistanceRequestType, BoricaCheckoutResponse, CheckoutResponse, closeSession(), closeSessionWithCard(), closeSessionWithCash() (+60 more)
...
Cohesion: 0.04
Nodes (49): OrderQueryDto, UpdateOrderDto, isLoyaltyAvailable(), addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress() (+41 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (59): getMethodLabel(), PaymentDrawer(), TimelineItem(), translateTimelineLabel(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles (+51 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (55): CreateRestaurantForm(), RestaurantList(), AuditIssue, MenuCheckWidget(), ApiKeyPanel(), csvToPayload(), ExportTab(), FileImporter() (+47 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (57): NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, NotificationContext, NotificationContextType (+49 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (14): AuthController, COOKIE_OPTIONS, setTokenCookie(), AuthService, GoogleAuthGuard, NONCE_COOKIE_OPTIONS, ctx, opts (+6 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (32): AuthUser, JwtAuthGuard, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, CreateRestaurantDto, DateRangeQueryDto, RefundPaymentDto, errors (+24 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (46): useAssistance(), Order, OrderContext, OrderContextType, OrderProvider(), OrderStatus, useOrders(), AssistanceContextValue (+38 more)
...
Cohesion: 0.06
Nodes (25): PinLoginMeta, OptionalJwtStrategy, passwordChangedAt, prisma, WrapperType, created, dto, items (+17 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (36): CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider(), SelectedOption (+28 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (37): MenuContext, MenuContextType, MenuProvider(), useMenuContext(), useMenu(), CategoryList(), CategorySettingsModal(), CategorySettingsModalProps (+29 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (34): draft, PosCartItem, PosContext, PosContextType, PosProvider(), PosSession, first, names (+26 more)
...
Cohesion: 0.06
Nodes (16): DashboardService, AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result (+8 more)
...
Cohesion: 0.06
Nodes (36): ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo, SubscriptionTier, TIER_FEATURES, useTier() (+28 more)
...
Cohesion: 0.06
Nodes (20): existingUser, futureDate, hashedCode, mockCompare, mockHash, newUser, real, saved (+12 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (27): abandonCheckout(), BoricaCardholderDetails, CheckoutProvider, createAssistanceRequest(), createCheckout(), createPaymentIntent(), CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel() (+19 more)
...
Cohesion: 0.09
Nodes (25): FontPicker(), FontPickerProps, getCategoryItems(), getMenuMeta(), recordMenuView(), BRANDING_FONT_NAMES, BRANDING_FONTS, BrandingFont (+17 more)
...
Cohesion: 0.07
Nodes (19): BillingPeriod, CheckoutTier, CreateCheckoutDto, ForceTierExpiryRow, getTierFromPrice(), GraceExpiryRow, IMMEDIATE_DOWNGRADE_STATUSES, PriceMap (+11 more)

### Community 51 - "Community 51"
Cohesion: 0.09
Nodes (9): CreateTableDto, UpdateTableDto, TablesController, mockOrders, mockOwner, mockRestaurant, mockTable, session (+1 more)
...
Cohesion: 0.08
Nodes (24): PosTheme, PosThemeContext, PosThemeContextValue, PosThemeProvider(), usePosTheme(), SessionBill, settlePartial(), SplitProvider (+16 more)
...
Cohesion: 0.06
Nodes (29): billOrders, boricaCardholder, boricaPayment, boricaRestaurant, [capturedPayload], created, epayPayment, epayRestaurant (+21 more)
...
Cohesion: 0.07
Nodes (21): CategoryPills(), CategoryPillsProps, Footer(), FooterProps, linkifyPhones(), LANG_CODES, TopBar(), TopBarProps (+13 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (22): AnalyticsView(), CategoryMix(), CHART_COLORS, CustomTooltip(), dayPartKeyMap, dayParts, EmptyState(), formatDate() (+14 more)
...
Cohesion: 0.1
Nodes (10): AssistanceController, AssistanceService, dto, mockEvents, mockFeatureService, mockPrisma, req, updated (+2 more)
...
Cohesion: 0.07
Nodes (28): 5. socket-event-tracer (Realtime Events), 6. query-n1-detector (Database Performance), CRITICAL, CRITICAL, CRITICAL, CRITICAL, CRITICAL, CRITICAL (+20 more)
...
Cohesion: 0.13
Nodes (23): downloadMenuXLSX(), bgn(), Cell, dayParts, downloadAnalyticsExport(), empty(), eur(), ExportMeta (+15 more)
...
Cohesion: 0.12
Nodes (17): cn(), formatElapsed(), statusConfig, TableCard(), TableCardProps, formatDate(), formatTime(), getElapsedLabel() (+9 more)
...
Cohesion: 0.11
Nodes (18): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, EpayCheckoutForm, EpayCheckoutParams, EpayMode, EpayNotification (+10 more)
...
Cohesion: 0.17
Nodes (15): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, ResetOwnerPasswordDto, SuperAdminConfirmationDto, SuperAdminImportMenuDto (+7 more)
...
Cohesion: 0.17
Nodes (14): CreatePrintStationDto, UpdatePrintStationDto, buildEscPosTicket(), CMD, DEFAULTS, divider(), fmtTime(), PrintItem (+6 more)

### Community 111 - "Community 111"
Cohesion: 0.15
Nodes (16): SummaryView(), UpgradeBanner(), useAnalytics(), usePaymentSummary(), useScanStats(), DateRangePreset, formatDate(), SummaryDateRange (+8 more)
...
Cohesion: 0.14
Nodes (8): Channel, COUNTRIES, CustomerLoginModal(), CustomerLoginModalProps, Step, ImageLightbox(), ImageLightboxProps, SubscriptionController

### Community 128 - "Community 128"
Cohesion: 0.12
Nodes (17): 20. super-admin-safety (Super-Admin Security), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 129 - "Community 129"
Cohesion: 0.12
Nodes (17): 17. call-waiter-auditor (Assistance / Call Waiter), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 130 - "Community 130"
Cohesion: 0.12
Nodes (17): 15. auth-strategy-auditor (Authentication Perimeter), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 131 - "Community 131"
Cohesion: 0.12
Nodes (17): 21. cart-order-consistency (Cart → Order Pipeline), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 132 - "Community 132"
Cohesion: 0.12
Nodes (17): 19. mypos-auditor (MyPOS Card Terminal), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 133 - "Community 133"
Cohesion: 0.12
Nodes (17): 13. epay-auditor (ePay.bg Payments), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 134 - "Community 134"
Cohesion: 0.12
Nodes (17): 2. pos-session-auditor (POS Session Lifecycle), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 135 - "Community 135"
Cohesion: 0.12
Nodes (17): 9. i18n-validator (Translation Key Parity), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 136 - "Community 136"
Cohesion: 0.12
Nodes (17): 12. device-enrollment-auditor (Staff Device Binding), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 137 - "Community 137"
Cohesion: 0.12
Nodes (17): 11. borica-auditor (BORICA EMV-3DS Payments), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 138 - "Community 138"
Cohesion: 0.12
Nodes (17): 8. api-contract-guard (DTO/Schema Consistency), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)

### Community 139 - "Community 139"
Cohesion: 0.12
Nodes (17): 16. subscription-tier-auditor (Billing & Tiers), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+9 more)
...
Cohesion: 0.12
Nodes (16): 18. analytics-accuracy (Analytics & KPIs), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+8 more)

### Community 152 - "Community 152"
Cohesion: 0.12
Nodes (16): 14. print-station-auditor (Receipt Printers), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+8 more)

### Community 153 - "Community 153"
Cohesion: 0.12
Nodes (16): 3. loyalty-integrity (Loyalty Math), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+8 more)
...
Cohesion: 0.12
Nodes (14): 11. Role-Based Access Control (RBAC) Bypasses, 9. Timezone & "Happy Hour" Manipulation, A. Feature summary, A. Feature summary, A. Feature summary, A. Feature summary, B. Files involved, B. Files involved (+6 more)
...
Cohesion: 0.15
Nodes (12): CategoryBreakdown, OrderStatusBreakdown, PaymentMethodTotal, PeakHour, RevenueTrendPoint, TableMetric, TopItem, getAnalytics() (+4 more)
...
Cohesion: 0.13
Nodes (15): 4. stripe-webhook-auditor (Stripe Integration), CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH, LOW (+7 more)
...
Cohesion: 0.14
Nodes (13): 1. rbac-guard (Role-Based Access Control), 21-Agent Codebase Audit — Complete Findings (107 total), CLAUDE Verification Pass — 2026-06-20, Codex Follow-up Verification (2026-06-20), CRITICAL, HIGH, Historical Pending TODO (superseded; 0 explicit `**[TODO]**` finding rows now), Legend (+5 more)
...
Cohesion: 0.15
Nodes (13): 10. migration-safety (Prisma Migrations), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+5 more)

### Community 181 - "Community 181"
Cohesion: 0.15
Nodes (13): 7. seed-safety-auditor (Seed Scripts), CRITICAL, CRITICAL, CRITICAL, CRITICAL, HIGH, HIGH, HIGH (+5 more)
...
Cohesion: 0.18
Nodes (10): after, before, FREE_RESTAURANT, mockEvents, mockMenuImport, mockPrisma, PROFESSIONAL_RESTAURANT, result (+2 more)
...
Cohesion: 0.2
Nodes (6): cardholder, pairs, pending, Provider, { service }, { service, payments }
...
Cohesion: 0.22
Nodes (8): checksum, decoded, encoded, form, multiple, multipleNewline, multipleSpace, single
...
Cohesion: 0.25
Nodes (6): fs, jsonContent, keysInTsx, locales, missingKeys, tsxContent
...
Cohesion: 0.33
Nodes (3): categories, items, payload
...
Cohesion: 0.5
Nodes (3): LoyaltyData, LoyaltyRetentionCard(), LoyaltyRetentionCardProps

### Community 443 - "Community 443"
Cohesion: 0.5
Nodes (3): QuickAction, QuickActionsRow(), QuickActionsRowProps

### Community 444 - "Community 444"
Cohesion: 0.5
Nodes (3): LiveTablesGrid(), LiveTablesGridProps, TableData
...
## Knowledge Gaps
- **4695 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4690 more)
...
- **Why does `FeatureService` connect `Community 41` to `Community 36`, `Community 69`, `Community 7`, `Community 103`, `Community 107`, `Community 13`, `Community 15`, `Community 16`, `Community 145`, `Community 50`, `Community 147`, `Community 57`, `Community 126`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 45` to `Community 33`, `Community 41`, `Community 10`, `Community 17`, `Community 23`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `t` connect `Community 10` to `Community 257`, `Community 4`, `Community 6`, `Community 9`, `Community 11`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 148`, `Community 23`, `Community 25`, `Community 160`, `Community 33`, `Community 166`, `Community 38`, `Community 42`, `Community 45`, `Community 53`, `Community 442`, `Community 443`, `Community 444`, `Community 62`, `Community 63`, `Community 66`, `Community 70`, `Community 201`, `Community 77`, `Community 83`, `Community 345`, `Community 218`, `Community 92`, `Community 111`, `Community 243`, `Community 127`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Are the 159 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
