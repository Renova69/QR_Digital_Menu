...
## Corpus Check
- 909 files · ~829,807 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16927 nodes · 21520 edges · 1521 communities (1438 shown, 83 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `93a514ee`
...
## Communities (1521 total, 83 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (106): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, EpayCheckoutForm, EpayCheckoutParams, EpayMode, EpayNotification (+98 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (110): BannerSettings, TYPE_STYLES, CATEGORY_META, getGuideField(), getGuideSteps(), groupBy(), HelpCategory, HelpView() (+102 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (107): CustomerLoginModal(), CartDrawer(), cartMocks, CartIcon(), CartIconProps, CartContext, CartContextType, CartItem (+99 more)
...
Cohesion: 0.03
Nodes (97): Channel, COUNTRIES, CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider(), useMenuContext() (+89 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (97): formatNotificationTimeAgo(), NotificationBell(), now, translate, PaymentToast(), AssistanceContext, AssistanceContextType, AssistancePage (+89 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (47): OptionalJwtStrategy, passwordChangedAt, prisma, ViewDef, MenuTranslationService, ClaimedRow, first, mockEvents (+39 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (81): DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AuthContext, AuthContextType, AuthProvider(), mockUser, TestConsumer() (+73 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (51): AuthUser, JwtAuthGuard, DASHBOARD_LANGUAGES, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto, CreateDeviceEnrollmentDto, CreatePaymentIntentDto (+43 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (58): AvailabilityQueryDto, CreateReservationDto, ModifyReservationDto, BlackoutDto, CoverCountDto, ListReservationsQueryDto, ManualReservationDto, RESERVATION_ACTIONS (+50 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (48): BulkItemUpdateDto, BulkUpdateItemsDto, AvailabilityType, CreateCategoryDto, pipe, result, CreateItemDto, Currency (+40 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (67): CreateOrderDto, OrderItemDto, OrderItemOptionDto, PosSubmissionDto, CreateTableDto, LoyaltyHistoryQueryDto, UpdateOrderDto, UpdateTableDto (+59 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (48): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, WrapperType, DeepPartial, payment, tx (+40 more)
...
Cohesion: 0.02
Nodes (84): API requirements, Database migration requirements, Expected execution process, Frontend requirements, Implementation constraints, Important principle, Main objective, Processing model (+76 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (33): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, VerifyDeviceEnrollmentDto, EventsModule, FeedbackModule (+25 more)
...
Cohesion: 0.06
Nodes (42): getMethodLabel(), PaymentDrawer(), TimelineItem(), PaymentReconciliationQueue(), PaymentReconciliationQueueProps, ReconciliationDecision, api, issue (+34 more)
...
Cohesion: 0.04
Nodes (38): DASHBOARD_LANGUAGES, Header(), spy, storageMock, store, ThemeConsumer(), Theme, ThemeContext (+30 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (31): useAssistance(), AssistanceContextValue, AssistanceRequest, AssistanceView(), getElapsedLabel(), getElapsedMinutes(), getUrgencyStyle(), RequestFilter (+23 more)
...
Cohesion: 0.07
Nodes (33): csvToPayload(), ExportTab(), IMPORT_ERROR_DEFAULTS, ImportErrorKey, ImportTab(), KNOWN_ALLERGENS, normalizeCurrency(), normalizeTag() (+25 more)
...
Cohesion: 0.05
Nodes (29): renderWithProviders(), superAdminGetDataRequests(), superAdminUpdateDataRequest(), renderWithProviders(), apiMocks, cartMocks, i18nMock, ITEMS (+21 more)
...
Cohesion: 0.07
Nodes (17): categories, category, choice, [firstChunk], item, mockPrisma, mockTranslation, option (+9 more)
...
Cohesion: 0.06
Nodes (35): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Call-Waiter Cooldown Bypass on Reload (May 29, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Custom Date Filter Heading — Analytics Deep-Dive (May 24, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+27 more)
...
Cohesion: 0.07
Nodes (22): confirmCheckoutSession(), generateStripeConnectLink(), updateOnboardingStep(), updateProfile(), Billing, getVisibleSteps(), OnboardingPage(), PAID_TIERS (+14 more)
...
Cohesion: 0.06
Nodes (31): Analytics Deep-Dive Full i18n (May 24, 2026), Auth Log Scrubbing (May 18, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+23 more)
...
Cohesion: 0.08
Nodes (26): BoricaCardholderDetails, CheckoutProvider, PendingBillPayment, CustomerFacingOrderSource, getCustomerFacingOrderSourceLabel(), interpolateNameFallback(), BillData, BillItem (+18 more)

### Community 86 - "Community 86"
Cohesion: 0.09
Nodes (26): getGoogleReviewUrl(), submitFeedback(), buildMenuReturnUrl(), INVALID_RESTAURANT_IDS, normalizeRestaurantId(), AnalyticsView, BOTTOM_NAV_TABS, DASHBOARD_LANGUAGES (+18 more)
...
Cohesion: 0.09
Nodes (20): PosCartItem, PosContext, PosContextType, PosSession, PosSessionInput, usePos(), buildTableSessionCheckoutUrl(), Category (+12 more)
...
Cohesion: 0.11
Nodes (8): UpdatePlatformSettingsDto, PlatformSettingsController, PlatformSettingsService, expectSuperAdminGuards(), guardNames(), PlatformSettingsMock, PrismaMock, UsersDataService
...
Cohesion: 0.07
Nodes (27): Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed, Fixed Issues & Bug Resolutions Log, Frontend — Super-Admin Pages (+19 more)
...
Cohesion: 0.14
Nodes (19): KpiCardProps, AnalyticsData, formatBgn(), formatDualCurrency(), formatEuro(), formatInlineDual(), formatStackedDual(), CheckoutPage() (+11 more)
...
Cohesion: 0.08
Nodes (24): CI Gate, code:bash (# Install all dependencies for both apps at once), code:bash (cd apps/backend), code:bash (cd apps/backend), code:bash (FORCE_SEED_WIPE=true npm run seed), code:bash (npm run seed:help), code:bash (npm run dev), code:powershell (.\deploy.ps1) (+16 more)
...
Cohesion: 0.13
Nodes (18): asRecord(), classifySyncError(), discardOrdersForSession(), discardPosOrder(), dispatchSyncEvent(), isPosTransportFailure(), PosOrderOption, PosOrderPayload (+10 more)
...
Cohesion: 0.16
Nodes (13): PosTheme, PosThemeContext, PosThemeContextValue, PosThemeProvider(), usePosTheme(), PosThemeShell(), PosThemeProbe(), shell (+5 more)
...
Cohesion: 0.11
Nodes (18): code:bash (git add apps/backend/package.json apps/backend/package-lock.), code:bash (git add CODING_ROADMAP.md CLAUDE.md), code:typescript (import {), code:typescript (import { Module } from "@nestjs/common";), code:bash (cd apps/backend && npm test -- --no-coverage), code:bash (git add apps/backend/src/payment/payment.controller.ts apps/), code:typescript (// Payment / TableSession), code:bash (git add apps/frontend/src/lib/api.ts) (+10 more)
...
Cohesion: 0.17
Nodes (11): PosProvider(), syncEngine, { result }, useCombined(), usePosOfflineSync(), createOrder(), createPosSyncEngine(), indexedDbPosOutbox (+3 more)
...
Cohesion: 0.16
Nodes (8): installGlobalErrorLogging(), lazyWithReload(), reloadOnceForStaleChunk(), freshModule(), withStaleChunkReload(), container, queryClient, root
...
Cohesion: 0.22
Nodes (10): DEFAULT_PUBLIC_DARK, DEFAULT_PUBLIC_LIGHT, getStoredPublicTheme(), LANGUAGE_LABELS, PublicBrandMode, PublicPalette, RTL_LANGS, setStoredPublicTheme() (+2 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:tsx (import { Navigate, useLocation } from "react-router-dom";), code:bash (git add apps/frontend/src/components/StaffRoute.tsx), code:tsx (import {), code:bash (git add apps/frontend/src/context/PosContext.tsx), File Structure (+3 more)

### Community 402 - "Community 402"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:typescript (// Add to UsersService class in apps/backend/src/users/users), code:bash (git add apps/backend/src/users/users.service.ts), code:tsx (import {), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/App.tsx), File Structure (+3 more)
...
Cohesion: 0.53
Nodes (4): isBearerJwtAuthEnabled(), RuntimeEnvironment, RuntimeEnvironmentVariables, validateRuntimeEnvironment()
...
Cohesion: 0.33
Nodes (4): err, loader, mod, reloadMock
...
## Knowledge Gaps
- **10517 isolated node(s):** `fs`, `content`, `m`, `fs`, `path` (+10512 more)
...
- **Why does `FeatureService` connect `Community 12` to `Community 0`, `Community 67`, `Community 39`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 15`, `Community 17`, `Community 21`, `Community 282`, `Community 92`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `PublicMenuContent()` connect `Community 2` to `Community 24`, `Community 12`, `Community 7`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 7` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 580`, `Community 133`, `Community 72`, `Community 18`, `Community 86`, `Community 25`, `Community 26`?**
