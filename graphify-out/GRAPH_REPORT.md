# Graph Report - QR_Digital_Menu-main  (2026-06-22)

## Corpus Check
- 621 files · ~912,878 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7956 nodes · 11017 edges · 610 communities (541 shown, 69 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 204 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a4c0498d`
...
## Communities (610 total, 69 thin omitted)
...
Cohesion: 0.02
Nodes (105): DASHBOARD_LANGUAGES, Header(), NotificationBell(), PaymentToast(), DASHBOARD_BLOCKED_ROLES, ProtectedRoute(), SuperAdminRoute(), AssistanceContext (+97 more)
...
Cohesion: 0.03
Nodes (94): CreateRestaurantForm(), RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, RestaurantProvider() (+86 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (90): Channel, COUNTRIES, CustomerLoginModalProps, Step, CartDrawer(), CartIcon(), CartIconProps, useCart() (+82 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (80): RestaurantContextType, useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage(), TermsPage(), api (+72 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (84): MenuProfitabilityPanel(), MenuProfitabilityPanelProps, HourlyDemand(), KpiCard(), KpiCardProps, CancelAnalyticsData, CancelHourRow, CancelItemRow (+76 more)
...
Cohesion: 0.04
Nodes (58): CustomerLoginModal(), CartContext, CartContextType, CartItem, CartProvider(), SelectedOption, abandonCheckout(), createAssistanceRequest() (+50 more)
...
Cohesion: 0.04
Nodes (34): ImportCategoryDto, ImportChoiceDto, ImportItemDto, ImportMenuDto, ImportOptionDto, categories, items, payload (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (38): UpdateOrderDto, isLoyaltyAvailable(), LoyaltyController, addDays(), addEarnedPointBatch(), expireAccountPoints(), getExpiringPointBatches(), getFirstRewardProgress() (+30 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (30): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, burger, call, existingAcc, makeMenuItem(), makeRestaurant() (+22 more)
...
Cohesion: 0.12
Nodes (39): SettleAllocationDto, SettlePartialDto, SplitMode, SplitProvider, BoricaCardholderInfo, EpayNotification, EpayPage, MYPOS_TEST_PUBLIC_CERT (+31 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (23): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, DashboardModule, EventsModule, HealthController, HealthModule (+15 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (21): OptionalJwtStrategy, passwordChangedAt, prisma, CreateTableDto, UpdateTableDto, RecordViewDto, MenuViewService, mockEvents (+13 more)
...
Cohesion: 0.06
Nodes (15): AssistanceController, CreateAssistanceDto, CreateFeedbackDto, OrderQueryDto, PaginatedResult, PaginationDto, PaymentHistoryQueryDto, dto (+7 more)
...
Cohesion: 0.1
Nodes (18): AuthUser, JwtAuthGuard, OptionalJwtAuthGuard, CreateCashRequestDto, BoricaCardholderDto, CreateCheckoutDto, CreateDeviceEnrollmentDto, DateRangeQueryDto (+10 more)
...
Cohesion: 0.07
Nodes (26): PinLoginMeta, existingUser, futureDate, hashedCode, mockCompare, mockHash, newUser, real (+18 more)
...
Cohesion: 0.08
Nodes (29): styles, io, parseSetupUrl(), Props, styles, getAndroidApiVersion(), LogEntry, Props (+21 more)
...
Cohesion: 0.09
Nodes (12): stripBrandingFields(), RestaurantsService, brandingDto, capturedPayload, deleted, dto, expected, restaurant (+4 more)
...
Cohesion: 0.07
Nodes (10): cardholder, pairs, pending, Provider, { service }, { service, payments }, BoricaCheckoutService, EpayCheckoutService (+2 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (8): UpdatePlatformSettingsDto, PlatformSettingsController, PlatformSettingsModule, PlatformSettingsService, RetentionService, UsersDataController, UsersDataModule, UsersDataService
...
Cohesion: 0.11
Nodes (18): ErrorBoundary, Props, State, ClientLogLevel, ClientLogPayload, getClientSessionId(), installGlobalErrorLogging(), logApiError() (+10 more)
...
Cohesion: 0.11
Nodes (18): SocketContext, SocketContextData, useSocket(), filterConfig, FilterMode, LiveTablesView(), PaymentsView(), getTableOrders() (+10 more)
...
Cohesion: 0.12
Nodes (5): MenuAuditController, CategoryDetailController, ItemController, MenuAuditService, MenuModule

### Community 90 - "Community 90"
Cohesion: 0.19
Nodes (9): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, UpdateCategoryDto, UpdateItemDto, allowedTypes, allowedTypes (+1 more)

### Community 91 - "Community 91"
Cohesion: 0.13
Nodes (9): BASE_RESTAURANT, mockMenuTranslation, mockPrisma, mockStorage, mockTranslation, option, spy, mockPost (+1 more)
...
Cohesion: 0.15
Nodes (12): usePos(), MenuOption, PosItemCard(), PosItemCardProps, MenuItem, PosItemGrid(), PosItemGridProps, PosQRBill() (+4 more)
...
Cohesion: 0.16
Nodes (7): AssistanceService, dto, mockEvents, mockFeatureService, mockPrisma, req, updated

### Community 127 - "Community 127"
Cohesion: 0.23
Nodes (9): CreateRestaurantDto, errors, keysFor(), validate(), UpdateRestaurantDto, BRANDING_FONT_NAMES, SUPPORTED_TARGET_LANGUAGE_CODES, RESTAURANT_PRIVATE_FIELDS (+1 more)

### Community 128 - "Community 128"
Cohesion: 0.14
Nodes (9): MenuTranslationService, categories, category, [firstChunk], item, mockPrisma, mockTranslation, option (+1 more)
...
Cohesion: 0.19
Nodes (4): BillingPeriod, CheckoutTier, CreateCheckoutDto, SubscriptionController
...
Cohesion: 0.23
Nodes (4): CreateMenuOptionDto, UpdateMenuOptionDto, MenuOptionController, MenuOptionDetailController

### Community 159 - "Community 159"
Cohesion: 0.21
Nodes (5): sharp, mockConfigService, mockS3Send, mockSharpChain, StorageService
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCategoryFilter.t), code:tsx (import { useState, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCartDrawer.tsx), code:tsx (import { QRCodeSVG } from "qrcode.react";), code:bash (git add apps/frontend/src/components/pos/PosQRBill.tsx), File Structure (+3 more)
...
Cohesion: 0.24
Nodes (7): useIdleTimer(), Category, PosCategoryFilter(), PosCategoryFilterProps, Category, MenuItem, PosPage()
...
Cohesion: 0.39
Nodes (7): ResetOwnerPasswordDto, SuperAdminConfirmationDto, SuperAdminImportMenuDto, TIERS, UpdatePaymentsEnabledDto, UpdateTenantStatusDto, UpdateTenantTierDto
...
Cohesion: 0.22
Nodes (8): closeSession(), closeSessionWithCard(), closeSessionWithCash(), createOrder(), getOrCreateSession(), ConfirmAction, PosCartDrawerProps, SEAT_LABEL_KEYS
...
Cohesion: 0.22
Nodes (9): code:block1 (Phase 2 (Frontend):), code:tsx (// apps/frontend/src/components/StaffRoute.tsx), code:tsx (// apps/frontend/src/components/ProtectedRoute.tsx), code:bash (git add apps/frontend/src/components/StaffRoute.tsx apps/fro), code:tsx (import { BrowserRouter as Router, Routes, Route, Outlet } fr), code:bash (git add apps/frontend/src/App.tsx), File Structure, Task 2.2: Split Providers Per Layout (+1 more)
...
Cohesion: 0.29
Nodes (6): getTableStatuses(), getZones(), PosTableModal(), STATUS_COLORS, STATUS_LABEL_KEYS, TableStatus
...
## Knowledge Gaps
- **4354 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4349 more)
...
- **Why does `FeatureService` connect `Community 27` to `Community 97`, `Community 137`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 24`, `Community 25`, `Community 90`, `Community 91`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 11` to `Community 2`, `Community 5`, `Community 9`, `Community 16`, `Community 81`, `Community 27`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `t` connect `Community 9` to `Community 1`, `Community 2`, `Community 130`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 139`, `Community 140`, `Community 16`, `Community 278`, `Community 39`, `Community 42`, `Community 61`, `Community 65`, `Community 455`, `Community 202`, `Community 203`, `Community 81`, `Community 93`, `Community 223`, `Community 98`, `Community 108`, `Community 110`, `Community 111`, `Community 112`, `Community 118`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Are the 174 inferred relationships involving `t` (e.g. with `ri` and `ai()`) actually correct?**
  _`t` has 174 INFERRED edges - model-reasoned connections that need verification._
- **What connects `Kt`, `ya`, `p` to the rest of the system?**
  _4354 weakly-connected nodes found - possible documentation gaps or missing edges._
