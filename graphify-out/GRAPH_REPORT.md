...
## Corpus Check
- 595 files · ~900,645 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8143 nodes · 10820 edges · 587 communities (522 shown, 65 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 195 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `59e872ae`
...
## Communities (587 total, 65 thin omitted)
...
Cohesion: 0.02
Nodes (102): CustomerLoginModal(), CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider() (+94 more)
...
Cohesion: 0.02
Nodes (105): CreateRestaurantForm(), NotificationBell(), PaymentToast(), AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance() (+97 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (99): filterConfig, FilterMode, LiveTablesView(), useDebouncedValue(), CookieConsentBanner(), CookiePolicyPage(), SITE_COOKIES, PrivacyPolicyPage() (+91 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (92): RestaurantList(), ALLOWED_ROLES, POS_REQUIRED_ROLES, ROLE_DEFAULT_PATH, StaffRoute(), RestaurantContext, useRestaurantContext(), SettingsTab (+84 more)
...
Cohesion: 0.04
Nodes (72): Channel, COUNTRIES, CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider(), useMenuContext() (+64 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (73): RestaurantContextType, AnalyticsView(), CategoryMix(), CHART_COLORS, dayPartKeyMap, dayParts, EmptyState(), formatDate() (+65 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (7): cardholder, pairs, pending, Provider, { service }, { service, payments }, PaymentService
...
Cohesion: 0.04
Nodes (29): WrapperType, CreatePrintStationDto, UpdatePrintStationDto, EventsGateway, parseCookie(), client, fetchSockets, inRoom (+21 more)
...
Cohesion: 0.04
Nodes (26): OptionalJwtStrategy, passwordChangedAt, prisma, BASIC_KEYS, FULL_PAYLOAD, mockDashboard, mockPrisma, OWNER (+18 more)
...
Cohesion: 0.07
Nodes (29): AuthUser, JwtAuthGuard, OptionalJwtAuthGuard, CreateDeviceEnrollmentDto, DateRangeQueryDto, RefundPaymentDto, SettleAllocationDto, SettlePartialDto (+21 more)
...
Cohesion: 0.06
Nodes (17): AssistanceController, AssistanceService, dto, mockEvents, mockFeatureService, mockPrisma, req, updated (+9 more)
...
Cohesion: 0.06
Nodes (15): DashboardService, AnalyticsResult, canceledEntry, defaultAggregate, mockPrisma, mockViews, newEntry, result (+7 more)
...
Cohesion: 0.09
Nodes (22): AvailabilityType, CreateCategoryDto, CreateItemDto, Currency, CreateMenuOptionDto, UpdateCategoryDto, UpdateItemDto, UpdateMenuOptionDto (+14 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (22): PinLoginMeta, JwtStrategy, passwordChangedAt, prisma, BillingPeriod, CheckoutTier, CreateCheckoutDto, FeatureService (+14 more)

### Community 31 - "Community 31"
Cohesion: 0.07
Nodes (18): MenuImportService, clampLimit(), clampPage(), emptyTierCounts(), parseOptionalDate(), after, before, FREE_RESTAURANT (+10 more)
...
Cohesion: 0.07
Nodes (31): MetricCard(), PaymentsView(), SettingCard(), cn(), SummaryCard(), ClassicCard(), getQrCodeUrl(), MinimalCard() (+23 more)
...
Cohesion: 0.06
Nodes (31): Atomic Refund — Race Condition Fix (May 23, 2026), Auth Log Scrubbing (May 18, 2026), Backend — `SuperAdminModule`, Branding: Public Menu Theme Application (May 25, 2026), Core Stability & Checkout, CSS / Design System (May 4, 2026), Database Performance Indexes (May 7, 2026), Files Changed (+23 more)
...
Cohesion: 0.13
Nodes (15): PosTheme, PosThemeContext, PosThemeContextValue, PosThemeProvider(), usePosTheme(), PosThemeShell(), changeLanguage, PosThemeProbe() (+7 more)
...
Cohesion: 0.12
Nodes (5): PlatformSettingsService, RetentionService, UsersDataController, UsersDataModule, UsersDataService
...
Cohesion: 0.11
Nodes (16): confirmCheckoutSession(), generateStripeConnectLink(), updateOnboardingStep(), Billing, getVisibleSteps(), OnboardingPage(), PAID_TIERS, PAYMENT_TIERS (+8 more)
...
Cohesion: 0.12
Nodes (14): 10. Negative Tipping & Price Underflows, 9. Timezone & "Happy Hour" Manipulation, A. Feature summary, A. Feature summary, A. Feature summary, A. Feature summary, B. Files involved, B. Files involved (+6 more)
...
Cohesion: 0.19
Nodes (9): usePos(), Category, PosCategoryFilter(), PosCategoryFilterProps, PosQRBill(), posState, PosSeatSelector(), SEAT_KEYS (+1 more)
...
Cohesion: 0.17
Nodes (10): closeSessionWithCard(), closeSessionWithCash(), createOrder(), getOrCreateSession(), ConfirmAction, PosCartDrawer(), PosCartDrawerProps, SEAT_LABEL_KEYS (+2 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTableModal.tsx), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosCategoryFilter.t), code:tsx (import { QRCodeSVG } from "qrcode.react";), code:bash (git add apps/frontend/src/components/pos/PosQRBill.tsx), File Structure (+3 more)

### Community 225 - "Community 225"
Cohesion: 0.18
Nodes (11): code:block1 (Phase 2 (Frontend):), code:typescript (// Add to AuthController in apps/backend/src/auth/auth.contr), code:bash (git add apps/backend/src/auth/auth.controller.ts), code:tsx (import { BrowserRouter as Router, Routes, Route, Outlet } fr), code:tsx (// apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/pages/DeviceLoginPage.tsx), code:bash (git add apps/frontend/src/App.tsx), File Structure (+3 more)
...
Cohesion: 0.2
Nodes (5): draft, PosCartItem, PosContext, PosContextType, PosSession
...
Cohesion: 0.25
Nodes (6): apiMocks, i18nMocks, onCashRequestCreated, onSuccess, socketMocks, submitSpy
...
## Knowledge Gaps
- **4708 isolated node(s):** `Kt`, `ya`, `p`, `Ca`, `wa` (+4703 more)
...
- **Why does `FeatureService` connect `Community 30` to `Community 160`, `Community 41`, `Community 12`, `Community 13`, `Community 14`, `Community 45`, `Community 16`, `Community 15`, `Community 19`, `Community 84`, `Community 29`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 2` to `Community 4`, `Community 9`, `Community 18`, `Community 23`, `Community 30`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `t` connect `Community 9` to `Community 1`, `Community 2`, `Community 131`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 272`, `Community 273`, `Community 18`, `Community 23`, `Community 152`, `Community 163`, `Community 164`, `Community 40`, `Community 51`, `Community 60`, `Community 188`, `Community 189`, `Community 71`, `Community 207`, `Community 85`, `Community 95`, `Community 99`, `Community 231`, `Community 107`, `Community 111`?**
...
- **What connects `Kt`, `ya`, `p` to the rest of the system?**
  _4708 weakly-connected nodes found - possible documentation gaps or missing edges._
