...
## Corpus Check
- 485 files · ~710,931 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5976 nodes · 7751 edges · 466 communities (420 shown, 46 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68c0b571`
...
- `OrderConsumer()` --calls--> `useOrders()`  [EXTRACTED]
  apps/frontend/src/App.test.tsx → apps/frontend/src/context/OrderContext.tsx
- `NotificationConsumer()` --calls--> `useNotifications()`  [EXTRACTED]
  apps/frontend/src/App.test.tsx → apps/frontend/src/context/NotificationContext.tsx
...
Cohesion: 0.04
Nodes (65): useRestaurantContext(), SettingsTab, SettingsView(), ALL_FEATURE_FLAGS, FeatureFlag, getAllowedStaffRoles(), getStaffLimit(), SubscriptionInfo (+57 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (46): filterConfig, FilterMode, LiveTablesView(), SITE_COOKIES, api, createTable(), createZone(), deleteTable() (+38 more)
...
Cohesion: 0.07
Nodes (47): Channel, COUNTRIES, CustomerLoginModalProps, Step, MenuContext, MenuContextType, MenuProvider(), useMenuContext() (+39 more)
...
Cohesion: 0.05
Nodes (46): PaymentDrawer(), TimelineItem(), exportPaymentsCsv(), formatDateTime(), formatMoney(), methodStyles, openStripePayment(), PaymentDetail (+38 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (25): AssistanceModule, AuthModule, GoogleStrategy, LocalStrategy, OptionalJwtStrategy, DashboardModule, EventsModule, HealthController (+17 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (43): AssistanceContext, AssistanceContextType, AssistanceProvider(), AssistanceRequest, useAssistance(), Order, OrderContext, OrderContextType (+35 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (20): JwtStrategy, passwordChangedAt, prisma, BillingPeriod, CheckoutTier, CreateCheckoutDto, dto, dtoWithRedirect (+12 more)
...
Cohesion: 0.07
Nodes (37): CustomerLoginModal(), CartDrawer(), CartIcon(), CartIconProps, CartContext, CartContextType, CartItem, CartProvider() (+29 more)
...
Cohesion: 0.04
Nodes (19): MenuAuditController, CategoryController, CategoryDetailController, ItemController, ItemDetailController, MenuAuditService, cat1, cat2 (+11 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (18): dto, mockEvents, mockFeatureService, mockPrisma, req, updated, CreateTableDto, UpdateTableDto (+10 more)
...
Cohesion: 0.07
Nodes (16): MenuImportService, clampLimit(), clampPage(), emptyTierCounts(), parseOptionalDate(), after, before, FREE_RESTAURANT (+8 more)
...
Cohesion: 0.05
Nodes (31): SocketProvider(), AppLayout(), CheckoutPage, CookiePolicyPage, CustomerProfilePage, DashboardPage, DeviceEnrollPage, DeviceLoginPage (+23 more)
...
Cohesion: 0.08
Nodes (20): ErrorBoundary, Props, State, NotificationBell(), PaymentToast(), renderWithProviders(), NotificationContext, NotificationContextType (+12 more)
...
Cohesion: 0.08
Nodes (18): CategoryPills(), CategoryPillsProps, Footer(), FooterProps, linkifyPhones(), LANG_CODES, TopBar(), TopBarProps (+10 more)
...
Cohesion: 0.1
Nodes (10): CHART_COLORS, CustomTooltip(), dayPartKeyMap, dayParts, formatPercent(), getChangeCopy(), MetricCard(), numberFormat (+2 more)
...
Cohesion: 0.13
Nodes (14): RecentOrdersProps, getGoogleReviewUrl(), submitFeedback(), FeedbackStep, Table, TableBody, TableCaption, TableCell (+6 more)
...
Cohesion: 0.18
Nodes (3): MenuViewController, RecordViewDto, MenuViewService
...
Cohesion: 0.26
Nodes (9): AnalyticsView(), formatDate(), SummaryView(), useAnalytics(), usePaymentSummary(), useScanStats(), useSummaryDateRange(), getLoyaltyAnalytics() (+1 more)
...
Cohesion: 0.18
Nodes (11): code:block1 (Create:), code:tsx (import { usePos } from "../../context/PosContext";), code:bash (git add apps/frontend/src/pages/pos/PosPage.tsx), code:tsx (import { useState, useEffect, useContext } from "react";), code:bash (git add apps/frontend/src/components/pos/PosTableModal.tsx), code:tsx (import { QRCodeSVG } from "qrcode.react";), code:bash (git add apps/frontend/src/components/pos/PosQRBill.tsx), File Structure (+3 more)
...
Cohesion: 0.22
Nodes (9): code:block1 (Phase 2 (Frontend):), code:tsx (import { BrowserRouter as Router, Routes, Route, Outlet } fr), code:tsx (import DeviceLoginPage from "./pages/DeviceLoginPage";), code:tsx ({/* Inside <Route element={<PublicLayout />}> */}), code:bash (git add apps/frontend/src/App.tsx), code:bash (git add apps/frontend/src/App.tsx), File Structure, Task 2.2: Split Providers Per Layout (+1 more)
...
## Knowledge Gaps
- **3466 isolated node(s):** `prisma`, `prisma`, `{ PrismaClient }`, `prisma`, `{ PrismaClient }` (+3461 more)
...
- **Why does `FeatureService` connect `Community 11` to `Community 35`, `Community 37`, `Community 7`, `Community 9`, `Community 75`, `Community 12`, `Community 16`, `Community 18`, `Community 22`, `Community 23`, `Community 120`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `PublicMenuPage()` connect `Community 36` to `Community 21`, `Community 11`, `Community 13`, `Community 30`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 21` to `Community 3`, `Community 4`, `Community 36`, `Community 6`, `Community 71`, `Community 10`, `Community 45`, `Community 13`, `Community 14`, `Community 122`, `Community 60`, `Community 31`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **What connects `prisma`, `prisma`, `{ PrismaClient }` to the rest of the system?**
  _3466 weakly-connected nodes found - possible documentation gaps or missing edges._
