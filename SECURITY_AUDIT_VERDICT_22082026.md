...
P3-3 is PARTIAL: 22 routes merged via PR #59 (`6a76bba4`) and 19 via PR #60
(`6f472e53`), both with green PR and post-merge CI. Another 23 tenant-management routes are
implemented for review (64 guarded total). The remaining tenant-route migration
is still open.
...
| P3-3  | **PARTIAL; PR #59/#60 MERGED, TENANT-MANAGEMENT SLICE IN REVIEW:** 41 merged routes plus 23 restaurant/device/import/audit/slug routes (64 guarded total); 245-route discovery. Other tenant controllers remain; [policy and inventory](ops/security/RESTAURANT_ACCESS.md) | M      |
...
CPU execution limit. P3-3 is partial (41 routes merged, 23 more in review); its remaining tenant-route
