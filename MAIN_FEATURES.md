...
| 4 | ~~**No service-level unit tests**~~ — **IN PROGRESS.** 22 `.spec.ts` files, 206 tests passing (May 16, 2026). New suites: `menu-translation.service.spec.ts` (11 tests), `menu-audit.service.spec.ts` (11 tests), `loyalty.service.spec.ts` (10 tests). Coverage still below 80% threshold — CI gate and further suites pending. | Regression risk. | Reach 80% coverage, add CI gate. | Medium | ~~Must-have~~ **In Progress** |
