...
Active orders are grouped into **Awaiting Payment**, **New**, **In Progress**, and **Ready** columns. Paid or pay-later orders enter the preparation flow; advancing an order then moves it through `NEW → IN_PROGRESS → SERVED → COMPLETED`. Cards include the available table, item, and request details.
