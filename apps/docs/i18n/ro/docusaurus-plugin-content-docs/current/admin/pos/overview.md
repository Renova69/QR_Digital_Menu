---
title: Prezentare generală a sistemului POS
sidebar_label: Prezentare generală
sidebar_position: 1
---

# Prezentare generală a sistemului POS

Sistemul POS pentru personal de la `/staff/pos` acceptă operațiuni la masă, introducerea comenzilor și fluxuri de lucru pentru plăți pe o tabletă sau pe un desktop.
