...
async function main() {
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Creamy burrata heart, black truffle shavings, aged balsamic, micro-basil.',
      price: 18.5,
  ...
  const oysters = await prisma.menuItem.create({
    data: {
      ...
      description:
        'Fresh oysters served with shallot mignonette, lemon, and Tabasco.',
      price: 24.0,
      currency: Currency.EUR,
      order: 2,
      categoryId: starters.id,
  ...
  await prisma.menuOption.create({
    data: {
      ...
      choices: [
        ...
        { name: 'Full Dozen (12)', priceModifier: 22.0 },
      ],
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Silky asparagus soup, lemon creme fraiche, toasted almonds, herb oil.',
      price: 14.5,
      currency: Currency.EUR,
      order: 3,
      categoryId: starters.id,
  ...
  const ribeye = await prisma.menuItem.create({
    data: {
      ...
      description:
        '45-day dry-aged Australian Wagyu, marble score 7+, served with bone marrow butter.',
      price: 85.0,
      currency: Currency.EUR,
      order: 1,
      isFeatured: true,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        '900g bone-in steak for sharing, chimichurri, roasted garlic jus.',
      price: 96.0,
      currency: Currency.EUR,
      order: 3,
      categoryId: steaks.id,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Smoked paprika oil, fava bean purée, pickled samphire, chorizo dust.',
      price: 28.5,
      currency: Currency.EUR,
      order: 1,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Ginger-scented bok choy, crispy dashi rice cake, wasabi emulsion.',
      price: 38.0,
      currency: Currency.EUR,
      order: 2,
      categoryId: seafood.id,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Maine lobster, saffron cream, wilted spinach, bottarga shavings.',
      price: 34.0,
      currency: Currency.EUR,
      order: 1,
      categoryId: pastas.id,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Avocado, blood orange, fennel, pumpkin seeds, citrus vinaigrette.',
      price: 17.0,
      currency: Currency.EUR,
      order: 4,
      categoryId: garden.id,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Caramelized cheesecake center, berry compote, vanilla bean cream.',
      price: 13.0,
      currency: Currency.EUR,
      order: 3,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Whipped goat cheese, candied walnuts, arugula, orange blossom dressing.',
      price: 16.0,
      currency: Currency.EUR,
      order: 1,
      categoryId: garden.id,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Avocado, edamame, pickled ginger, sea grapes, sesame-ginger dressing.',
      price: 19.5,
      currency: Currency.EUR,
      order: 2,
      categoryId: garden.id,
  ...
  await prisma.menuItem.create({
    data: {
      ...
      description:
        'Espresso-soaked sponge, mascarpone clouds, dark chocolate soil.',
      price: 12.0,
      currency: Currency.EUR,
      order: 1,
      categoryId: desserts.id,
  ...
  await prisma.menuItem.create({
    data: {
      name: 'Matcha Fondant',
      description:
        'Molten green tea heart, white chocolate ganache, black sesame ice cream.',
      price: 14.0,
      currency: Currency.EUR,
      order: 2,
      categoryId: desserts.id,
  ...
  const azureMartini = await prisma.menuItem.create({
    data: {
      ...
      description:
        'Butterfly pea tea gin, elderflower liqueur, lemon zest, edible orchids.',
      price: 16.0,
      currency: Currency.EUR,
      order: 1,
      isFeatured: true,
  ...
  const negroni = await prisma.menuItem.create({
    data: {
      name: 'Smoked Negroni',
      description:
        'Classic Negroni smoked with hickory wood, served in a crystal decanter.',
      price: 18.0,
      currency: Currency.EUR,
      order: 2,
      categoryId: cocktails.id,
  ...
  console.log(
    '✅ Created 35+ signature items with options, allergens, and tags',
  );
