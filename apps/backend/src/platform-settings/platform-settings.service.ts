...
export class PlatformSettingsService {
  ...
  getPublicPayload(settings: PlatformSettings) {
    return {
      ...
      dpaEnabled: settings.dpaEnabled,
      refundPolicyEnabled: settings.refundPolicyEnabled,
      msaEnabled: settings.msaEnabled,
      ...
      dpaContent: settings.dpaContent,
      refundPolicyContent: settings.refundPolicyContent,
      msaContent: settings.msaContent,
