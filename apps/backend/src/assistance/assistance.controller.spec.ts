...
describe('AssistanceController', () => {
  ...
  it('creates an assistance request from the validated body', async () => {
  ...
  it('lists requests for the authenticated owner', async () => {
  ...
  it('finds one request scoped to the owner', async () => {
  ...
  it('updates a request with the owner id attached', async () => {
    ...
    await expect(result).resolves.toEqual({ id: 'a1', isResolved: true });
  });

  it('removes a request scoped to the owner', async () => {
