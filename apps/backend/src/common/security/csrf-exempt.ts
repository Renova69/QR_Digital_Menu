 ...
 * `/subscription/webhook`, `/notifications/sms/{provider}/status`,
 * `/notifications/email/resend/status`) — those use a raw body or form payload
 * plus provider signature instead of the double-submit cookie.
 *
