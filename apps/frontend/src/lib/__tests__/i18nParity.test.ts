...
const MENU_EDIT_KEYS = [
  ...
  "menuAdmin.optionPreset.sizeName",
  "menuAdmin.optionPreset.sizeSmall",
  "menuAdmin.optionPreset.sizeMedium",
  "menuAdmin.optionPreset.sizeLarge",
  "menuAdmin.optionPreset.donenessName",
  "menuAdmin.optionPreset.donenessRare",
  "menuAdmin.optionPreset.donenessMediumRare",
  "menuAdmin.optionPreset.donenessMedium",
  "menuAdmin.optionPreset.donenessMediumWell",
  "menuAdmin.optionPreset.donenessWellDone",
  "menuAdmin.optionPreset.quantityName",
  "menuAdmin.optionPreset.halfDozen",
  "menuAdmin.optionPreset.fullDozen",
...
const GENERAL_SETTINGS_KEYS = [
  ...
  "settings.menuAddress",
  "settings.menuAddressDesc",
  "settings.copyMenuAddress",
  "settings.menuAddressNotAssigned",
  "settings.changeMenuAddress",
  "settings.renameMenuAddressTitle",
  "settings.renameMenuAddressDesc",
  "settings.newMenuAddressLabel",
  "settings.saveMenuAddress",
  "settings.renameCooldownMessage",
