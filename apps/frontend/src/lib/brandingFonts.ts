...
export const BRANDING_FONTS: BrandingFont[] = [
  {
    ...
    category: "Serif",
    pairsWith: ["Outfit", "Lato", "Karla", "Open Sans"],
  },
  {
    name: "Merriweather",
    category: "Serif",
  ...
  },
  {
    name: "Lora",
    category: "Serif",
    pairsWith: ["Lato", "Open Sans", "Karla"],
  },
  {
    name: "Crimson Text",
    category: "Serif",
    pairsWith: ["Outfit", "Karla", "Open Sans"],
  },
  { name: "PT Serif", category: "Serif", pairsWith: ["Open Sans", "Roboto"] },
  {
    name: "Inter",
    category: "Sans-Serif",
    pairsWith: ["Inter", "Outfit", "Lato"],
  },
  {
    name: "Outfit",
    category: "Sans-Serif",
    pairsWith: ["Outfit", "Inter", "Playfair Display"],
  },
  {
    name: "Roboto",
    category: "Sans-Serif",
    pairsWith: ["Roboto", "Open Sans", "Merriweather"],
  },
  {
    name: "Open Sans",
    category: "Sans-Serif",
    pairsWith: ["Merriweather", "Lora", "Oswald"],
  },
  {
    name: "Montserrat",
    category: "Sans-Serif",
  ...
  },
  {
    name: "Pacifico",
    category: "Display",
    pairsWith: ["Open Sans", "Lato", "Outfit"],
  },
];
