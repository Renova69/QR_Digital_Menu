...
const FEATURE_ROWS: FeatureRowData[] = [
  {
    sectionKey: "pricing.sections.menu",
    labelKey: "pricing.features.digitalMenu",
    free: true,
    starter: true,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.menuImport",
    free: true,
    starter: true,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.qrCodes",
    free: true,
    starter: true,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.menuExport",
    free: true,
    starter: true,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.multiLanguage",
    free: false,
    starter: true,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.callWaiter",
    free: false,
    starter: true,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.dayparting",
    free: false,
    starter: false,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.upselling",
    free: false,
    starter: false,
    professional: true,
    enterprise: true,
  ...
  {
    sectionKey: "pricing.sections.payments",
    labelKey: "pricing.features.paymentProviders",
    free: false,
    starter: false,
    professional: true,
    enterprise: true,
  ...
  {
    sectionKey: "pricing.sections.analytics",
    labelKey: "pricing.features.basicAnalytics",
    free: true,
    starter: true,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.fullAnalytics",
    free: false,
    starter: false,
    professional: true,
    enterprise: true,
  ...
  {
    sectionKey: "pricing.sections.customers",
    labelKey: "pricing.features.customerAccounts",
    free: false,
    starter: false,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.loyalty",
    free: false,
    starter: false,
    professional: true,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.reservations",
    free: false,
    starter: false,
    professional: true,
    enterprise: true,
  ...
  {
    sectionKey: "pricing.sections.customization",
    labelKey: "pricing.features.customBranding",
    free: false,
    starter: false,
    professional: true,
    enterprise: true,
  ...
  {
    sectionKey: "pricing.sections.operations",
    labelKey: "pricing.features.pos",
    free: false,
    starter: false,
    professional: false,
    enterprise: true,
  ...
  {
    labelKey: "pricing.features.thermalPrinters",
    free: false,
    starter: false,
    professional: false,
    enterprise: true,
  ...
  {
    sectionKey: "pricing.sections.team",
    labelKey: "pricing.features.staffMembers",
    free: "0",
    starter: "1",
    professional: "5",
    enterprise: "∞",
  ...
  {
    sectionKey: "pricing.sections.support",
    labelKey: "pricing.features.prioritySupport",
    free: false,
    starter: false,
    professional: false,
    enterprise: true,
...
export default function PricingPage() {
  ...
  const activeRestaurantId =
    useContext(RestaurantContext)?.activeRestaurant?.id;
              ...
              <thead>
                <tr className="border-b border-border bg-muted">
                  ...
                  {TIER_ORDER.map((col) => (
                    <th
                      key={col}
                      className="px-3 py-4 text-center text-[10px] font-black uppercase tracking-widest text-foreground"
                    >
                      {tierName(t, col)}
                    </th>
                  ))}
              ...
              <tbody>
                {tableItems.map((item) => {
                  if (item.type === "section") {
                    return (
                      <tr key={item.key} className="bg-secondary/30">
                        <td
                          colSpan={5}
                          className="px-5 py-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground"
                        >
                          {t(item.labelKey)}
                        </td>
                      </tr>
                  ...
                  return (
                    <tr
                      key={row.labelKey}
                      className={`border-t border-border/50 ${index % 2 === 0 ? "" : "bg-secondary/10"}`}
                    >
                      ...
                      <td className="px-3 py-3 text-center">
                        <FeatureCell val={row.professional} />
                      </td>
                      <td className="px-3 py-3 text-center">
