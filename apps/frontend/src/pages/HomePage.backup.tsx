...
const advantageItems = [
  { icon: Clock, label: 'Launch a menu in minutes', text: 'Import items, organize categories, print QR codes, and keep everything editable.' },
  { icon: CreditCard, label: 'Reduce ordering friction', text: 'Guests order and pay from the table without waiting for the next service touch.' },
  { icon: MessageSquare, label: 'Know what guests need', text: 'Collect feedback, call-waiter requests, and customer signals before they become problems.' },
  { icon: Zap, label: 'Move faster every shift', text: 'Live orders, smart dashboards, and role-based tools keep teams aligned.' },
] as const;
...
const comparisonRows: FeatureRow[] = [
  ...
  { label: 'Custom branding', free: false, starter: false, professional: true, enterprise: true },
  ...
  { label: 'POS and kitchen display', free: false, starter: false, professional: false, enterprise: true },
...
const faqItems = [
  {
    ...
    answer: 'Yes. You can start with the digital menu and QR code workflow, then add ordering, payments, loyalty, POS, or kitchen tools when the restaurant is ready.',
  },
  {
    question: 'Do guests need to download an app?',
    answer: 'No. Guests open the menu from a QR scan in their browser, so the experience is fast and familiar on iPhone and Android.',
  },
  {
    question: 'Which plan is best for a growing restaurant?',
    answer: 'Professional is the best fit for most restaurants because it includes payments, analytics, loyalty, multi-language menus, and staff access.',
  },
  {
    question: 'Can I upgrade later?',
    answer: 'Yes. The tiers are built to let a restaurant start small and unlock more operational tools as the team adopts the platform.',
  },
  {
    question: 'Does the platform support staff and kitchen workflows?',
    answer: 'Yes. Enterprise includes POS, kitchen display, multi-location support, advanced staff control, and priority service features.',
  },
];
    ...
    <div className="relative mx-auto grid w-full max-w-5xl gap-5 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
        ...
        <div className="overflow-hidden rounded-[1.8rem] bg-white text-[#16131f]">
          <div className="bg-[#f7f6fb] px-4 pb-4 pt-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[11px] font-semibold text-[#6f6984]">Table 12</p>
            ...
            <div className="mt-4 rounded-2xl bg-[#191529] p-4 text-white">
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/55">Happy hour</p>
              <p className="mt-1 text-lg font-black">20% off signature drinks</p>
              <p className="mt-2 text-[11px] text-white/65">Today, 16:00 - 18:00</p>
            </div>
          </div>
          <div className="space-y-3 px-4 py-4">
            {[
              ['Truffle pasta', 'Fresh parmesan, herbs', 'EUR 15.90', 'bg-amber-200'],
              ['Grilled salmon', 'Seasonal vegetables', 'EUR 18.90', 'bg-orange-200'],
              ['Garden spritz', 'Citrus, mint, tonic', 'EUR 7.50', 'bg-emerald-200'],
            ].map(([name, desc, price, color]) => (
              <div key={name} className="grid grid-cols-[48px_1fr_auto] items-center gap-3">
      ...
      <div className="relative rounded-[1.75rem] border border-border bg-card p-4 shadow-[0_34px_80px_-46px_rgba(20,14,50,0.55)] md:p-5">
        <div className="flex flex-wrap items-start justify-between gap-4 border-b border-border pb-4">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.2em] text-primary">Live dashboard</p>
            <h3 className="mt-1 text-2xl font-black tracking-tight text-foreground">Today at a glance</h3>
          </div>
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-4">
          {[
            ...
            <div key={label} className="rounded-2xl border border-border bg-secondary/70 p-3">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-[1.3fr_0.7fr]">
          <div className="rounded-2xl border border-border bg-background p-4">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-sm font-black text-foreground">Orders overview</p>
              <div className="flex rounded-lg bg-secondary p-1 text-[10px] font-bold text-muted-foreground">
                <span className="rounded-md bg-card px-2 py-1 text-foreground">Week</span>
          ...
          <div className="rounded-2xl border border-border bg-background p-4">
            ...
            <div className="mt-4 space-y-3">
              {[
                ...
                <div key={name} className="grid grid-cols-[28px_1fr_auto] items-center gap-2 text-xs">
                  <span className="font-black text-muted-foreground">{rank}</span>
  ...
  const plans: Plan[] = [
    {
      ...
      price: 'EUR 0',
      period: 'forever',
      description: 'Start with a clean digital menu, QR codes, and menu import tools.',
      cta: 'Start free',
      href: '/register',
      accent: 'border-slate-300/60',
      bullets: ['Digital menu editor', 'QR code management', 'OCR menu import', '1 staff member'],
    },
    {
      key: 'STARTER',
      name: 'Starter',
      price: 'EUR 15',
      period: 'per month',
      description: 'Add ordering and simple reporting for a small restaurant team.',
      cta: 'Choose Starter',
      href: '/register',
      accent: 'border-blue-500/35',
      bullets: ['Everything in Free', 'Online ordering', 'Basic analytics', 'Order status basics'],
    },
    {
      key: 'PROFESSIONAL',
      name: 'Professional',
      price: 'EUR 25',
      period: 'per month',
      description: 'The strongest package for restaurants ready to grow revenue.',
      badge: 'Most popular',
      highlight: true,
      cta: 'Choose Professional',
      href: '/register',
      accent: 'border-primary',
      bullets: ['Stripe pay-at-table', 'Full analytics', 'Loyalty and customer accounts', 'Multi-language and branding', 'Up to 5 staff'],
    },
    {
      key: 'ENTERPRISE',
      name: 'Enterprise',
      price: 'EUR 45',
      period: 'per month',
      description: 'Advanced operations for teams, kitchens, and multi-location brands.',
      cta: 'Choose Enterprise',
      href: '/register',
      accent: 'border-emerald-500/35',
      bullets: ['POS and kitchen display', 'Multi-location support', 'Thermal printers', 'Advanced roles', 'Priority support'],
    },
  ];
    ...
    <div className="relative left-1/2 min-h-screen w-screen -translate-x-1/2 overflow-x-clip bg-background text-foreground">
      <section className="border-b border-border bg-foreground text-background">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-3 text-center sm:flex-row sm:px-6 lg:px-8">
          ...
          <Link to="/register" className="inline-flex items-center gap-2 rounded-full bg-background px-4 py-2 text-xs font-black uppercase tracking-wider text-foreground transition hover:opacity-90">
            Launch your QR menu
      ...
      <section className="relative overflow-hidden border-b border-border bg-background">
        <div className="absolute inset-0 -z-0 bg-[linear-gradient(rgba(110,86,248,0.06)_1px,transparent_1px),linear-gradient(90deg,rgba(14,11,26,0.05)_1px,transparent_1px)] bg-[size:32px_32px]" aria-hidden="true" />
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-primary">
              ...
              {t('landing.heroBadge', 'Built for restaurants. Loved by customers.')}
            </div>
            <h1 className="text-5xl font-black leading-[0.95] tracking-tight text-foreground sm:text-6xl lg:text-7xl">
              QR Menu
              <span className="block brand-gradient-text">restaurant SaaS that sells, serves, and scales.</span>
            </h1>
            <p className="mx-auto mt-7 max-w-2xl text-base font-medium leading-8 text-muted-foreground sm:text-lg">
              A complete digital restaurant platform for QR menus, ordering, payments, loyalty, analytics, staff workflows, POS, and kitchen display.
            </p>
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs font-bold text-muted-foreground">
              {['No app download', 'Setup in minutes', 'Cancel anytime'].map((item) => (
      ...
      <section className="bg-card py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-7 grid grid-cols-2 gap-4 text-center text-sm font-black uppercase tracking-[0.12em] text-muted-foreground/55 sm:grid-cols-3 lg:grid-cols-6">
            {['Urban Grill', 'Pasta House', 'Tokyo Sushi', 'Cafe Deluxe', 'Burger District', 'Ocean Breeze'].map((name) => (
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {advantageItems.map(({ icon: Icon, label, text }) => (
              <article key={label} className="rounded-2xl border border-border bg-card p-6 shadow-sm">
      ...
      <section id="features" className="bg-background py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-8 text-muted-foreground">
              From the first QR scan to repeat visits, the platform covers the full customer and staff journey.
            </p>
          </div>
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {featureCards.map(({ icon: Icon, title, text, tone }) => (
              <article key={title} className="group rounded-2xl border border-border bg-card p-6 transition duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-xl">
                <div className={`mb-5 flex h-12 w-12 items-center justify-center rounded-xl border ${tone}`}>
                  <Icon className="h-5 w-5" />
                </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8 lg:items-center">
          <div>
            ...
            <p className="mt-5 text-base leading-8 text-white/68">
              Managers can see what is selling, what needs attention, how tables are moving, and where revenue is coming from without switching systems.
            </p>
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {['Live table status', 'Order and payment history', 'Top dishes and demand', 'Customer retention signals'].map((item) => (
      ...
      <section id="pricing" className="bg-background py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-8 text-muted-foreground">
              Clear plans for simple menus, ordering, revenue growth, and full restaurant operations.
            </p>
          </div>
      ...
      <section className="bg-foreground px-4 py-16 text-background sm:px-6 md:py-24 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-background/68">
            Launch a stunning QR menu today, then grow into ordering, payments, loyalty, POS, and kitchen operations when the restaurant is ready.
          </p>
          <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
            <Link to="/register" className="inline-flex h-14 items-center justify-center rounded-2xl bg-background px-8 text-sm font-black uppercase tracking-wider text-foreground transition hover:opacity-90">
              Start Free Trial
              <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
            <Link to="/pricing" className="inline-flex h-14 items-center justify-center rounded-2xl border border-background/20 px-8 text-sm font-black uppercase tracking-wider text-background transition hover:bg-background/10">
              View Pricing
            </Link>
          </div>
        </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-5 px-4 text-center sm:px-6 md:flex-row md:text-left lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-medium text-muted-foreground">Digital restaurant operations platform</p>
            </div>
          </div>
