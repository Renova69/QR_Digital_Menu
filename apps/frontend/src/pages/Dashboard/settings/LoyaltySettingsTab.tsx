...
const LoyaltySettingsTab: React.FC = () => {
  ...
  useEffect(() => {
    if (
      ...
      setLoyaltySilverMultiplier(
        activeRestaurant.loyaltySilverMultiplier ?? 1.2,
      );
      ...
      const [sh, sm] = parseTimeParts(
        activeRestaurant.happyHourStartTime,
        [18, 0],
      );
      const [eh, em] = parseTimeParts(
        activeRestaurant.happyHourEndTime,
        [20, 0],
      );
  ...
  if (!isLoyaltyFeature) {
    return (
      <div className="py-12 text-center text-muted-foreground text-sm">
        {t("settings.featureNotAvailable", {
          defaultValue: "Loyalty is not available on your plan.",
        })}
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSave} className="space-y-6">
      ...
      <div className="p-4 bg-primary/5 border border-primary/20 rounded-xl flex items-center justify-between">
        <div>
          <p className="font-bold text-primary">
            {t("loyaltySettings.enableLoyalty")}
          </p>
      ...
      <div
        className={
          sectionDisabled ? "opacity-40 pointer-events-none select-none" : ""
        }
      >
        {/* ── Points Economy ── */}
        <div className="border-b border-border pb-6 space-y-4">
          <h3 className={`${sectionHeading} mb-4`}>
            {t("loyaltySettings.pointsEconomy", {
              defaultValue: "Points Economy",
            })}
          </h3>
          ...
          {/* Cashback info bar */}
          <div
            className={`text-xs rounded-lg px-3 py-2 flex items-center gap-2 ${cashbackHigh ? "bg-yellow-500/10 border border-yellow-500/20" : "bg-primary/5 border border-primary/10"}`}
          >
            <span
              className={`font-semibold ${cashbackHigh ? "text-yellow-500" : "text-primary"}`}
            >
              {t("loyaltySettings.cashbackInfo", {
                pct: (cashbackPct * 100).toFixed(1),
              })}
            </span>
            {cashbackHigh && (
          ...
          <div className="rounded-xl border border-border bg-muted/30 p-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-3 flex items-center gap-1.5">
              ...
              {t("loyaltySettings.liveCalcTitle", {
                defaultValue: "Live Example — €{{amount}} order",
                amount: calcAmount,
              })}
            </p>
        ...
        <div className="border-b border-border py-6 space-y-4">
          <h3 className={`${sectionHeading} mb-4`}>
            {t("loyaltySettings.expirySection", {
              defaultValue: "Point Expiry",
            })}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setLoyaltyPointExpiryDays(Number(e.target.value))
                }
                className={inputCls}
              />
              <p className="text-[10px] text-muted-foreground mt-1">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setLoyaltyExpiryReminderDays(Number(e.target.value))
                }
                className={inputCls}
              />
              <p className="text-[10px] text-muted-foreground mt-1">
          ...
          {reminderTooHigh && (
            <p className="text-xs text-red-500 flex items-center gap-1">
              <AlertTriangle className="w-3 h-3" />
              {t("loyaltySettings.reminderMustBeLower", {
                defaultValue: "Reminder days must be less than expiry days.",
              })}
            </p>
          )}
        </div>
            ...
            <div className="rounded-xl border border-slate-300/40 bg-slate-50 dark:bg-slate-900/50 p-4 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLoyaltySilverThreshold(Number(e.target.value))
                  }
                  className={inputCls}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLoyaltySilverMultiplier(Number(e.target.value))
                  }
                  className={inputCls}
                />
              </div>
            ...
            <div className="rounded-xl border border-amber-300/40 bg-amber-50 dark:bg-amber-900/20 p-4 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLoyaltyGoldThreshold(Number(e.target.value))
                  }
                  className={inputCls}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLoyaltyGoldMultiplier(Number(e.target.value))
                  }
                  className={inputCls}
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-foreground/80 mb-2">
                  {t("loyaltySettings.happyHourDays", {
                ...
                <div className="flex flex-wrap gap-1.5">
                  {(
                    [
                      {
                        n: 1,
                        short: t("loyaltySettings.dayMon", {
                          defaultValue: "Mon",
                        }),
                      },
                      {
                        n: 2,
                        short: t("loyaltySettings.dayTue", {
                          defaultValue: "Tue",
                        }),
                      },
                      {
                        n: 3,
                        short: t("loyaltySettings.dayWed", {
                          defaultValue: "Wed",
                        }),
                      },
                      {
                        n: 4,
                        short: t("loyaltySettings.dayThu", {
                          defaultValue: "Thu",
                        }),
                      },
                      {
                        n: 5,
                        short: t("loyaltySettings.dayFri", {
                          defaultValue: "Fri",
                        }),
                      },
                      {
                        n: 6,
                        short: t("loyaltySettings.daySat", {
                          defaultValue: "Sat",
                        }),
                      },
                      {
                        n: 7,
                        short: t("loyaltySettings.daySun", {
                          defaultValue: "Sun",
                        }),
                      },
                    ] as const
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    <select
                      ...
                      onChange={(e) =>
                        setHappyHourStartH(Number(e.target.value))
                      }
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setHappyHourStartM(Number(e.target.value))
                      }
                      className="w-16 px-2 py-2 border border-border rounded-lg bg-background text-foreground text-center focus:outline-none focus:ring-2 focus:ring-primary/50"
                    >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setHappyHourMultiplier(Number(e.target.value))
                    }
                    className={inputCls}
                  />
                </div>
