...
export default function KitchenPage() {
  ...
  const completedOrders = orders
    ...
    .filter((o) => now - new Date(o.createdAt).getTime() < HISTORY_HOURS * 3600000)
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-4 font-mono">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-[10px] text-gray-600">{completedAt}</span>
                      </div>
      ...
      <div
        ...
        style={{ height: showHistory ? 'calc(100vh - 22rem)' : 'calc(100vh - 5rem)' }}
      >
        {COLUMNS.map((col) => {
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="ml-2 text-xs text-gray-500">({colOrders.length})</span>
              </div>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span
                          className={`text-xs font-bold tabular-nums ${
                            urgent && col.status === 'NEW' ? 'text-red-400' : 'text-gray-500'
                          }`}
                        >
                          {minutes}m
                        </span>
