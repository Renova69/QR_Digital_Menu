    ...
    ? ({
        ...
        ...(activeBrandPalette
          ? {
              ...
              "--color-border": hexToRgba(activeBrandPalette.text, publicThemeMode === 'dark' ? 0.15 : 0.12),
              "--color-input": hexToRgba(activeBrandPalette.text, publicThemeMode === 'dark' ? 0.15 : 0.12),
