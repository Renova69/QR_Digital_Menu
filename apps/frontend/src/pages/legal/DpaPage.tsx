...
export default function DpaPage() {
  ...
  const content =
    (data.dpaContent as Record<string, string> | null)?.[locale] ||
    (data.dpaContent as Record<string, string> | null)?.["en"] ||
    "";
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <pre className="whitespace-pre-wrap text-sm text-gray-700 dark:text-gray-300 leading-relaxed font-sans">
        {content || "No DPA content configured yet. Please configure this in the Super Admin dashboard."}
      </pre>
