...
export default function TermsPage() {
  ...
  const content =
    (data.termsContent as Record<string, string> | null)?.[locale] ||
    (data.termsContent as Record<string, string> | null)?.["en"] ||
    "";

  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold mb-6">{t('auto.termsOfService', 'Terms of Service')}</h1>
