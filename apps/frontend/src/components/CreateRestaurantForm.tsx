      ...
      <div className="glass-panel bg-card/80 p-8 sm:p-12 rounded-[2rem] w-full max-w-lg shadow-xl backdrop-blur-xl border border-border">
        <div className="text-center mb-8">
          <h3 className="text-3xl font-extrabold text-foreground tracking-tight mb-2">
            {t("auto.launchWorkspace", "Launch Workspace")}
          </h3>
          <p className="text-muted-foreground font-medium">
            {t(
              "auto.createYourFirstRestaurantProfileTo",
              "Create your first restaurant profile to access the dashboard and menu builder.",
            )}
          </p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-semibold text-foreground">
              {t("auto.restaurantName", "Restaurant Name")}
            </label>
            <input
              type="text"
              value={name}
              ...
              placeholder={t(
                "auto.eGTheGoldenSpatula",
                "e.g. The Golden Spatula",
              )}
              required
            />
          </div>
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-foreground">
              {t("auto.mainDashboardLanguage", "Main Dashboard Language")}
            </label>
            <div className="relative">
              ...
              >
                ...
                <option value="bg">
                  {t("auto.Bulgarian", "Български (Bulgarian)")}
                </option>
                <option value="ro">
                  {t("auto.romNRomanian", "Română (Romanian)")}
                </option>
              </select>
            ...
            <p className="text-[10px] text-muted-foreground font-medium px-1">
              {t(
                "auto.thisSetsTheInterfaceLanguageForYou",
                "This sets the interface language for your admin panel.",
              )}
            </p>
          </div>
          ...
          >
            {t("auto.createRestaurant", "Create Restaurant")}
          </button>
        </form>
      </div>
    </div>
