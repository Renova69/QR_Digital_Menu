  ...
  return (
    <div className="kpi-tile transition-all duration-300 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-[1.65rem] font-display font-bold text-foreground leading-none mb-2">
          {value}
        </p>
        {change != null ? (
          <div className="space-y-0.5">
            <div className="flex items-center gap-1">
              ...
              <span
                className={`text-xs font-bold ${change > 0 ? "text-emerald-500" : change < 0 ? "text-red-400" : "text-muted-foreground"}`}
              >
