...
function InstagramIcon() {
  return (
    <svg className={socialIconCls} viewBox="0 0 24 24" fill="url(#instagramGradient)">
      <defs>
...
export default function SocialBar({ restaurantName, websiteUrl, facebookUrl, instagramUrl, tiktokUrl, youtubeUrl }: SocialBarProps) {
  ...
  return (
    <div
      className="sticky top-0 z-40 px-3 py-2 flex items-center justify-between bg-background/80 backdrop-blur-md border-b border-border/40"
      style={{
