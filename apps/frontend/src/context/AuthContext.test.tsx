...
import api, { register as apiRegister, verifyRegistration as apiVerifyRegistration } from '../lib/api';
  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={() => auth.verifyRegistration('new@example.com', 'password123', '123456')}
      >
        Verify
      </button>
    </div>
