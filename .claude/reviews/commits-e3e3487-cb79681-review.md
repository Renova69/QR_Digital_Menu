...
**Fix**: Either rename the KPI to "Active Customers" (frontend `KpiRow.tsx:41` label `"New Customers"` → `"Active Customers"`), or change the query to find phones whose _first_ order for this restaurant falls in the window.
