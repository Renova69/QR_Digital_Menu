...
_By default, Stripe defers proration charges. You must run this script to force immediate payment on upgrades._
...
- _Optional: Revert your `.env` file back to your test key so you don't accidentally run test code against production._
